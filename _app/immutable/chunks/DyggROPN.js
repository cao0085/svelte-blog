import{b as H,d as Jn,f as w,a as f}from"./Cew64nlL.js";import"./C5SEx9ip.js";import{t as Kn,h as V,a as W,P as Xn,aH as Qn,d as G,V as Zn,Y as ns,W as ss,B as as,T as M,s as t,o as b,v as n,w as s,aI as E}from"./COc0ozwQ.js";import{r as ts}from"./CR_4RHM7.js";function a(u,e,p=!1,k=!1,o=!1){var r=u,c="";Kn(()=>{var d=Xn;if(c===(c=e()??"")){V&&W();return}if(d.nodes_start!==null&&(Qn(d.nodes_start,d.nodes_end),d.nodes_start=d.nodes_end=null),c!==""){if(V){G.data;for(var l=W(),g=l;l!==null&&(l.nodeType!==8||l.data!=="");)g=l,l=Zn(l);if(l===null)throw ns(),ss;H(G,g),r=as(l);return}var i=c+"";p?i=`<svg>${i}</svg>`:k&&(i=`<math>${i}</math>`);var y=Jn(i);if((p||k)&&(y=M(y)),H(M(y),y.lastChild),p||k)for(;M(y);)r.before(M(y));else r.before(y)}})}const z={title:"Base Backgroud Service",date:"2025-09-25",category:"software",subCategory:"Backend",tags:["Backgroud","backend","markdown"],slug:"backgroudservice"},{title:Yt,date:zt,category:Jt,subCategory:Kt,tags:Xt,slug:Qt}=z;var ps=w('<h6>C#實作非立即性的服務排序</h6> <hr/> <h3>使用背景</h3> <p>當主程式的 DI 註冊週期是以 HTTP lifecycle 為主時，可藉由 Background Service 提供長期運行的服務容器。</p> <ol><li>非阻塞式處理：可由外部 API 觸發某些動作，立即回應用戶端而不等待處理完成</li> <li>解耦合設計：將耗時的業務邏輯從 HTTP 請求週期中分離出來</li> <li>簡易事件模式：作為一個輕量級的 Event pattern 實現，處理非即時性任務</li> <li>資源管理：避免長時間佔用 HTTP 連線資源，提升系統整體效能</li></ol> <h3>Channel 基礎原理</h3> <p>Channel 是 .NET Core 提供的 thread-safe 生產者-消費者模式實作，基於 System.Threading.Channels 命名空間。它解決了多執行緒環境下的資料傳遞問題。</p> <pre class="language-csharp"><!></pre> <h3>Channel 的監聽機制</h3> <p>寫入機制 (Producer)</p> <pre class="language-csharp"><!></pre> <p>讀取監聽機制 (Consumer)</p> <pre class="language-csharp"><!></pre> <h3>基本架構</h3> <p>DI註冊</p> <pre class="language-csharp"><!></pre> <p>Controller</p> <pre class="language-csharp"><!></pre> <p>服務內部</p> <pre class="language-csharp"><!></pre>',1);function os(u){var e=ps(),p=t(b(e),14),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token class-name"><span class="token keyword">var</span></span> channel <span class="token operator">=</span> Channel<span class="token punctuation">.</span><span class="token generic-method"><span class="token function">CreateUnbounded</span><span class="token generic class-name"><span class="token punctuation">&lt;</span>YourRequestType<span class="token punctuation">></span></span></span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// Channel 包含兩個部分</span>
...
<span class="token operator">&lt;</span><span class="token class-name">PackageReference</span> Include<span class="token operator">=</span><span class="token string">"MassTransit.RabbitMQ"</span> Version<span class="token operator">=</span><span class="token string">"8.1.2"</span> <span class="token operator">/</span><span class="token operator">></span></code>`),s(h);var _=t(h,2),R=n(_);a(R,()=>`<code class="language-csharp"><span class="token comment">// Program.cs</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(_);var S=t(_,4),A=n(S);a(A,()=>'<code class="language-csharp"><span class="token keyword">await</span> _sendEndpoint<span class="token punctuation">.</span><span class="token function">Send</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">GenerateInvoice</span> <span class="token punctuation">&#123;</span> OrderId <span class="token operator">=</span> <span class="token string">"123"</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(S);var T=t(S,4),P=n(T);a(P,()=>'<code class="language-csharp"><span class="token keyword">await</span> _publishEndpoint<span class="token punctuation">.</span><span class="token function">Publish</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">UserCreated</span> <span class="token punctuation">&#123;</span> UserId <span class="token operator">=</span> Guid<span class="token punctuation">.</span><span class="token function">NewGuid</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(T);var I=t(T,4),D=n(I);a(D,()=>`<code class="language-csharp">cfg<span class="token punctuation">.</span><span class="token function">ConfigureMediator</span><span class="token punctuation">(</span><span class="token punctuation">(</span>context<span class="token punctuation">,</span> cfg<span class="token punctuation">)</span> <span class="token operator">=></span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(I);var x=t(I,2),O=n(x);a(O,()=>`<code class="language-csharp"><span class="token punctuation">[</span><span class="token attribute"><span class="token class-name">HttpPost</span><span class="token attribute-arguments"><span class="token punctuation">(</span><span class="token string">"register"</span><span class="token punctuation">)</span></span></span><span class="token punctuation">]</span>
...
<span class="token punctuation">&#125;</span></code>`),s(x),f(u,e)}const rs=Object.freeze(Object.defineProperty({__proto__:null,default:is,metadata:K},Symbol.toStringTag,{value:"Module"})),X={title:"Domain-Driven - Outbox Message",date:"2025-06-23",category:"software",subCategory:"Backend",tags:["DDD","backend","design"],slug:"ddd_outbox"},{title:ip,date:rp,category:dp,subCategory:mp,tags:gp,slug:yp}=X;var ds=w('<h6>拆分主副邏輯，同時保持資料同步性</h6> <hr/> <h2>SideEffect</h2> <p>若把 DDD 流程中的主副行為拆分：</p> <ul><li>創建員工帳戶的時候 <code>&lt;TABLE_Employee&gt;</code> 新增一筆資料</li> <li>幫對應到的 <code>&lt;TABLE_Department&gt;_Headcount</code> 總人數加一</li></ul> <br/> <p>若是以依照 MVC 架構會是</p> <pre class="language-csharp"><!></pre> <p>用 DDD 寫則變成是</p> <pre class="language-csharp"><!></pre> <p>假設創建員工帳號變為須更新 5-10 張表單,函式會越來越巨大、複雜且難以測試與維護。透過 DDD 的 Domain Event 拆解副作用邏輯可異步處理，減少主流程延遲。</p> <h2>ASIO 原子性（Atomicity of Side-Effect & IO）</h2> <p>剛剛提到的行為，主邏輯成功時無法保證所有副作用（如更新部門、發送通知等）都成功執行，這違反了分散系統中常見的 資料一致性與原子性要求。</p> <p>解決方法是設計一張資料庫新表<code>&lt;DB_Outbox_Message&gt;</code>，在一筆交易中提交主邏輯與事件，且把事件訊息<code>(Event、Payload、Time)</code>寫入這張表。這樣執行失敗也有紀錄可以查驗，也可設計失敗的 Retry 機制。</p> <br/> <p>主要實踐方法是用背景應用重複執行，訪問 DB_Outbox_Message 執行該事件</p> <pre class="language-csharp"><!></pre>',1);function ms(u){var e=ds(),p=t(b(e),14),k=n(p);a(k,()=>`<code class="language-csharp">db_Employee<span class="token punctuation">.</span><span class="token function">Add</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
dotnet ef migrations <span class="token function">add</span> AddNewFeature <span class="token parameter variable">--project</span> DDD.Infrastructure --startup-project DDD.WebApi <span class="token parameter variable">--context</span> BaseDbContext // 跨層設定</code>`),s(m);var h=t(m,4),C=n(h);a(C,()=>'<code class="language-bash">dotnet ef database update <span class="token parameter variable">--context</span> BaseDbContext <span class="token parameter variable">--project</span> <span class="token punctuation">..</span>. --startup-project <span class="token punctuation">..</span>.</code>'),s(h);var _=t(h,6),R=n(_);a(R,()=>`<code class="language-csharp">    <span class="token keyword">public</span> <span class="token keyword">partial</span> <span class="token keyword">class</span> <span class="token class-name">InitialCreate</span> <span class="token punctuation">:</span> <span class="token type-list"><span class="token class-name">Migration</span></span>
    <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span></code>`),s(_);var S=t(_,8),A=n(S);a(A,()=>`<code class="language-csharp"><span class="token comment">// Infrastructure/Settings/DatabaseMigrate.cs</span>
...
<span class="token punctuation">&#125;</span></code>`),s(S);var T=t(S,4),P=n(T);a(P,()=>`<code class="language-json"><span class="token comment">// 正式</span>
...
<span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(T);var I=t(T,4),D=n(I);a(D,()=>`<code class="language-csharp"><span class="token comment">// Infrastructure/Installers/DatabaseMigrationInstaller.cs</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(I);var x=t(I,4),O=n(x);a(O,()=>`<code class="language-csharp"><span class="token comment">// Program.cs</span>
...
app<span class="token punctuation">.</span><span class="token function">Run</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(x),E(2),f(u,e)}const fs=Object.freeze(Object.defineProperty({__proto__:null,default:ws,metadata:Q},Symbol.toStringTag,{value:"Module"})),Z={title:"Finite-State Machine",date:"2025-06-30",category:"software",subCategory:"Backend",tags:["FSM","backend","markdown"],slug:"FSM"},{title:Sp,date:Cp,category:Tp,subCategory:Ip,tags:Rp,slug:Ep}=Z;var bs=w('<h6>FSM 這是一種類比電路常見的概念，用金流常見的狀態模擬看看。</h6> <hr/> <h3>核心概念</h3> <p>狀態是封閉集合其一：Pending / Paid / Failed / RefundPending / Refunded。</p> <p>事件是唯一入口：只有明確的事件才能讓狀態改變。</p> <pre class="language-csharp"><!></pre> <table><thead><tr><th>CurrentState</th><th>Trigger</th><th>NextState</th></tr></thead><tbody><tr><td>Pending</td><td>PaySucceeded</td><td>Paid</td></tr><tr><td>Pending</td><td>PayFailed</td><td>Failed</td></tr><tr><td>Paid</td><td>StartRefund</td><td>RefundPending</td></tr><tr><td>RefundPending</td><td>RefundSucceeded</td><td>Refunded</td></tr><tr><td>RefundPending</td><td>RefundFailed</td><td>Paid</td></tr><tr><td>Failed/Refunded</td><td><em>(無任何事件)</em></td><td><em>(終點)</em></td></tr></tbody></table> <h3>簡易流程</h3> <pre class="language-csharp"><!></pre> <p>限制行為的方式</p> <pre class="language-csharp"><!></pre> <h3>測試與擴充</h3> <p>單元測試每條轉移：「Pending → PaySucceeded → Paid」。</p> <p>新增流程：只要在 enum + 轉移表多加一條，和對應 trigger 的處理；主程式 switch(fsm.CurrentState) 自動接手 DB 差異。</p>',1);function hs(u){var e=bs(),p=t(b(e),10),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token comment">// 狀態（State）</span>
...
但是如果_R3突然掛掉了，可以找一個替代伺服器_R4，只是_R4儲存的資料需要標記，等_R3恢復後再回補</p> <pre class="language-text"><!></pre>`,1);function As(u){var e=Es(),p=t(b(e),34),k=n(p);a(k,()=>`<code class="language-text">庫存初始值：100
...
Instructor | Room
-----------|-----
Smith      | R1</code>`),s(h);var _=t(h,6),R=n(_);a(R,()=>`<code class="language-text">錯誤
...
Restaurant | Area</code>`),s(S);var T=t(S,6),P=n(T);a(P,()=>`<code class="language-text">-- Supplier-Part
S1 | P1
...
Supplier | Part | Project
---------|------|---------
S1       | P1   | J1</code>`),s(I),f(u,e)}const Bs=Object.freeze(Object.defineProperty({__proto__:null,default:Us,metadata:en},Symbol.toStringTag,{value:"Module"})),cn={title:"關聯式資料庫",date:"2025-06-22",category:"software",subCategory:"Database",tags:["database","db","sql"],slug:"db_relational"},{title:fo,date:bo,category:ho,subCategory:vo,tags:_o,slug:So}=cn;var Hs=w('<pre class="language-pgsql"><!></pre> <p>連接 SQL Server 時是透過 TDS（Tabular Data Stream）的通訊協定來交換資料。</p> <ul><li>TDS 是 SQL Server 專用的底層通訊協定，負責在用戶端與資料庫伺服器之間傳遞</li> <li>通常透過 TCP/IP 傳輸，預設使用的連接埠為 1433。</li> <li>用戶端要連接資料庫時，會使用一段 Connection String（連線字串）</li></ul> <pre class="language-pgsql"><!></pre> <h3>Table（資料表）</h3> <p>資料表是資料的儲存核心，每個表由「列（row）」與「欄（column）」構成。</p> <pre class="language-sql"><!></pre> <h3>Primary Key（主鍵）</h3> <p>能唯一標識每一筆資料，一張表只能有一個主鍵，可以是單一欄位或多欄位組成（複合主鍵）。</p> <pre class="language-sql"><!></pre> <h3>Unique Constraint（唯一約束）</h3> <p>限制欄位值不能重複，一張表可以有多個唯一欄位。</p> <pre class="language-sql"><!></pre> <h3>Foreign Key（外鍵）</h3> <pre class="language-sql"><!></pre> <h3>Index（索引）</h3> <p>加速查詢效率，類似書本的目錄，索引可以建立在單一欄位或多個欄位上。</p> <pre class="language-sql"><!></pre>',1);function Vs(u){var e=Hs(),p=b(e),k=n(p);a(k,()=>`<code class="language-pgsql">SQL Server Instance
├── Database
│   ├── Schema
│   │   ├── Table
│   │   ├── View
...
<span class="token keyword">ORDER</span> <span class="token keyword">BY</span> cc<span class="token punctuation">.</span>Depth<span class="token punctuation">;</span></code>`),s(h);var _=t(h,6),R=n(_);a(R,()=>`<code class="language-sql"><span class="token comment">-- 對所有 ancestor of parentId，插入新後代關係</span>
...
<span class="token keyword">return</span> Response<span class="token punctuation">;</span></code>`),s(l),E(16),f(u,e)}const na=Object.freeze(Object.defineProperty({__proto__:null,default:Zs,metadata:kn},Symbol.toStringTag,{value:"Module"})),rn={title:"Download PDF",date:"2025-06-22",category:"software",subCategory:"開發筆記",tags:["pdf","js","dom"],slug:"jsPDF"},{title:Bo,date:Ho,category:Vo,subCategory:Wo,tags:Go,slug:Yo}=rn;var sa=w('<h6>紀錄下載影像相關處理 <a href="https://github.com/cao0085/code-pattern/tree/main/fronted-pdf-download" rel="nofollow">相關程式碼</a></h6> <hr/> <h3>畫面截圖類型（html2canvas、dom-to-image…）</h3> <p>原理大多是用<code>document.query(ID / class)</code>抓取指定的<code>DOM</code>，在套件內<strong>模擬</strong>JS排版樣式引擎(所以可能會跑版)，繪圖在 HTML<code>&lt;canvas&gt;</code>Element 後再轉成 base64/Blob 格式輸出。</p> <p>要注意的是瀏覽器對於能當作繪製<code>&lt;canvas&gt;</code>的來源控管較為嚴格，例如在瀏覽器渲染的 img 來源可以使用，套件內被擋下來的問題，再來就是錯誤是發生在套件內部不好除錯。</p> <br/> <h3>向量型（jsPDF、pdf-lib…）</h3> <p>用程式碼直接描述格線、文字 ，也可以插入圖片當作背景。要注意的一樣是外部來源的合法(圖片、字體)，圖片可先在.js 轉換成 base64 當作來源給套件使用，減少套件內轉換失敗的風險。</p> <h4>jsPDF</h4> <p>添加字體方式有兩種方式讀取.ttf和.js，一樣讓套件讀取處理過的資源部屬比較穩定</p> <p>網站下載 .ttf 字體向量檔案</p> <pre class="language-js"><!></pre> <p>把 .ttf 轉成.js 再import到模組，因為字型檔案很大要用到再載入就好</p> <pre class="language-js"><!></pre> <p>圖片轉URL</p> <pre class="language-js"><!></pre> <p>下載和預覽</p> <pre class="language-js"><!></pre>',1);function aa(u){var e=sa(),p=t(b(e),22),k=n(p);a(k,()=>`<code class="language-js"><span class="token comment">// var pdfDoc = 建立一個 jsPDF 提供的物件(&#123; unit: 'mm', format: 'a4' &#125;)</span>
...
pdfDoc<span class="token punctuation">.</span><span class="token function">save</span><span class="token punctuation">(</span><span class="token string">"fileName.pdf"</span><span class="token punctuation">)</span></code>`),s(l),f(u,e)}const ta=Object.freeze(Object.defineProperty({__proto__:null,default:aa,metadata:rn},Symbol.toStringTag,{value:"Module"})),dn={title:"多個 PDF 檔案合併",date:"2025-09-16",category:"software",subCategory:"開發筆記",tags:["pdf","backend","command"],slug:"pdfmarge"},{title:zo,date:Jo,category:Ko,subCategory:Xo,tags:Qo,slug:Zo}=dn;var pa=w('<h6><a href="https://github.com/cao0085/pdfMerger" rel="nofollow">Repository</a> ，Python 執行相容性比較好，C# UI方便友善</h6> <hr/> <h3>C#</h3> <pre class="language-csharp"><!></pre> <pre class="language-csharp"><!></pre> <h3>Python3</h3> <pre class="language-bash"><!></pre> <pre class="language-python"><!></pre>',1);function oa(u){var e=pa(),p=t(b(e),6),k=n(p);a(k,()=>`<code class="language-csharp">  <span class="token comment">// .csproj</span>
...
確認檔案產出再 Update 資料庫</p> <pre class="language-csharp"><!></pre> <pre class="language-csharp"><!></pre>`,1);function la(u){var e=ca(),p=t(b(e),16),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token comment">/// &lt;summary></span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#123;</span>
        ...
        <span class="token keyword">throw</span><span class="token punctuation">;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(m),f(u,e)}const ua=Object.freeze(Object.defineProperty({__proto__:null,default:la,metadata:mn},Symbol.toStringTag,{value:"Module"})),gn={title:"SFTP、FTPS C# 連線測試",date:"2025-10-01",category:"software",subCategory:"開發筆記",tags:["tcp","ip","container"],slug:"sftp_ftps"},{title:ee,date:ce,category:le,subCategory:ue,tags:ke,slug:ie}=gn;var ka=w('<h6>紀錄本地端測試方法</h6> <hr/> <h3>SFTP</h3> <p>docker-compose.yml</p> <pre class="language-yml"><!></pre> <pre class="language-csharp"><!></pre> <h3>FTPS</h3> <pre class="language-csharp"><!></pre> <p>docker-compose.yml</p> <pre class="language-yml"><!></pre> <h3>2SFTP+FTPS</h3> <pre class="language-yml"><!></pre>',1);function ia(u){var e=ka(),p=t(b(e),8),k=n(p);a(k,()=>`<code class="language-yml"><span class="token key atrule">services</span><span class="token punctuation">:</span>
...
<span class="token punctuation">&#125;</span></code>`),s(m);var h=t(m,6),C=n(h);a(C,()=>`<code class="language-kotlin"><span class="token keyword">class</span> ArticleViewModel <span class="token operator">:</span> <span class="token function">ViewModel</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">fun</span> <span class="token function">recordPageView</span><span class="token punctuation">(</span>articleId<span class="token operator">:</span> String<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(h);var _=t(h,10),R=n(_);a(R,()=>`<code class="language-kotlin"><span class="token comment">// 這種錯誤應該 Crash,讓開發者知道有 Bug</span>
...
<span class="token keyword">fun</span> <span class="token function">loadPosts</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    viewModelScope<span class="token punctuation">.</span><span class="token function">launch</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(S),f(u,e)}const Ra=Object.freeze(Object.defineProperty({__proto__:null,default:Ia,metadata:hn},Symbol.toStringTag,{value:"Module"})),vn={title:"插入 3D 影像",date:"2025-08-13",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"threeJs"},{title:Be,date:He,category:Ve,subCategory:We,tags:Ge,slug:Ye}=vn;var Ea=w(`<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>匯入 .glb</h3> <p>透過用 three.js 匯入
Canvas ➜ WebGL ➜ Three.js ➜ GLB 模型 ➜ GPU 顯示</p> <pre class="language-js"><!></pre>`,1);function Aa(u){var e=Ea(),p=t(b(e),8),k=n(p);a(k,()=>`<code class="language-js">  <span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> <span class="token constant">THREE</span> <span class="token keyword">from</span> <span class="token string">'three'</span><span class="token punctuation">;</span>
...
</code>`),s(l),E(2),f(u,e)}const La=Object.freeze(Object.defineProperty({__proto__:null,default:Ma,metadata:Sn},Symbol.toStringTag,{value:"Module"})),Cn={title:"Angular20 Auth & Route 03",date:"2025-12-11",category:"software",subCategory:"Frontend",tags:["fronted","angular","route"],slug:"angular_AuthRoute_03"},{title:ec,date:cc,category:lc,subCategory:uc,tags:kc,slug:ic}=Cn;var qa=w('<h6>基於 RBAC 實作權限控管和畫面渲染，處理 UI/UX</h6> <hr/> <h3>Layout</h3> <p>主畫面的 Layout 會是常見的</p> <ol><li>Header 放入基本資料</li> <li>SideBar 側邊攔根據權限 Render 出入口</li> <li>ContentView 根據不同路由顯示不同畫面</li></ol> <p><strong>sidebar.component.ts</strong></p> <p>這邊主要功能是整理 permissionService 的權限列表( 有設計 TabService 但可解耦的先忽略)，轉成 UI 好渲染的資料結構(menuItems)，Click( ) Enevt就是跳轉到該 permissionService 對應的 route，ContentView 再根據 Route 顯示綁定的 Component</p> <pre class="language-ts"><!></pre> <p>所以麻煩的部份會是 permissionService (原資料) 要如何 MAPPING 到前端定義的 URL ROUTE 字串值，為此會需要定義一個介面</p> <pre class="language-ts"><!></pre> <p>route.config.ts</p> <p>資料整理完後，還需自行轉換成 Angular Route 套件可以吃的資料模型 convertToRoute( )，丟回給 app.routes.ts 使用</p> <pre class="language-ts"><!></pre> <p>app.routes.ts 會變成</p> <pre class="language-ts"><!></pre> <p>未來要新增一個畫面，前端就是添加一組</p> <pre class="language-ts"><!></pre>',1);function $a(u){var e=qa(),p=t(b(e),14),k=n(p);a(k,()=>`<code class="language-ts">
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token function-variable function">loadComponent</span><span class="token operator">:</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token keyword">import</span><span class="token punctuation">(</span><span class="token string">'../../features/parking-system/order-management.component'</span><span class="token punctuation">)</span>
        <span class="token punctuation">.</span><span class="token function">then</span><span class="token punctuation">(</span>m <span class="token operator">=></span> m<span class="token punctuation">.</span>OrderManagementComponent<span class="token punctuation">)</span><span class="token punctuation">,</span>
<span class="token punctuation">&#125;</span></code>`),s(i),f(u,e)}const ja=Object.freeze(Object.defineProperty({__proto__:null,default:$a,metadata:Cn},Symbol.toStringTag,{value:"Module"})),Tn={title:"Angular20 Http",date:"2025-12-12",category:"software",subCategory:"Frontend",tags:["fronted","angular","route"],slug:"angular_http"},{title:rc,date:dc,category:mc,subCategory:gc,tags:yc,slug:wc}=Tn;var Fa=w('<h6>Angular 有包好 HttpClient & HttpResource 可以直接拿來用</h6> <hr/> <p><strong><em>HttpClient</em></strong></p> <p>基於 RxJS Observable 所以可以使用物件提供的一套方法，錯誤自動透過 Observable 的 error channel 處理 2XX 外的都會拋出，需要手動 subscribe() 或搭配 async pipe 使用</p> <p><strong><em>HttpResource</em></strong></p> <p>基於 Signal 新推出 API，當依賴的 Signal 變化時自動重新請求，回傳的是 Resource 物件，包含 value()、status()、error() 等 Signal</p> <pre class="language-ts"><!></pre> <p>這邊的配置功能上</p> <ol><li>HttpResource 只做 Get( ) 用來處理 Service 類型的資料(權限表、個人資料等)</li> <li>HttpClient 、 error 做最基本，業務邏輯外部處理</li> <li>用繼承的方式處理不同 Domain 的使用場景</li></ol> <p>其餘有特殊需求就直接在該元件拿 BaseApiService + 額外實作就好</p> <pre class="language-ts"><!></pre>',1);function Ua(u){var e=Fa(),p=t(b(e),12),k=n(p);a(k,()=>`<code class="language-ts"><span class="token comment">// HttpClient 傳統寫法</span>
...
<span class="token punctuation">&#125;</span></code>`),s(o),f(u,e)}const Ba=Object.freeze(Object.defineProperty({__proto__:null,default:Ua,metadata:Tn},Symbol.toStringTag,{value:"Module"})),In={title:"Angular20 Signal",date:"2025-12-12",category:"software",subCategory:"Frontend",tags:["fronted","angular","route"],slug:"angular_signal"},{title:fc,date:bc,category:hc,subCategory:vc,tags:_c,slug:Sc}=In;var Ha=w('<h6>認識新的 StateAPI - Signal 參考 <a href="https://v20.angular.dev/guide/signals" rel="nofollow">Angular20</a>、<a href="https://nx.dev/blog/angular-state-management-2025" rel="nofollow">2025 AngularStateManagement</a></h6> <hr/> <h3>Signals</h3> <p>basic</p> <pre class="language-ts"><!></pre> <p><strong><em>signal 、 computed 、 effect、 linkedSignal</em></strong></p> <p>情境 - 根據地區(本島、外島)來控制可運送選項</p> <pre class="language-ts"><!></pre> <p>目前選單重置後都會預設第一個，再添加一個判斷”當前選項在新選單內就不變動”</p> <pre class="language-ts"><!></pre> <p>小結一下</p> <ul><li>computed : 純粹的衍生狀態 (tax = priceSignal * 0.05)</li> <li>effect : 當作流程控制響應(副作用處理)，例如跳出彈窗或打 API 等</li> <li>linkedSignal: 可被寫入的 computed</li></ul> <p><strong><em>signal state</em></strong></p> <p>ngrx 提供的API，主要在強型別和結構化上的規範</p> <pre class="language-ts"><!></pre> <p><strong><em>signal Store</em></strong></p> <pre class="language-ts"><!></pre>',1);function Va(u){var e=Ha(),p=t(b(e),8),k=n(p);a(k,()=>`<code class="language-ts"><span class="token comment">// basic</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">AppStore</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">update</span><span class="token punctuation">(</span>item<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(p);var o=t(p,6),r=n(o);a(r,()=>`<code class="language-ts"><span class="token comment">// signal</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">ShoppingCart</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">changeRegion</span><span class="token punctuation">(</span>region<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(o);var c=t(o,4),d=n(c);a(d,()=>`<code class="language-ts"><span class="token comment">// effect</span>
<span class="token decorator"><span class="token at operator">@</span><span class="token function">Component</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span><span class="token operator">...</span><span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">ShoppingCart</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">private</span> _options <span class="token operator">=</span> <span class="token generic-function"><span class="token function">signal</span><span class="token generic class-name"><span class="token operator">&lt;</span><span class="token builtin">string</span><span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token operator">></span></span></span><span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token string">'標準運送'</span><span class="token punctuation">,</span> <span class="token string">'快速運送'</span><span class="token punctuation">,</span> <span class="token string">'超商取貨'</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token keyword">private</span> _selected <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">_options</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token keyword">const</span> AppStore <span class="token operator">=</span> <span class="token function">signalStore</span><span class="token punctuation">(</span>
  ...
  <span class="token function">withMethods</span><span class="token punctuation">(</span><span class="token punctuation">(</span>state<span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">(</span><span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(i),f(u,e)}const Wa=Object.freeze(Object.defineProperty({__proto__:null,default:Va,metadata:In},Symbol.toStringTag,{value:"Module"})),Rn={title:"Angular20 RxJS TabService",date:"2025-12-05",category:"software",subCategory:"Frontend",tags:["fronted","angular","RxJS"],slug:"angular_tabService"},{title:Cc,date:Tc,category:Ic,subCategory:Rc,tags:Ec,slug:Ac}=Rn;var Ga=w('<h6>企業內部系統常用到的分頁顯示管理</h6> <hr/> <p>分頁管理器，主要功能會是需要可以</p> <ol><li>存放(已Instance)當前的分頁(Component)</li> <li>選擇該分頁替換內容</li> <li>銷毀分頁</li></ol> <p>至少要建立兩個資料模型</p> <pre class="language-ts"><!></pre> <h3>BehaviorSubject</h3> <p>RxJS庫提供一個可觀察物件 (Observable) BehaviorSubject。它主要用於宣告和管理一個帶有初始值的狀態變數。它同時具備「觀察者 (Observer)」和「可觀察物件 (Observable)」的特性。</p> <pre class="language-ts"><!></pre> <h3>Signal</h3> <p>新版 Angular(16+) 提供框架內部語法 Signal 來雙向監聽</p> <pre class="language-ts"><!></pre> <p>整體概念和 React18 useState 用法很像</p> <pre class="language-ts"><!></pre> <p>邏輯層 tab.service.ts</p> <pre class="language-ts"><!></pre> <p>UI層 tab-container.ts</p> <pre class="language-ts"><!></pre>',1);function Ya(u){var e=Ga(),p=t(b(e),10),k=n(p);a(k,()=>`<code class="language-ts"><span class="token comment">// 每個目錄的基本資料結構，用 id 當作唯一識別</span>
<span class="token keyword">interface</span> <span class="token class-name">MenuItem</span> <span class="token punctuation">&#123;</span>
    id<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">TabContainerComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(m),f(u,e)}const za=Object.freeze(Object.defineProperty({__proto__:null,default:Ya,metadata:Rn},Symbol.toStringTag,{value:"Module"})),En={title:"Angular Http Observable",date:"2025-06-22",category:"software",subCategory:"Frontend",tags:["http","angular","api"],slug:"angular_http_observable"},{title:xc,date:Pc,category:Dc,subCategory:Oc,tags:Nc,slug:Mc}=En;var Ja=w('<h6>RxJS Observable</h6> <hr/> <p>在 Angular 裡，HttpClient 的每個方法都會回傳一個 RxJS Observable，這些 Observable 屬於 cold 類型 —— 在訂閱（subscribe）時才真正發送請求。</p> <p>多次訂閱同一個 Observable 會觸發多次獨立的後端呼叫；若在請求途中解除訂閱，Angular 會直接 中止（abort）尚未完成的 HTTP 連線。</p> <pre class="language-js"><!></pre> <p>簡易封裝才可以靈活使用 pipe()、switchMap() …</p> <pre class="language-js"><!></pre> <h3>Observable 常見 Method</h3> <table><thead><tr><th>Operator</th><th>用途說明</th></tr></thead><tbody><tr><td><code>map()</code></td><td>資料轉換，取出你要的欄位、格式化資料</td></tr><tr><td><code>tap()</code></td><td>執行副作用（不改變資料），常用來 <code>console.log</code>, 設定 loading</td></tr><tr><td><code>switchMap()</code></td><td>用一筆資料觸發下一個 Observable，並自動取消舊的</td></tr><tr><td><code>mergeMap()</code></td><td>觸發下一個 Observable，但不取消前一筆（適合併發）</td></tr><tr><td><code>catchError()</code></td><td>錯誤處理，不讓錯誤中斷整個流程</td></tr><tr><td><code>finalize()</code></td><td>無論成功/失敗，最後一定會執行（常用來清除狀態）</td></tr><tr><td><code>retry(n)</code></td><td>API 失敗時，自動重試 n 次</td></tr><tr><td><code>timeout(ms)</code></td><td>若 Observable 超過時間未完成，會自動報錯</td></tr><tr><td><code>debounceTime(ms)</code></td><td>等使用者輸入穩定後才送出請求（防抖）</td></tr></tbody></table> <pre class="language-js"><!></pre>',1);function Ka(u){var e=Ja(),p=t(b(e),8),k=n(p);a(k,()=>`<code class="language-js"><span class="token keyword">this</span><span class="token punctuation">.</span>http<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'/api/getExportData'</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code>`),s(p);var o=t(p,4),r=n(o);a(r,()=>`<code class="language-js"><span class="token comment">// src/app/core/api/api.service.ts</span>
...
<span class="token punctuation">&#125;</span></code>`),s(o);var c=t(o,6),d=n(c);a(d,()=>`<code class="language-js"><span class="token keyword">this</span><span class="token punctuation">.</span>api<span class="token punctuation">.</span>get<span class="token operator">&lt;</span>any<span class="token operator">></span><span class="token punctuation">(</span><span class="token string">'/api/users'</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code>`),s(c),f(u,e)}const Xa=Object.freeze(Object.defineProperty({__proto__:null,default:Ka,metadata:En},Symbol.toStringTag,{value:"Module"})),An={title:"Angular Basic _ Route",date:"2025-06-22",category:"software",subCategory:"Frontend",tags:["route","angular","api"],slug:"angular_router"},{title:Lc,date:qc,category:$c,subCategory:jc,tags:Fc,slug:Uc}=An;var Qa=w('<h6>參考這個<a href="https://github.com/mbejda/AngularFire-Starter-Template" rel="nofollow">專案範本</a>、官方文件學習</h6> <hr/> <p>專案起始 index.html</p> <pre class="language-html"><!></pre> <p>元件去抓專案的根節點，render的內容用<code>&lt;router-outlet&gt;</code>佔位</p> <pre class="language-ts"><!></pre> <p>Route</p> <p>設定該路由(Path) <code>&lt;router-outlet&gt;</code>映射的元件</p> <pre class="language-ts"><!></pre> <p>且若添加 children 屬性擇該 映射的元件 裡面也可以再放一個佔位</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <h3>Route順序和路由守衛</h3> <p>Angular自帶跳轉和瀏覽權限設定，可自行放入<code>canActivate[]</code>裡面做邏輯判斷</p> <pre class="language-ts"><!></pre>',1);function Za(u){var e=Qa(),p=t(b(e),6),k=n(p);a(k,()=>`<code class="language-html"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">doctype</span> <span class="token name">html</span><span class="token punctuation">></span></span>
...
<span class="token punctuation">]</span><span class="token punctuation">;</span></code>`),s(m),f(u,e)}const nt=Object.freeze(Object.defineProperty({__proto__:null,default:Za,metadata:An},Symbol.toStringTag,{value:"Module"})),xn={title:"Angular Basic _ Start",date:"2025-06-22",category:"software",subCategory:"Frontend",tags:["fronted","angular","layout"],slug:"angular_basic"},{title:Bc,date:Hc,category:Vc,subCategory:Wc,tags:Gc,slug:Yc}=xn;var st=w(`<h6>參考這個<a href="https://github.com/mbejda/AngularFire-Starter-Template" rel="nofollow">專案範本</a> 、<a href="https://github.com/cao0085/angular-18" rel="nofollow">練習Repository</a>、官方文件學習</h6> <hr/> <pre class="language-shell"><!></pre> <h3>.component.ts</h3> <p>Component是Angular核心，負責收集要渲染的資料和掛載到指定節點，邏輯函式也是寫在這一層。</p> <pre class="language-ts"><!></pre> <h3>.component.html</h3> <pre class="language-html"><!></pre> <h3>表單處理</h3> <p>傳統資料流處理</p> <p><code>點擊輸入文字 -&gt; 觸發 'input' event -&gt; Calls setValue() -&gt; 'valueChanges' event to observers -&gt; Observers</code></p> <br/> <p>Angular 內保持雙向同步有兩種做法</p> <ol><li><p>Reactive forms (新版主流)</p> <p><code>點擊輸入文字 -&gt; 觸發 FormControl</code></p> <p><code>1. -&gt; Fires a 'valueChanges' event to observers -&gt; Observers</code></p> <p><code>2. -&gt; Notifies the ControlValueAccessor -&gt; Updates the DataValue</code></p></li></ol> <ol start="2"><li><p>Template-Driven forms (NgModel)</p> <p><code>點擊輸入文字 -&gt; 觸發 'input' event -&gt; ControlValueAccessor</code></p> <p><code>1. -&gt; Calls setValue() on the FormControl -&gt; Fires a 'valueChanges' event to observers -&gt; Observers</code></p> <p><code>2. -&gt; Calls viewToModelUpdate() -&gt; NgModel -&gt; Emits an ngModelChange event -&gt; Component -&gt; Component</code></p></li></ol> <p>驗證</p> <pre class="language-js"><!></pre> <pre class="language-js"><!></pre> <h3>投影 Content Projection</h3> <p>主要是讓元件的導入方可以自訂內容插入到這個元件中，就像 React 的 <code>props.children</code>。適合「UI 容器元件 + 插槽」的場景，例如 Dialog、Card、Tab、Layout 等常見 UI 元件。</p> <p>元件容器</p> <pre class="language-ts"><!></pre> <p>使用元件</p> <pre class="language-ts"><!></pre> <p>指定該 ClassName 去插入內容取代<code>ng-content</code>,且若沒被指定到<code>ng-content</code>也不會占位</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre>`,1);function at(u){var e=st(),p=t(b(e),4),k=n(p);a(k,()=>`<code class="language-shell">ng generate component hello-world

src/app/hello-world/
├── hello-world.component.ts
├── hello-world.component.html
├── hello-world.component.css
└── hello-world.component.spec.ts</code>`),s(p);var o=t(p,6),r=n(o);a(r,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">"@angular/core"</span><span class="token punctuation">;</span>
    ...
    <span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">ItemComponent</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token function">addItem</span><span class="token punctuation">(</span>description<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
            ...
            <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span></code>`),s(o);var c=t(o,4),d=n(c);a(d,()=>`<code class="language-html">    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>main<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
<span class="token operator">&lt;</span><span class="token operator">/</span>app<span class="token operator">-</span>card<span class="token operator">></span></code>`),s(h);var _=t(h,4),R=n(_);a(R,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>my-dialog</span><span class="token punctuation">></span></span></code>`),s(S),f(u,e)}const tt=Object.freeze(Object.defineProperty({__proto__:null,default:at,metadata:xn},Symbol.toStringTag,{value:"Module"})),Pn={title:"Angular Basic _ Value",date:"2025-06-22",category:"software",subCategory:"Frontend",tags:["fronted","angular","value"],slug:"angular_value02"},{title:zc,date:Jc,category:Kc,subCategory:Xc,tags:Qc,slug:Zc}=Pn;var pt=w(`<h6>應用中傳遞值的方法</h6> <hr/> <p><a href="https://angular.dev/guide/components/inputs#declaring-inputs-with-the-input-decorator" rel="nofollow">官方文件</a></p> <h3>Input</h3> <p>舊版寫法 <code>@Input()</code></p> <p>有提供一些屬性操作，可參考文件</p> <pre class="language-ts"><!></pre> <p>新版寫法 <code>import &#123; input &#125; from '@angular/core'</code></p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <h3>Output</h3> <p>都須維護兩個值</p> <br/> <p>舊版寫法 <code>@Output()</code></p> <pre class="language-js"><!></pre> <p>新版寫法<code>import &#123; input, output &#125; from '@angular/core'</code></p> <pre class="language-js"><!></pre> <pre class="language-html"><!></pre> <h3>ViewChild & ViewChildren</h3> <p>ViewChild(抓第一個) & ViewChildren(抓符合條件) 是 Angular 中的一種在元件 class 中存取 template 上某個/種類元素或元件實例的方法。</p> <p>舊版 @ViewChild()</p> <pre class="language-js"><!></pre> <pre class="language-html"><!></pre> <p>新版 viewChild()</p> <pre class="language-js"><!></pre> <p>可以這樣用</p> <pre class="language-js"><!></pre> <h3>Dependency Injection</h3> <pre class="language-ts"><!></pre> <pre class="language-ts"><!></pre> <h3>Signals</h3> <pre class="language-js"><!></pre> <pre class="language-ts"><!></pre> <p>常見用法</p> <pre class="language-ts"><!></pre> <h3>untracked()</h3> <p>讀取 signal 值，但不想讓它變成 reactive 依賴時，就用 untracked()</p> <p>原本</p> <pre class="language-js"><!></pre> <p>有時只需初始化時取值就好，所以不須自動追蹤。有需要再寫一個 function 取值</p> <pre class="language-js"><!></pre> <p>條件符合再反應一次</p> <pre class="language-js"><!></pre>`,1);function ot(u){var e=pt(),p=t(b(e),12),k=n(p);a(k,()=>`<code class="language-ts"><span class="token decorator"><span class="token at operator">@</span><span class="token function">Component</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span><span class="token operator">...</span><span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
...
<span class="token punctuation">&#125;</span></code>`),s(h);var _=t(h,2),R=n(_);a(R,()=>'<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">#myDiv</span><span class="token punctuation">></span></span>hello<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>'),s(_);var S=t(_,4),A=n(S);a(A,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component<span class="token punctuation">,</span> effect<span class="token punctuation">,</span> viewChild<span class="token punctuation">,</span> ElementRef <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">MyComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(S);var T=t(S,4),P=n(T);a(P,()=>`<code class="language-js"><span class="token comment">// div = viewChild.required('myDiv', &#123; read: ElementRef &#125;);</span>
<span class="token function">effect</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">HeroService</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(I);var x=t(I,2),O=n(x);a(O,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> HeroService <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'../services/hero.service'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">HeroComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">add</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">this</span><span class="token punctuation">.</span>heroes <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span>heroService<span class="token punctuation">.</span><span class="token function">getHeroes</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(x);var N=t(x,4),L=n(N);a(L,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
firstName<span class="token punctuation">.</span><span class="token function">update</span><span class="token punctuation">(</span><span class="token parameter">name</span> <span class="token operator">=></span> name<span class="token punctuation">.</span><span class="token function">toUpperCase</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(N);var q=t(N,2),Vn=n(q);a(Vn,()=>`<code class="language-ts"><span class="token keyword">const</span> firstName <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token string">'Morgan'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
firstName<span class="token punctuation">.</span><span class="token function">set</span><span class="token punctuation">(</span><span class="token string">'Jaime'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">firstNameCapitalized</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 'JAIME'（自動反應）</span></code>`),s(q);var $=t(q,4),Wn=n($);a(Wn,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component<span class="token punctuation">,</span> signal<span class="token punctuation">,</span> computed <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(j);var F=t(j,4),Yn=n(F);a(Yn,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal<span class="token punctuation">,</span> effect<span class="token punctuation">,</span> untracked <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(F);var B=t(F,4),zn=n(B);a(zn,()=>`<code class="language-js"><span class="token keyword">const</span> a <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">UserComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">setName</span><span class="token punctuation">(</span>newName<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>name<span class="token punctuation">.</span><span class="token function">set</span><span class="token punctuation">(</span>newName<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(h);var _=t(h,2),R=n(_);a(R,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Observable<span class="token punctuation">,</span> Subject<span class="token punctuation">,</span> BehaviorSubject <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'rxjs'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(S);var T=t(S,4),P=n(T);a(P,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> BehaviorSubject <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'rxjs'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(I);var x=t(I,4),O=n(x);a(O,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> AsyncSubject <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'rxjs'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(x);var N=t(x,4),L=n(N);a(L,()=>`<code class="language-ts">data$<span class="token punctuation">.</span><span class="token function">subscribe</span><span class="token punctuation">(</span>value <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),f(u,e)}const rt=Object.freeze(Object.defineProperty({__proto__:null,default:it,metadata:On},Symbol.toStringTag,{value:"Module"})),Nn={title:"Design Token",date:"2025-08-18",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"webdesign"},{title:rl,date:dl,category:ml,subCategory:gl,tags:yl,slug:wl}=Nn;var dt=w('<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>Color System</h3> <p>Primary Colors</p> <pre class="language-json"><!></pre> <p>Status Colors</p> <pre class="language-json"><!></pre> <p>Neutral Colors</p> <pre class="language-json"><!></pre> <h3>Typography System</h3> <p>Font Family</p> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre>',1);function mt(u){var e=dt(),p=t(b(e),8),k=n(p);a(k,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(m);var h=t(m,2),C=n(h);a(C,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(h);var _=t(h,2),R=n(_);a(R,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(_);var S=t(_,2),A=n(S);a(A,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(S);var T=t(S,2),P=n(T);a(P,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
&#125;</code>`),s(m),f(u,e)}const ft=Object.freeze(Object.defineProperty({__proto__:null,default:wt,metadata:Mn},Symbol.toStringTag,{value:"Module"})),Ln={title:"HTTP & FileStream",date:"2025-10-27",category:null,subCategory:null,tags:["http","filestream"],slug:"filestream"},{title:Cl,date:Tl,category:Il,subCategory:Rl,tags:El,slug:Al}=Ln;var bt=w('<p>實作串流相關 API</p> <hr/> <h3>FileStream 特性</h3> <ul><li>指針機制：串流有一個內部指針，讀取時會向前移動，讀完後就到了末尾</li> <li>記憶體效率：串流設計用來處理大文件，不會把整個文件載入記憶體</li> <li>即時處理：數據是可以邊讀邊處理的，適合有獨立資料結構導向的檔案類型</li></ul> <p><strong>適合的類型</strong> : <code>.txt</code>, <code>.csv</code>,<code>.jsonl</code>,<code>.mp3</code>, <code>.mp4</code></p> <p><strong>不適合的類型</strong> : <code>.json</code>, <code>.zip</code>, <code>.rar</code></p> <pre class="language-csharp"><!></pre> <p>這邊可邊接收邊處理，是因為 <strong>HTTP 不同 Request 參數類型，會有不同的執行時機</strong>，例如:</p> <ul><li><p>String / Object：Body 完整接收後才執行，資料立即可用（適合小型資料、JSON）</p></li> <li><p>IFormFile：Headers 接收後就執行，檔案資訊立即可用但內容需等待串流（適合大型檔案）</p></li></ul>',1);function ht(u){var e=bt(),p=t(b(e),12),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token comment">// 串流處理：記憶體效率高</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),E(4),f(u,e)}const vt=Object.freeze(Object.defineProperty({__proto__:null,default:ht,metadata:Ln},Symbol.toStringTag,{value:"Module"})),qn={title:"Http Connect",date:"2025-09-03",category:"software",subCategory:"Internet",tags:["Http","tcp","backend"],slug:"http_connect"},{title:xl,date:Pl,category:Dl,subCategory:Ol,tags:Nl,slug:Ml}=qn;var _t=w('<h3>TCP 連線的運作機制</h3> <ol><li><p>伺服器主機主動開啟 Port <code>net.Listen("tcp", ":4000")</code></p></li> <li><p>同時 <code>conn, err := listener.Accept()</code> 等待連接</p></li> <li><p>客戶端發送請求 <code>server_ip:4000</code> OS 背後做 TCP 三次握手驗證</p></li> <li><p>資料會傳送到 <code>OS緩衝區</code>，程式則會定期去緩衝區讀取資料處理</p></li></ol> <h3>Server 的核心特性</h3> <ul><li>持續運行（Long-running Process）</li> <li>對外提供通訊介面</li></ul> <pre class="language-go"><!></pre> <p>HTTP 本身是個字串，會需要嚴格的解析流程，可以導入狀態機的概念去處理如:</p> <ul><li>解析請求行 → 提取方法、路徑、版本</li> <li>解析標頭   → 逐行讀取 key: value</li> <li>解析請求體 → 根據 Content-Length 讀取</li></ul> <pre class="language-go"><!></pre>',1);function St(u){var e=_t(),p=t(b(e),8),k=n(p);a(k,()=>`<code class="language-go"><span class="token keyword">package</span> main
...
<span class="token punctuation">&#125;</span></code>`),s(o);var c=t(o,8),d=n(c);a(d,()=>`<code class="language-javascript"><span class="token keyword">const</span> <span class="token constant">WCV_DEFAULT_SETTING</span> <span class="token operator">=</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c),E(10),f(u,e)}const jt=Object.freeze(Object.defineProperty({__proto__:null,default:$t,metadata:Bn},Symbol.toStringTag,{value:"Module"})),Hn={title:"CSS Render 範本",date:"2025-06-22",category:null,subCategory:null,tags:["svelte","blog","markdown"],slug:"example"},{title:ru,date:du,category:mu,subCategory:gu,tags:yu,slug:wu}=Hn;var Ft=w('<p>這是第一篇文章，用來展示部落格如何從 markdown 載入內容。</p> <hr/> <h1>這是 H1 標題</h1> <h2>這是 H2 標題</h2> <h3>這是 H3 標題</h3> <hr/> <p>段落文字：這是一段普通的段落內容，展示預設的段落文字樣式。</p> <p>強調文字：<strong>粗體</strong>、<em>斜體</em>、<del>刪除線</del>。</p> <hr/> <h3>清單測試</h3> <ul><li>無序清單項目 1</li> <li>無序清單項目 2 <ul><li>子項目 a</li> <li>子項目 b</li></ul></li></ul> <ol><li>有序清單項目 1</li> <li>有序清單項目 2 <ol><li>子項目 i</li> <li>子項目 ii</li></ol></li></ol> <hr/> <h3>程式碼區塊</h3> <h4>行內程式碼</h4> <p>例如你可以這樣寫：<code>console.log("Hello Svelte!")</code></p> <h4>區塊程式碼</h4> <pre class="language-js"><!></pre>',1);function Ut(u){var e=Ft(),p=t(b(e),34),k=n(p);a(k,()=>`<code class="language-js"><span class="token keyword">function</span> <span class="token function">greet</span><span class="token punctuation">(</span><span class="token parameter">name</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> <span class="token template-string"><span class="token template-punctuation string">&#96;</span><span class="token string">Hello, </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">$&#123;</span>name<span class="token interpolation-punctuation punctuation">&#125;</span></span><span class="token string">!</span><span class="token template-punctuation string">&#96;</span></span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(p),f(u,e)}const Bt=Object.freeze(Object.defineProperty({__proto__:null,default:Ut,metadata:Hn},Symbol.toStringTag,{value:"Module"})),U=[],Y=Object.assign({"/src/content/Backend/BackgroudService.md":es,"/src/content/Backend/DDD_layer.md":us,"/src/content/Backend/DDD_mediator.md":rs,"/src/content/Backend/DDD_outbox.md":gs,"/src/content/Backend/EFCore_Codefirst.md":fs,"/src/content/Backend/FSM.md":vs,"/src/content/Database/Paxon_1.md":Cs,"/src/content/Database/Paxon_2.md":Rs,"/src/content/Database/consistency_1.md":xs,"/src/content/Database/consistency_2.md":Os,"/src/content/Database/consistency_3.md":Ls,"/src/content/Database/db_leetcode50.md":js,"/src/content/Database/db_normalization.md":Bs,"/src/content/Database/db_relational.md":Ws,"/src/content/Database/db_sql.md":zs,"/src/content/Database/db_table_1.md":Xs,"/src/content/Devlop-Note/cashflow.md":na,"/src/content/Devlop-Note/jsPDF.md":ta,"/src/content/Devlop-Note/pdfMerge.md":ea,"/src/content/Devlop-Note/reconcile.md":ua,"/src/content/Devlop-Note/sftp_ftps.md":ra,"/src/content/Devlop-Note/structurizr.md":ga,"/src/content/Devlop-Note/summary_2025.md":fa,"/src/content/Devlop-Note/xlsx_excel.md":va,"/src/content/Fronted/Electron_01.md":Ca,"/src/content/Fronted/Kotlin_01.md":Ra,"/src/content/Fronted/ThreeJS.md":xa,"/src/content/Fronted/angular20_AuthRoute_01.md":Oa,"/src/content/Fronted/angular20_AuthRoute_02.md":La,"/src/content/Fronted/angular20_AuthRoute_03.md":ja,"/src/content/Fronted/angular20_Http.md":Ba,"/src/content/Fronted/angular20_Signal.md":Wa,"/src/content/Fronted/angular20_tabService.md":za,"/src/content/Fronted/angular_basic_http.md":Xa,"/src/content/Fronted/angular_basic_router.md":nt,"/src/content/Fronted/angular_basic_start.md":tt,"/src/content/Fronted/angular_basic_value.md":et,"/src/content/Fronted/angular_basic_value_02.md":ut,"/src/content/Fronted/css.md":rt,"/src/content/Fronted/design_token.md":gt,"/src/content/Http/CORS.md":ft,"/src/content/Http/filestream.md":vt,"/src/content/Http/http_connect.md":Ct,"/src/content/Http/http_secretKey.md":Rt,"/src/content/Http/nginx.md":xt,"/src/content/Project/blog.md":Ot,"/src/content/Project/webpreviewer.md":Lt,"/src/content/Project/websiteeditor.md":jt,"/src/content/empty.md":Bt});for(const u in Y){const e=Y[u];U.push({category:e.metadata.category,subCategory:e.metadata.subCategory,title:e.metadata.title,slug:e.metadata.slug,date:e.metadata.date,tags:e.metadata.tags,excerpt:e.metadata.excerpt??"",component:e.default})}U.sort((u,e)=>e.date.localeCompare(u.date));const fu=ts(U);export{ga as A,ra as B,ua as C,ea as D,ta as E,na as F,Xs as G,zs as H,Ws as I,Bs as J,js as K,Ls as L,Os as M,xs as N,Rs as O,Cs as P,vs as Q,fs as R,gs as S,rs as T,us as U,es as V,fu as W,Bt as _,jt as a,Lt as b,Ot as c,xt as d,Rt as e,Ct as f,vt as g,ft as h,gt as i,rt as j,ut as k,et as l,tt as m,nt as n,Xa as o,za as p,Wa as q,Ba as r,ja as s,La as t,Oa as u,xa as v,Ra as w,Ca as x,va as y,fa as z};
