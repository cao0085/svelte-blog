import{b as B,d as zn,f as w,a as f}from"./Cew64nlL.js";import"./C5SEx9ip.js";import{t as Jn,h as V,a as W,P as Xn,aH as Kn,d as G,V as Qn,Y as Zn,W as ns,B as ss,T as L,s as t,o as b,v as n,w as s,aI as R}from"./COc0ozwQ.js";import{r as as}from"./CR_4RHM7.js";function a(u,o,p=!1,k=!1,e=!1){var r=u,c="";Jn(()=>{var d=Xn;if(c===(c=o()??"")){V&&W();return}if(d.nodes_start!==null&&(Kn(d.nodes_start,d.nodes_end),d.nodes_start=d.nodes_end=null),c!==""){if(V){G.data;for(var l=W(),g=l;l!==null&&(l.nodeType!==8||l.data!=="");)g=l,l=Qn(l);if(l===null)throw Zn(),ns;B(G,g),r=ss(l);return}var i=c+"";p?i=`<svg>${i}</svg>`:k&&(i=`<math>${i}</math>`);var y=zn(i);if((p||k)&&(y=L(y)),B(L(y),y.lastChild),p||k)for(;L(y);)r.before(L(y));else r.before(y)}})}const z={title:"Base Backgroud Service",date:"2025-09-25",category:"software",subCategory:"Backend",tags:["Backgroud","backend","markdown"],slug:"backgroudservice"},{title:Bt,date:Vt,category:Wt,subCategory:Gt,tags:Yt,slug:zt}=z;var ts=w('<h6>C#實作非立即性的服務排序</h6> <hr/> <h3>使用背景</h3> <p>當主程式的 DI 註冊週期是以 HTTP lifecycle 為主時，可藉由 Background Service 提供長期運行的服務容器。</p> <ol><li>非阻塞式處理：可由外部 API 觸發某些動作，立即回應用戶端而不等待處理完成</li> <li>解耦合設計：將耗時的業務邏輯從 HTTP 請求週期中分離出來</li> <li>簡易事件模式：作為一個輕量級的 Event pattern 實現，處理非即時性任務</li> <li>資源管理：避免長時間佔用 HTTP 連線資源，提升系統整體效能</li></ol> <h3>Channel 基礎原理</h3> <p>Channel 是 .NET Core 提供的 thread-safe 生產者-消費者模式實作，基於 System.Threading.Channels 命名空間。它解決了多執行緒環境下的資料傳遞問題。</p> <pre class="language-csharp"><!></pre> <h3>Channel 的監聽機制</h3> <p>寫入機制 (Producer)</p> <pre class="language-csharp"><!></pre> <p>讀取監聽機制 (Consumer)</p> <pre class="language-csharp"><!></pre> <h3>基本架構</h3> <p>DI註冊</p> <pre class="language-csharp"><!></pre> <p>Controller</p> <pre class="language-csharp"><!></pre> <p>服務內部</p> <pre class="language-csharp"><!></pre>',1);function ps(u){var o=ts(),p=t(b(o),14),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token class-name"><span class="token keyword">var</span></span> channel <span class="token operator">=</span> Channel<span class="token punctuation">.</span><span class="token generic-method"><span class="token function">CreateUnbounded</span><span class="token generic class-name"><span class="token punctuation">&lt;</span>YourRequestType<span class="token punctuation">></span></span></span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// Channel 包含兩個部分</span>
...
builder<span class="token punctuation">.</span>Services<span class="token punctuation">.</span><span class="token function">AddTransient</span><span class="token punctuation">(</span><span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">IPipelineBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">,</span> <span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">ValidationBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(m);var h=t(m,8),C=n(h);a(C,()=>`<code class="language-csharp"><span class="token comment">// .csproj</span>
...
<span class="token operator">&lt;</span><span class="token class-name">PackageReference</span> Include<span class="token operator">=</span><span class="token string">"MassTransit.RabbitMQ"</span> Version<span class="token operator">=</span><span class="token string">"8.1.2"</span> <span class="token operator">/</span><span class="token operator">></span></code>`),s(h);var _=t(h,2),E=n(_);a(E,()=>`<code class="language-csharp"><span class="token comment">// Program.cs</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(_);var S=t(_,4),A=n(S);a(A,()=>'<code class="language-csharp"><span class="token keyword">await</span> _sendEndpoint<span class="token punctuation">.</span><span class="token function">Send</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">GenerateInvoice</span> <span class="token punctuation">&#123;</span> OrderId <span class="token operator">=</span> <span class="token string">"123"</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(S);var T=t(S,4),x=n(T);a(x,()=>'<code class="language-csharp"><span class="token keyword">await</span> _publishEndpoint<span class="token punctuation">.</span><span class="token function">Publish</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">UserCreated</span> <span class="token punctuation">&#123;</span> UserId <span class="token operator">=</span> Guid<span class="token punctuation">.</span><span class="token function">NewGuid</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(T);var I=t(T,4),D=n(I);a(D,()=>`<code class="language-csharp">cfg<span class="token punctuation">.</span><span class="token function">ConfigureMediator</span><span class="token punctuation">(</span><span class="token punctuation">(</span>context<span class="token punctuation">,</span> cfg<span class="token punctuation">)</span> <span class="token operator">=></span>
    <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(I);var P=t(I,2),N=n(P);a(N,()=>`<code class="language-csharp"><span class="token punctuation">[</span><span class="token attribute"><span class="token class-name">HttpPost</span><span class="token attribute-arguments"><span class="token punctuation">(</span><span class="token string">"register"</span><span class="token punctuation">)</span></span></span><span class="token punctuation">]</span>
...
<span class="token punctuation">&#125;</span></code>`),s(P),f(u,o)}const is=Object.freeze(Object.defineProperty({__proto__:null,default:ks,metadata:X},Symbol.toStringTag,{value:"Module"})),K={title:"Domain-Driven - Outbox Message",date:"2025-06-23",category:"software",subCategory:"Backend",tags:["DDD","backend","design"],slug:"ddd_outbox"},{title:cp,date:lp,category:up,subCategory:kp,tags:ip,slug:rp}=K;var rs=w('<h6>拆分主副邏輯，同時保持資料同步性</h6> <hr/> <h2>SideEffect</h2> <p>若把 DDD 流程中的主副行為拆分：</p> <ul><li>創建員工帳戶的時候 <code>&lt;TABLE_Employee&gt;</code> 新增一筆資料</li> <li>幫對應到的 <code>&lt;TABLE_Department&gt;_Headcount</code> 總人數加一</li></ul> <br/> <p>若是以依照 MVC 架構會是</p> <pre class="language-csharp"><!></pre> <p>用 DDD 寫則變成是</p> <pre class="language-csharp"><!></pre> <p>假設創建員工帳號變為須更新 5-10 張表單,函式會越來越巨大、複雜且難以測試與維護。透過 DDD 的 Domain Event 拆解副作用邏輯可異步處理，減少主流程延遲。</p> <h2>ASIO 原子性（Atomicity of Side-Effect & IO）</h2> <p>剛剛提到的行為，主邏輯成功時無法保證所有副作用（如更新部門、發送通知等）都成功執行，這違反了分散系統中常見的 資料一致性與原子性要求。</p> <p>解決方法是設計一張資料庫新表<code>&lt;DB_Outbox_Message&gt;</code>，在一筆交易中提交主邏輯與事件，且把事件訊息<code>(Event、Payload、Time)</code>寫入這張表。這樣執行失敗也有紀錄可以查驗，也可設計失敗的 Retry 機制。</p> <br/> <p>主要實踐方法是用背景應用重複執行，訪問 DB_Outbox_Message 執行該事件</p> <pre class="language-csharp"><!></pre>',1);function ds(u){var o=rs(),p=t(b(o),14),k=n(p);a(k,()=>`<code class="language-csharp">db_Employee<span class="token punctuation">.</span><span class="token function">Add</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c),f(u,o)}const ms=Object.freeze(Object.defineProperty({__proto__:null,default:ds,metadata:K},Symbol.toStringTag,{value:"Module"})),Q={title:"Finite-State Machine",date:"2025-06-30",category:"software",subCategory:"Backend",tags:["FSM","backend","markdown"],slug:"FSM"},{title:dp,date:mp,category:gp,subCategory:yp,tags:wp,slug:fp}=Q;var gs=w('<h6>FSM 這是一種類比電路常見的概念，用金流常見的狀態模擬看看。</h6> <hr/> <h3>核心概念</h3> <p>狀態是封閉集合其一：Pending / Paid / Failed / RefundPending / Refunded。</p> <p>事件是唯一入口：只有明確的事件才能讓狀態改變。</p> <pre class="language-csharp"><!></pre> <table><thead><tr><th>CurrentState</th><th>Trigger</th><th>NextState</th></tr></thead><tbody><tr><td>Pending</td><td>PaySucceeded</td><td>Paid</td></tr><tr><td>Pending</td><td>PayFailed</td><td>Failed</td></tr><tr><td>Paid</td><td>StartRefund</td><td>RefundPending</td></tr><tr><td>RefundPending</td><td>RefundSucceeded</td><td>Refunded</td></tr><tr><td>RefundPending</td><td>RefundFailed</td><td>Paid</td></tr><tr><td>Failed/Refunded</td><td><em>(無任何事件)</em></td><td><em>(終點)</em></td></tr></tbody></table> <h3>簡易流程</h3> <pre class="language-csharp"><!></pre> <p>限制行為的方式</p> <pre class="language-csharp"><!></pre> <h3>測試與擴充</h3> <p>單元測試每條轉移：「Pending → PaySucceeded → Paid」。</p> <p>新增流程：只要在 enum + 轉移表多加一條，和對應 trigger 的處理；主程式 switch(fsm.CurrentState) 自動接手 DB 差異。</p>',1);function ys(u){var o=gs(),p=t(b(o),10),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token comment">// 狀態（State）</span>
...
但是如果_R3突然掛掉了，可以找一個替代伺服器_R4，只是_R4儲存的資料需要標記，等_R3恢復後再回補</p> <pre class="language-text"><!></pre>`,1);function Ts(u){var o=Cs(),p=t(b(o),34),k=n(p);a(k,()=>`<code class="language-text">庫存初始值：100
...
<span class="token punctuation">(</span>
  ...
  <span class="token keyword">LIMIT</span> <span class="token number">1</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(m);var h=t(m,6),C=n(h);a(C,()=>`<code class="language-sql"><span class="token keyword">SELECT</span> id<span class="token punctuation">,</span> <span class="token function">COUNT</span><span class="token punctuation">(</span><span class="token operator">*</span><span class="token punctuation">)</span> <span class="token keyword">AS</span> num
<span class="token keyword">FROM</span> <span class="token punctuation">(</span>
...
-------|------------|-----
DB     | Smith      | R1
DB     | Jones      | R2</code>`),s(m);var h=t(m,4),C=n(h);a(C,()=>`<code class="language-text">-- 課程與教室（CourseRoom）
Course | Room
-------|-----
DB     | R1
...
Instructor | Room
-----------|-----
Smith      | R1</code>`),s(h);var _=t(h,6),E=n(_);a(E,()=>`<code class="language-text">錯誤
Restaurant | Crust   | Area
-----------|---------|--------
X Pizza    | Thick   | Downtown
X Pizza    | Stuffed | Downtown
X Pizza    | Thick   | Uptown
X Pizza    | Stuffed | Uptown</code>`),s(_);var S=t(_,4),A=n(S);a(A,()=>`<code class="language-text">Restaurant | Crust
Restaurant | Area</code>`),s(S);var T=t(S,6),x=n(T);a(x,()=>`<code class="language-text">-- Supplier-Part
S1 | P1
...
---------|------|---------
S1       | P1   | J1  （合理）
S1       | P1   | J2  （若 J2 並不屬於 P1）</code>`),s(T);var I=t(T,4),D=n(I);a(D,()=>`<code class="language-text">-- Supplier-Part-Project
Supplier | Part | Project
---------|------|---------
S1       | P1   | J1</code>`),s(I),f(u,o)}const Ms=Object.freeze(Object.defineProperty({__proto__:null,default:$s,metadata:on},Symbol.toStringTag,{value:"Module"})),en={title:"關聯式資料庫",date:"2025-06-22",category:"software",subCategory:"Database",tags:["database","db","sql"],slug:"db_relational"},{title:co,date:lo,category:uo,subCategory:ko,tags:io,slug:ro}=en;var js=w('<pre class="language-pgsql"><!></pre> <p>連接 SQL Server 時是透過 TDS（Tabular Data Stream）的通訊協定來交換資料。</p> <ul><li>TDS 是 SQL Server 專用的底層通訊協定，負責在用戶端與資料庫伺服器之間傳遞</li> <li>通常透過 TCP/IP 傳輸，預設使用的連接埠為 1433。</li> <li>用戶端要連接資料庫時，會使用一段 Connection String（連線字串）</li></ul> <pre class="language-pgsql"><!></pre> <h3>Table（資料表）</h3> <p>資料表是資料的儲存核心，每個表由「列（row）」與「欄（column）」構成。</p> <pre class="language-sql"><!></pre> <h3>Primary Key（主鍵）</h3> <p>能唯一標識每一筆資料，一張表只能有一個主鍵，可以是單一欄位或多欄位組成（複合主鍵）。</p> <pre class="language-sql"><!></pre> <h3>Unique Constraint（唯一約束）</h3> <p>限制欄位值不能重複，一張表可以有多個唯一欄位。</p> <pre class="language-sql"><!></pre> <h3>Foreign Key（外鍵）</h3> <pre class="language-sql"><!></pre> <h3>Index（索引）</h3> <p>加速查詢效率，類似書本的目錄，索引可以建立在單一欄位或多個欄位上。</p> <pre class="language-sql"><!></pre>',1);function Fs(u){var o=js(),p=b(o),k=n(p);a(k,()=>`<code class="language-pgsql">SQL Server Instance
├── Database
│   ├── Schema
│   │   ├── Table
│   │   ├── View
...
└─ C <span class="token punctuation">(</span>ID=3<span class="token punctuation">)</span></code>`),s(m);var h=t(m,6),C=n(h);a(C,()=>`<code class="language-sql"><span class="token comment">-- 查詢某節點的所有後代（含自己）</span>
...
<span class="token keyword">ORDER</span> <span class="token keyword">BY</span> cc<span class="token punctuation">.</span>Depth<span class="token punctuation">;</span></code>`),s(h);var _=t(h,6),E=n(_);a(E,()=>`<code class="language-sql"><span class="token comment">-- 對所有 ancestor of parentId，插入新後代關係</span>
...
<span class="token keyword">return</span> Response<span class="token punctuation">;</span></code>`),s(l),R(16),f(u,o)}const Xs=Object.freeze(Object.defineProperty({__proto__:null,default:Js,metadata:un},Symbol.toStringTag,{value:"Module"})),kn={title:"Download PDF",date:"2025-06-22",category:"software",subCategory:"開發筆記",tags:["pdf","js","dom"],slug:"jsPDF"},{title:Do,date:Oo,category:No,subCategory:Lo,tags:qo,slug:$o}=kn;var Ks=w('<h6>紀錄下載影像相關處理 <a href="https://github.com/cao0085/code-pattern/tree/main/fronted-pdf-download" rel="nofollow">相關程式碼</a></h6> <hr/> <h3>畫面截圖類型（html2canvas、dom-to-image…）</h3> <p>原理大多是用<code>document.query(ID / class)</code>抓取指定的<code>DOM</code>，在套件內<strong>模擬</strong>JS排版樣式引擎(所以可能會跑版)，繪圖在 HTML<code>&lt;canvas&gt;</code>Element 後再轉成 base64/Blob 格式輸出。</p> <p>要注意的是瀏覽器對於能當作繪製<code>&lt;canvas&gt;</code>的來源控管較為嚴格，例如在瀏覽器渲染的 img 來源可以使用，套件內被擋下來的問題，再來就是錯誤是發生在套件內部不好除錯。</p> <br/> <h3>向量型（jsPDF、pdf-lib…）</h3> <p>用程式碼直接描述格線、文字 ，也可以插入圖片當作背景。要注意的一樣是外部來源的合法(圖片、字體)，圖片可先在.js 轉換成 base64 當作來源給套件使用，減少套件內轉換失敗的風險。</p> <h4>jsPDF</h4> <p>添加字體方式有兩種方式讀取.ttf和.js，一樣讓套件讀取處理過的資源部屬比較穩定</p> <p>網站下載 .ttf 字體向量檔案</p> <pre class="language-js"><!></pre> <p>把 .ttf 轉成.js 再import到模組，因為字型檔案很大要用到再載入就好</p> <pre class="language-js"><!></pre> <p>圖片轉URL</p> <pre class="language-js"><!></pre> <p>下載和預覽</p> <pre class="language-js"><!></pre>',1);function Qs(u){var o=Ks(),p=t(b(o),22),k=n(p);a(k,()=>`<code class="language-js"><span class="token comment">// var pdfDoc = 建立一個 jsPDF 提供的物件(&#123; unit: 'mm', format: 'a4' &#125;)</span>
...
pdfDoc<span class="token punctuation">.</span><span class="token function">save</span><span class="token punctuation">(</span><span class="token string">"fileName.pdf"</span><span class="token punctuation">)</span></code>`),s(l),f(u,o)}const Zs=Object.freeze(Object.defineProperty({__proto__:null,default:Qs,metadata:kn},Symbol.toStringTag,{value:"Module"})),rn={title:"多個 PDF 檔案合併",date:"2025-09-16",category:"software",subCategory:"開發筆記",tags:["pdf","backend","command"],slug:"pdfmarge"},{title:Mo,date:jo,category:Fo,subCategory:Uo,tags:Ho,slug:Bo}=rn;var na=w('<h6><a href="https://github.com/cao0085/pdfMerger" rel="nofollow">Repository</a> ，Python 執行相容性比較好，C# UI方便友善</h6> <hr/> <h3>C#</h3> <pre class="language-csharp"><!></pre> <pre class="language-csharp"><!></pre> <h3>Python3</h3> <pre class="language-bash"><!></pre> <pre class="language-python"><!></pre>',1);function sa(u){var o=na(),p=t(b(o),6),k=n(p);a(k,()=>`<code class="language-csharp">  <span class="token comment">// .csproj</span>
...
確認檔案產出再 Update 資料庫</p> <pre class="language-csharp"><!></pre> <pre class="language-csharp"><!></pre>`,1);function pa(u){var o=ta(),p=t(b(o),16),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token comment">/// &lt;summary></span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(m),f(u,o)}const oa=Object.freeze(Object.defineProperty({__proto__:null,default:pa,metadata:dn},Symbol.toStringTag,{value:"Module"})),mn={title:"SFTP、FTPS C# 連線測試",date:"2025-10-01",category:"software",subCategory:"開發筆記",tags:["tcp","ip","container"],slug:"sftp_ftps"},{title:Xo,date:Ko,category:Qo,subCategory:Zo,tags:ne,slug:se}=mn;var ea=w('<h6>紀錄本地端測試方法</h6> <hr/> <h3>SFTP</h3> <p>docker-compose.yml</p> <pre class="language-yml"><!></pre> <pre class="language-csharp"><!></pre> <h3>FTPS</h3> <pre class="language-csharp"><!></pre> <p>docker-compose.yml</p> <pre class="language-yml"><!></pre> <h3>2SFTP+FTPS</h3> <pre class="language-yml"><!></pre>',1);function ca(u){var o=ea(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-yml"><span class="token key atrule">services</span><span class="token punctuation">:</span>
...
<span class="token punctuation">&#125;</span></code>`),s(i);var m=t(i,6),v=n(m);a(v,()=>`<code class="language-kotlin"><span class="token keyword">class</span> ArticleViewModel <span class="token operator">:</span> <span class="token function">ViewModel</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">fun</span> <span class="token function">fetchViewCount</span><span class="token punctuation">(</span>articleId<span class="token operator">:</span> String<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(m);var h=t(m,6),C=n(h);a(C,()=>`<code class="language-kotlin"><span class="token keyword">class</span> ArticleViewModel <span class="token operator">:</span> <span class="token function">ViewModel</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">fun</span> <span class="token function">recordPageView</span><span class="token punctuation">(</span>articleId<span class="token operator">:</span> String<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(h);var _=t(h,10),E=n(_);a(E,()=>`<code class="language-kotlin"><span class="token comment">// 這種錯誤應該 Crash,讓開發者知道有 Bug</span>
...
<span class="token punctuation">&#125;</span></code>`),s(_);var S=t(_,4),A=n(S);a(A,()=>`<code class="language-kotlin">
...
<span class="token keyword">fun</span> <span class="token function">loadPosts</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    viewModelScope<span class="token punctuation">.</span><span class="token function">launch</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(S),f(u,o)}const Sa=Object.freeze(Object.defineProperty({__proto__:null,default:_a,metadata:bn},Symbol.toStringTag,{value:"Module"})),hn={title:"插入 3D 影像",date:"2025-08-13",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"threeJs"},{title:De,date:Oe,category:Ne,subCategory:Le,tags:qe,slug:$e}=hn;var Ca=w(`<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>匯入 .glb</h3> <p>透過用 three.js 匯入
Canvas ➜ WebGL ➜ Three.js ➜ GLB 模型 ➜ GPU 顯示</p> <pre class="language-js"><!></pre>`,1);function Ta(u){var o=Ca(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-js">  <span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> <span class="token constant">THREE</span> <span class="token keyword">from</span> <span class="token string">'three'</span><span class="token punctuation">;</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(p),f(u,o)}const Ia=Object.freeze(Object.defineProperty({__proto__:null,default:Ta,metadata:hn},Symbol.toStringTag,{value:"Module"})),vn={title:"Angular20 Auth & Route 01",date:"2025-12-08",category:"software",subCategory:"Frontend",tags:["fronted","angular","route"],slug:"angular_AuthRoute_01"},{title:Me,date:je,category:Fe,subCategory:Ue,tags:He,slug:Be}=vn;var Ra=w('<h6>基於 RBAC 實作權限控管和畫面渲染，先處理資料結構設計</h6> <hr/> <p>和要求資料庫一致性一樣，越全面的權限控管程式碼就會複雜很多，所以根據專案的使用場景去選擇想要的架構。</p> <p>這次需求是【登入】後才可以使用的 ERP 系統，其他都導到login、401、403、404 就可以了。這次我的需求是</p> <ol><li><p>權限控制的顆粒度設計: 除了按照常見的 admin/manager/user 層級分級外，還需要可以控制到單一使用者的行為。</p></li> <li><p>限制後行為處理: 當不符權限時還需分成不同情況處理，例如</p> <ul><li>目錄層級沒有權限就不顯示</li> <li>編輯/刪除操作需要跳出提醒框【尚無權限，請與經理申請開通】</li></ul></li> <li><p>防止緩存、網路異常和惡意攻擊: 即使阻斷使用者入口(隱藏 UI 元件)，後端仍需實作獨立的權限驗證防禦。代表前後端（使用不同語言）必須維護一組權限常數定義。</p></li></ol> <h3>DB TABLE</h3> <p>最小實踐 3 張可以完成結構: 人員表 / 行為表 / 人員行為表(多對多)</p> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <p>這時若要建立 n 帳號，連結表就會新增 n * n 筆資料，要解決資料量需要再開一張 role 定義表，來當作集合使用 ( user -> role -> Claims )</p> <p>不把 userRoles 直接合併到 user 是因為有可能單一人員有多種身份(A子公司的副理、B子公司的開發人員) 保持可擴充性。</p> <pre class="language-json"><!></pre> <p>現在則是每個角色的權限都一樣，想要開特權/黑名單則需要再開一張表。</p> <pre class="language-json"><!></pre> <p>核心概念就是定義一張權限總表集中管理，存/取方式就用關聯+集合+邏輯判斷。</p> <p>查詢 SQL 大概會長這樣</p> <pre class="language-sql"><!></pre> <h3>前端的資料模型</h3> <p>把 DB 定義的常數值複製一份到前端，避免沒有同步更新、人為字串問題時可以好找錯誤。</p> <pre class="language-ts"><!></pre> <h3>維護更新</h3> <p>以後要新作功能流程時候，就是</p> <ol><li>DB Claim Table 添加一個事件</li> <li>RoleClaim Table 綁定事件權限</li> <li>前端 ClaimCode.ts 同步添加就可以模組化使用了</li></ol>',1);function Ea(u){var o=Ra(),p=t(b(o),14),k=n(p);a(k,()=>`<code class="language-json">    <span class="token comment">// 人員表</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">,</span></code>`),s(p);var e=t(p,2),r=n(e);a(r,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
    ...
    <span class="token property">"userClaims"</span><span class="token operator">:</span> <span class="token punctuation">[</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">]</span>
<span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,6),d=n(c);a(d,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
    <span class="token property">"users"</span><span class="token operator">:</span> <span class="token punctuation">[</span>
        <span class="token punctuation">&#123;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">AuthService</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(p);var e=t(p,6),r=n(e);a(r,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Injectable<span class="token punctuation">,</span> signal<span class="token punctuation">,</span> computed <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">PermissionService</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,10),d=n(c);a(d,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Routes <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/router'</span><span class="token punctuation">;</span>
...
</code>`),s(l),R(2),f(u,o)}const Da=Object.freeze(Object.defineProperty({__proto__:null,default:xa,metadata:_n},Symbol.toStringTag,{value:"Module"})),Sn={title:"Angular20 Auth & Route 03",date:"2025-12-11",category:"software",subCategory:"Frontend",tags:["fronted","angular","route"],slug:"angular_AuthRoute_03"},{title:Xe,date:Ke,category:Qe,subCategory:Ze,tags:nc,slug:sc}=Sn;var Oa=w('<h6>基於 RBAC 實作權限控管和畫面渲染，處理 UI/UX</h6> <hr/> <h3>Layout</h3> <p>主畫面的 Layout 會是常見的</p> <ol><li>Header 放入基本資料</li> <li>SideBar 側邊攔根據權限 Render 出入口</li> <li>ContentView 根據不同路由顯示不同畫面</li></ol> <p><strong>sidebar.component.ts</strong></p> <p>這邊主要功能是整理 permissionService 的權限列表( 有設計 TabService 但可解耦的先忽略)，轉成 UI 好渲染的資料結構(menuItems)，Click( ) Enevt就是跳轉到該 permissionService 對應的 route，ContentView 再根據 Route 顯示綁定的 Component</p> <pre class="language-ts"><!></pre> <p>所以麻煩的部份會是 permissionService (原資料) 要如何 MAPPING 到前端定義的 URL ROUTE 字串值，為此會需要定義一個介面</p> <pre class="language-ts"><!></pre> <p>route.config.ts</p> <p>資料整理完後，還需自行轉換成 Angular Route 套件可以吃的資料模型 convertToRoute( )，丟回給 app.routes.ts 使用</p> <pre class="language-ts"><!></pre> <p>app.routes.ts 會變成</p> <pre class="language-ts"><!></pre> <p>未來要新增一個畫面，前端就是添加一組</p> <pre class="language-ts"><!></pre>',1);function Na(u){var o=Oa(),p=t(b(o),14),k=n(p);a(k,()=>`<code class="language-ts">
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">SidebarComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(p);var e=t(p,4),r=n(e);a(r,()=>`<code class="language-ts"><span class="token comment">/**
 * 路由配置介面
 */</span>
...
<span class="token punctuation">&#125;</span>
</code>`),s(e);var c=t(e,6),d=n(c);a(d,()=>`<code class="language-ts"><span class="token keyword">export</span> <span class="token keyword">const</span> <span class="token constant">ROUTE_CONFIGS</span><span class="token operator">:</span> RouteConfig<span class="token punctuation">[</span><span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token punctuation">[</span>
    <span class="token punctuation">&#123;</span>
        path<span class="token operator">:</span> <span class="token string">'basic-system/log'</span><span class="token punctuation">,</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token function-variable function">loadComponent</span><span class="token operator">:</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token keyword">import</span><span class="token punctuation">(</span><span class="token string">'../../features/parking-system/order-management.component'</span><span class="token punctuation">)</span>
        <span class="token punctuation">.</span><span class="token function">then</span><span class="token punctuation">(</span>m <span class="token operator">=></span> m<span class="token punctuation">.</span>OrderManagementComponent<span class="token punctuation">)</span><span class="token punctuation">,</span>
<span class="token punctuation">&#125;</span></code>`),s(i),f(u,o)}const La=Object.freeze(Object.defineProperty({__proto__:null,default:Na,metadata:Sn},Symbol.toStringTag,{value:"Module"})),Cn={title:"Angular20 Http",date:"2025-12-12",category:"software",subCategory:"Frontend",tags:["fronted","angular","route"],slug:"angular_http"},{title:ac,date:tc,category:pc,subCategory:oc,tags:ec,slug:cc}=Cn;var qa=w('<h6>Angular 有包好 HttpClient & HttpResource 可以直接拿來用</h6> <hr/> <p><strong><em>HttpClient</em></strong></p> <p>基於 RxJS Observable 所以可以使用物件提供的一套方法，錯誤自動透過 Observable 的 error channel 處理 2XX 外的都會拋出，需要手動 subscribe() 或搭配 async pipe 使用</p> <p><strong><em>HttpResource</em></strong></p> <p>基於 Signal 新推出 API，當依賴的 Signal 變化時自動重新請求，回傳的是 Resource 物件，包含 value()、status()、error() 等 Signal</p> <pre class="language-ts"><!></pre> <p>這邊的配置功能上</p> <ol><li>HttpResource 只做 Get( ) 用來處理 Service 類型的資料(權限表、個人資料等)</li> <li>HttpClient 、 error 做最基本，業務邏輯外部處理</li> <li>用繼承的方式處理不同 Domain 的使用場景</li></ol> <p>其餘有特殊需求就直接在該元件拿 BaseApiService + 額外實作就好</p> <pre class="language-ts"><!></pre>',1);function $a(u){var o=qa(),p=t(b(o),12),k=n(p);a(k,()=>`<code class="language-ts"><span class="token comment">// HttpClient 傳統寫法</span>
...
<span class="token comment">// searchQuery 變化時自動觸發新請求</span></code>`),s(p);var e=t(p,8),r=n(e);a(r,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Injectable<span class="token punctuation">,</span> resource<span class="token punctuation">,</span> Signal <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(e),f(u,o)}const Ma=Object.freeze(Object.defineProperty({__proto__:null,default:$a,metadata:Cn},Symbol.toStringTag,{value:"Module"})),Tn={title:"Angular20 Signal",date:"2025-12-12",category:"software",subCategory:"Frontend",tags:["fronted","angular","route"],slug:"angular_signal"},{title:lc,date:uc,category:kc,subCategory:ic,tags:rc,slug:dc}=Tn;var ja=w('<h6>認識新的 StateAPI - Signal 參考 <a href="https://v20.angular.dev/guide/signals" rel="nofollow">Angular20</a>、<a href="https://nx.dev/blog/angular-state-management-2025" rel="nofollow">2025 AngularStateManagement</a></h6> <hr/> <h3>Signals</h3> <p>basic</p> <pre class="language-ts"><!></pre> <p><strong><em>signal 、 computed 、 effect、 linkedSignal</em></strong></p> <p>情境 - 根據地區(本島、外島)來控制可運送選項</p> <pre class="language-ts"><!></pre> <p>目前選單重置後都會預設第一個，再添加一個判斷”當前選項在新選單內就不變動”</p> <pre class="language-ts"><!></pre> <p>小結一下</p> <ul><li>computed : 純粹的衍生狀態 (tax = priceSignal * 0.05)</li> <li>effect : 當作流程控制響應(副作用處理)，例如跳出彈窗或打 API 等</li> <li>linkedSignal: 可被寫入的 computed</li></ul> <p><strong><em>signal state</em></strong></p> <p>ngrx 提供的API，主要在強型別和結構化上的規範</p> <pre class="language-ts"><!></pre> <p><strong><em>signal Store</em></strong></p> <pre class="language-ts"><!></pre>',1);function Fa(u){var o=ja(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-ts"><span class="token comment">// basic</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">AppStore</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">update</span><span class="token punctuation">(</span>item<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(p);var e=t(p,6),r=n(e);a(r,()=>`<code class="language-ts"><span class="token comment">// signal</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">ShoppingCart</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">changeRegion</span><span class="token punctuation">(</span>region<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,4),d=n(c);a(d,()=>`<code class="language-ts"><span class="token comment">// effect</span>
<span class="token decorator"><span class="token at operator">@</span><span class="token function">Component</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span><span class="token operator">...</span><span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">ShoppingCart</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">private</span> _options <span class="token operator">=</span> <span class="token generic-function"><span class="token function">signal</span><span class="token generic class-name"><span class="token operator">&lt;</span><span class="token builtin">string</span><span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token operator">></span></span></span><span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token string">'標準運送'</span><span class="token punctuation">,</span> <span class="token string">'快速運送'</span><span class="token punctuation">,</span> <span class="token string">'超商取貨'</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token keyword">private</span> _selected <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">_options</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">ShoppingCart</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">changeRegion</span><span class="token punctuation">(</span>region<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c);var l=t(c,10),g=n(l);a(g,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> patchState<span class="token punctuation">,</span> signalState <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@ngrx/signals'</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">AppStore</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">updateStore</span><span class="token punctuation">(</span>item<span class="token operator">:</span> StoreItem<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(l);var i=t(l,4),y=n(i);a(y,()=>`<code class="language-ts"><span class="token comment">// signalStore () 算是會自動 DI </span>
<span class="token keyword">const</span> AppStore <span class="token operator">=</span> <span class="token function">signalStore</span><span class="token punctuation">(</span>
  ...
  <span class="token function">withMethods</span><span class="token punctuation">(</span><span class="token punctuation">(</span>state<span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">(</span><span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(i),f(u,o)}const Ua=Object.freeze(Object.defineProperty({__proto__:null,default:Fa,metadata:Tn},Symbol.toStringTag,{value:"Module"})),In={title:"Angular20 RxJS TabService",date:"2025-12-05",category:"software",subCategory:"Frontend",tags:["fronted","angular","RxJS"],slug:"angular_tabService"},{title:mc,date:gc,category:yc,subCategory:wc,tags:fc,slug:bc}=In;var Ha=w('<h6>企業內部系統常用到的分頁顯示管理</h6> <hr/> <p>分頁管理器，主要功能會是需要可以</p> <ol><li>存放(已Instance)當前的分頁(Component)</li> <li>選擇該分頁替換內容</li> <li>銷毀分頁</li></ol> <p>至少要建立兩個資料模型</p> <pre class="language-ts"><!></pre> <h3>BehaviorSubject</h3> <p>RxJS庫提供一個可觀察物件 (Observable) BehaviorSubject。它主要用於宣告和管理一個帶有初始值的狀態變數。它同時具備「觀察者 (Observer)」和「可觀察物件 (Observable)」的特性。</p> <pre class="language-ts"><!></pre> <h3>Signal</h3> <p>新版 Angular(16+) 提供框架內部語法 Signal 來雙向監聽</p> <pre class="language-ts"><!></pre> <p>整體概念和 React18 useState 用法很像</p> <pre class="language-ts"><!></pre> <p>邏輯層 tab.service.ts</p> <pre class="language-ts"><!></pre> <p>UI層 tab-container.ts</p> <pre class="language-ts"><!></pre>',1);function Ba(u){var o=Ha(),p=t(b(o),10),k=n(p);a(k,()=>`<code class="language-ts"><span class="token comment">// 每個目錄的基本資料結構，用 id 當作唯一識別</span>
<span class="token keyword">interface</span> <span class="token class-name">MenuItem</span> <span class="token punctuation">&#123;</span>
    id<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">TabContainerComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(m),f(u,o)}const Va=Object.freeze(Object.defineProperty({__proto__:null,default:Ba,metadata:In},Symbol.toStringTag,{value:"Module"})),Rn={title:"Angular Http Observable",date:"2025-06-22",category:"software",subCategory:"Frontend",tags:["http","angular","api"],slug:"angular_http_observable"},{title:hc,date:vc,category:_c,subCategory:Sc,tags:Cc,slug:Tc}=Rn;var Wa=w('<h6>RxJS Observable</h6> <hr/> <p>在 Angular 裡，HttpClient 的每個方法都會回傳一個 RxJS Observable，這些 Observable 屬於 cold 類型 —— 在訂閱（subscribe）時才真正發送請求。</p> <p>多次訂閱同一個 Observable 會觸發多次獨立的後端呼叫；若在請求途中解除訂閱，Angular 會直接 中止（abort）尚未完成的 HTTP 連線。</p> <pre class="language-js"><!></pre> <p>簡易封裝才可以靈活使用 pipe()、switchMap() …</p> <pre class="language-js"><!></pre> <h3>Observable 常見 Method</h3> <table><thead><tr><th>Operator</th><th>用途說明</th></tr></thead><tbody><tr><td><code>map()</code></td><td>資料轉換，取出你要的欄位、格式化資料</td></tr><tr><td><code>tap()</code></td><td>執行副作用（不改變資料），常用來 <code>console.log</code>, 設定 loading</td></tr><tr><td><code>switchMap()</code></td><td>用一筆資料觸發下一個 Observable，並自動取消舊的</td></tr><tr><td><code>mergeMap()</code></td><td>觸發下一個 Observable，但不取消前一筆（適合併發）</td></tr><tr><td><code>catchError()</code></td><td>錯誤處理，不讓錯誤中斷整個流程</td></tr><tr><td><code>finalize()</code></td><td>無論成功/失敗，最後一定會執行（常用來清除狀態）</td></tr><tr><td><code>retry(n)</code></td><td>API 失敗時，自動重試 n 次</td></tr><tr><td><code>timeout(ms)</code></td><td>若 Observable 超過時間未完成，會自動報錯</td></tr><tr><td><code>debounceTime(ms)</code></td><td>等使用者輸入穩定後才送出請求（防抖）</td></tr></tbody></table> <pre class="language-js"><!></pre>',1);function Ga(u){var o=Wa(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-js"><span class="token keyword">this</span><span class="token punctuation">.</span>http<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'/api/getExportData'</span><span class="token punctuation">)</span>
...
<span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,6),d=n(c);a(d,()=>`<code class="language-js"><span class="token keyword">this</span><span class="token punctuation">.</span>api<span class="token punctuation">.</span>get<span class="token operator">&lt;</span>any<span class="token operator">></span><span class="token punctuation">(</span><span class="token string">'/api/users'</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code>`),s(c),f(u,o)}const Ya=Object.freeze(Object.defineProperty({__proto__:null,default:Ga,metadata:Rn},Symbol.toStringTag,{value:"Module"})),En={title:"Angular Basic _ Route",date:"2025-06-22",category:"software",subCategory:"Frontend",tags:["route","angular","api"],slug:"angular_router"},{title:Ic,date:Rc,category:Ec,subCategory:Ac,tags:Pc,slug:xc}=En;var za=w('<h6>參考這個<a href="https://github.com/mbejda/AngularFire-Starter-Template" rel="nofollow">專案範本</a>、官方文件學習</h6> <hr/> <p>專案起始 index.html</p> <pre class="language-html"><!></pre> <p>元件去抓專案的根節點，render的內容用<code>&lt;router-outlet&gt;</code>佔位</p> <pre class="language-ts"><!></pre> <p>Route</p> <p>設定該路由(Path) <code>&lt;router-outlet&gt;</code>映射的元件</p> <pre class="language-ts"><!></pre> <p>且若添加 children 屬性擇該 映射的元件 裡面也可以再放一個佔位</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <h3>Route順序和路由守衛</h3> <p>Angular自帶跳轉和瀏覽權限設定，可自行放入<code>canActivate[]</code>裡面做邏輯判斷</p> <pre class="language-ts"><!></pre>',1);function Ja(u){var o=za(),p=t(b(o),6),k=n(p);a(k,()=>`<code class="language-html"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">doctype</span> <span class="token name">html</span><span class="token punctuation">></span></span>
...
<span class="token punctuation">&#125;</span></code>`),s(i);var m=t(i,8),v=n(m);a(v,()=>`<code class="language-ts"><span class="token decorator"><span class="token at operator">@</span><span class="token function">Component</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">CardComponent</span> <span class="token punctuation">&#123;</span><span class="token punctuation">&#125;</span></code>`),s(m);var h=t(m,4),C=n(h);a(C,()=>`<code class="language-ts"><span class="token operator">&lt;</span>app<span class="token operator">-</span>card<span class="token operator">></span>
...
<span class="token operator">&lt;</span><span class="token operator">/</span>app<span class="token operator">-</span>card<span class="token operator">></span></code>`),s(h);var _=t(h,4),E=n(_);a(E,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(_);var S=t(_,2),A=n(S);a(A,()=>`<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>my-dialog</span><span class="token punctuation">></span></span>
...
<span class="token punctuation">/></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>custom-slider</span> <span class="token attr-name">[(defineValue)]</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>50<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span></code>`),s(m);var h=t(m,8),C=n(h);a(C,()=>`<code class="language-js">@<span class="token function">ViewChild</span><span class="token punctuation">(</span><span class="token string">'myDiv'</span><span class="token punctuation">)</span> divElement<span class="token operator">!</span><span class="token operator">:</span> ElementRef<span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(h);var _=t(h,2),E=n(_);a(E,()=>'<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">#myDiv</span><span class="token punctuation">></span></span>hello<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>'),s(_);var S=t(_,4),A=n(S);a(A,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component<span class="token punctuation">,</span> effect<span class="token punctuation">,</span> viewChild<span class="token punctuation">,</span> ElementRef <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">MyComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(S);var T=t(S,4),x=n(T);a(x,()=>`<code class="language-js"><span class="token comment">// div = viewChild.required('myDiv', &#123; read: ElementRef &#125;);</span>
<span class="token function">effect</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code>`),s(T);var I=t(T,4),D=n(I);a(D,()=>`<code class="language-ts"><span class="token comment">// hero.service.ts</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">HeroService</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(I);var P=t(I,2),N=n(P);a(N,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> HeroService <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'../services/hero.service'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">HeroComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">add</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">this</span><span class="token punctuation">.</span>heroes <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span>heroService<span class="token punctuation">.</span><span class="token function">getHeroes</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(P);var O=t(P,4),q=n(O);a(q,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
firstName<span class="token punctuation">.</span><span class="token function">update</span><span class="token punctuation">(</span><span class="token parameter">name</span> <span class="token operator">=></span> name<span class="token punctuation">.</span><span class="token function">toUpperCase</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(O);var $=t(O,2),Bn=n($);a(Bn,()=>`<code class="language-ts"><span class="token keyword">const</span> firstName <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token string">'Morgan'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
firstName<span class="token punctuation">.</span><span class="token function">set</span><span class="token punctuation">(</span><span class="token string">'Jaime'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">firstNameCapitalized</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 'JAIME'（自動反應）</span></code>`),s($);var M=t($,4),Vn=n(M);a(Vn,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component<span class="token punctuation">,</span> signal<span class="token punctuation">,</span> computed <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(j);var F=t(j,4),Gn=n(F);a(Gn,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal<span class="token punctuation">,</span> effect<span class="token punctuation">,</span> untracked <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(F);var H=t(F,4),Yn=n(H);a(Yn,()=>`<code class="language-js"><span class="token keyword">const</span> a <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(H),f(u,o)}const at=Object.freeze(Object.defineProperty({__proto__:null,default:st,metadata:Pn},Symbol.toStringTag,{value:"Module"})),xn={title:"Angular Basic _ Value02",date:"2025-06-22",category:"software",subCategory:"Frontend",tags:["fronted","angular","value"],slug:"angular_value_02"},{title:Vc,date:Wc,category:Gc,subCategory:Yc,tags:zc,slug:Jc}=xn;var tt=w('<h6>應用中維護值的一些關鍵字</h6> <hr/> <h3>Component 層級的單向綁定( logic update -> dom rerender )</h3> <p><strong>普通變數 + Change Detection :</strong> Angular 的 Zone.js 會自動觸發變更檢測</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <p><strong>Signals :</strong> 響應式更新性能更好，需要新版 Angular 16+</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <p><strong>RxJS Observable + async pipe:</strong> 套件內有提供的一種監聽，概念是定義兩個變數值，一個可被調整的值 BehaviorSubject，另一個 Observable 限讀和 html 語法下 <code>&#123;&#123; count$ | async &#125;&#125;</code>，值被更新時就會 rerender 了。</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <h3>響應式組件和雙向綁定</h3> <p>一樣是 Signals( 同步、自動追蹤依賴、更輕量 ) & RxJS Observables ( 異步、需手動訂閱 )</p> <pre class="language-ts"><!></pre> <pre class="language-ts"><!></pre> <p>還有提供表單模組 FormsModule & ReactiveFormsModule 可以配合 ngModel 使用，Service.ts 也用上述方式維護值和狀態</p> <h3>APP Singleton</h3> <h6>RxJS Observable 套件物件內建很多方法補充一下</h6> <ul><li>Subject: 沒有初始值、value，是用來即時發送事件通知</li></ul> <pre class="language-ts"><!></pre> <ul><li>BehaviorSubject: 可推送新值（next( )）、記住最新的值（value）、新訂閱者會立即收到當前值</li></ul> <pre class="language-ts"><!></pre> <ul><li>ReplaySubject: 記住 N 個歷史值、新訂閱者會收到過去的 N 個值</li></ul> <pre class="language-ts"><!></pre> <ul><li>AsyncSubject:  只發送最後一個值、只關心最終結果的場景</li></ul> <pre class="language-ts"><!></pre> <ul><li>Observable: Subject 轉成 asObservable 後就會有 subscribe、pipe、filter…等功能</li></ul> <pre class="language-ts"><!></pre>',1);function pt(u){var o=tt(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-ts"><span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">MyComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(p);var e=t(p,2),r=n(e);a(r,()=>`<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>p</span><span class="token punctuation">></span></span>&#123;&#123; count &#125;&#125;<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>p</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>button</span> <span class="token attr-name">(click)</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>increment()<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>+1<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>button</span><span class="token punctuation">></span></span></code>`),s(e);var c=t(e,4),d=n(c);a(d,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>button</span> <span class="token attr-name">(click)</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>increment()<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>+1<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>button</span><span class="token punctuation">></span></span></code>`),s(m);var h=t(m,6),C=n(h);a(C,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal<span class="token punctuation">,</span> computed<span class="token punctuation">,</span> effect <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">UserComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">setName</span><span class="token punctuation">(</span>newName<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>name<span class="token punctuation">.</span><span class="token function">set</span><span class="token punctuation">(</span>newName<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(h);var _=t(h,2),E=n(_);a(E,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Observable<span class="token punctuation">,</span> Subject<span class="token punctuation">,</span> BehaviorSubject <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'rxjs'</span><span class="token punctuation">;</span>
...
behaviorSubject<span class="token punctuation">.</span><span class="token function">subscribe</span><span class="token punctuation">(</span>val <span class="token operator">=></span> <span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>val<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 立即輸出 0</span></code>`),s(_);var S=t(_,10),A=n(S);a(A,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Subject <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'rxjs'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(S);var T=t(S,4),x=n(T);a(x,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> BehaviorSubject <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'rxjs'</span><span class="token punctuation">;</span>

<span class="token keyword">private</span> countSubject <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">BehaviorSubject</span><span class="token punctuation">(</span><span class="token number">0</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
count$ <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span>countSubject<span class="token punctuation">.</span><span class="token function">asObservable</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(T);var I=t(T,4),D=n(I);a(D,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> ReplaySubject <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'rxjs'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(I);var P=t(I,4),N=n(P);a(N,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> AsyncSubject <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'rxjs'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(P);var O=t(P,4),q=n(O);a(q,()=>`<code class="language-ts">data$<span class="token punctuation">.</span><span class="token function">subscribe</span><span class="token punctuation">(</span>value <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),f(u,o)}const lt=Object.freeze(Object.defineProperty({__proto__:null,default:ct,metadata:Dn},Symbol.toStringTag,{value:"Module"})),On={title:"Design Token",date:"2025-08-18",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"webdesign"},{title:al,date:tl,category:pl,subCategory:ol,tags:el,slug:cl}=On;var ut=w('<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>Color System</h3> <p>Primary Colors</p> <pre class="language-json"><!></pre> <p>Status Colors</p> <pre class="language-json"><!></pre> <p>Neutral Colors</p> <pre class="language-json"><!></pre> <h3>Typography System</h3> <p>Font Family</p> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre>',1);function kt(u){var o=ut(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(i);var m=t(i,2),v=n(m);a(v,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(m);var h=t(m,2),C=n(h);a(C,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(h);var _=t(h,2),E=n(_);a(E,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(_);var S=t(_,2),A=n(S);a(A,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(S);var T=t(S,2),x=n(T);a(x,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(T);var I=t(T,2),D=n(I);a(D,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
&#125;</code>`),s(m),f(u,o)}const mt=Object.freeze(Object.defineProperty({__proto__:null,default:dt,metadata:Nn},Symbol.toStringTag,{value:"Module"})),Ln={title:"HTTP & FileStream",date:"2025-10-27",category:null,subCategory:null,tags:["http","filestream"],slug:"filestream"},{title:ml,date:gl,category:yl,subCategory:wl,tags:fl,slug:bl}=Ln;var gt=w('<p>實作串流相關 API</p> <hr/> <h3>FileStream 特性</h3> <ul><li>指針機制：串流有一個內部指針，讀取時會向前移動，讀完後就到了末尾</li> <li>記憶體效率：串流設計用來處理大文件，不會把整個文件載入記憶體</li> <li>即時處理：數據是可以邊讀邊處理的，適合有獨立資料結構導向的檔案類型</li></ul> <p><strong>適合的類型</strong> : <code>.txt</code>, <code>.csv</code>,<code>.jsonl</code>,<code>.mp3</code>, <code>.mp4</code></p> <p><strong>不適合的類型</strong> : <code>.json</code>, <code>.zip</code>, <code>.rar</code></p> <pre class="language-csharp"><!></pre> <p>這邊可邊接收邊處理，是因為 <strong>HTTP 不同 Request 參數類型，會有不同的執行時機</strong>，例如:</p> <ul><li><p>String / Object：Body 完整接收後才執行，資料立即可用（適合小型資料、JSON）</p></li> <li><p>IFormFile：Headers 接收後就執行，檔案資訊立即可用但內容需等待串流（適合大型檔案）</p></li></ul>',1);function yt(u){var o=gt(),p=t(b(o),12),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token comment">// 串流處理：記憶體效率高</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),R(4),f(u,o)}const wt=Object.freeze(Object.defineProperty({__proto__:null,default:yt,metadata:Ln},Symbol.toStringTag,{value:"Module"})),qn={title:"Http Connect",date:"2025-09-03",category:"software",subCategory:"Internet",tags:["Http","tcp","backend"],slug:"http_connect"},{title:hl,date:vl,category:_l,subCategory:Sl,tags:Cl,slug:Tl}=qn;var ft=w('<h3>TCP 連線的運作機制</h3> <ol><li><p>伺服器主機主動開啟 Port <code>net.Listen("tcp", ":4000")</code></p></li> <li><p>同時 <code>conn, err := listener.Accept()</code> 等待連接</p></li> <li><p>客戶端發送請求 <code>server_ip:4000</code> OS 背後做 TCP 三次握手驗證</p></li> <li><p>資料會傳送到 <code>OS緩衝區</code>，程式則會定期去緩衝區讀取資料處理</p></li></ol> <h3>Server 的核心特性</h3> <ul><li>持續運行（Long-running Process）</li> <li>對外提供通訊介面</li></ul> <pre class="language-go"><!></pre> <p>HTTP 本身是個字串，會需要嚴格的解析流程，可以導入狀態機的概念去處理如:</p> <ul><li>解析請求行 → 提取方法、路徑、版本</li> <li>解析標頭   → 逐行讀取 key: value</li> <li>解析請求體 → 根據 Content-Length 讀取</li></ul> <pre class="language-go"><!></pre>',1);function bt(u){var o=ft(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-go"><span class="token keyword">package</span> main
...
<span class="token punctuation">&#125;</span></code>`),s(c),f(u,o)}const St=Object.freeze(Object.defineProperty({__proto__:null,default:_t,metadata:$n},Symbol.toStringTag,{value:"Module"})),Mn={title:"Nginx",date:"2025-11-27",category:"software",subCategory:"Internet",tags:["http","nginx"],slug:"nginx"},{title:Dl,date:Ol,category:Nl,subCategory:Ll,tags:ql,slug:$l}=Mn;var Ct=w('<h6>公司內部開發的時候用看看Nginx，就不用搬筆電跑來跑去</h6> <hr/> <p>可以這樣配置測試環境</p> <ol><li>本地先 run 一個要被訪問的 Server</li> <li>配置 nginx.conf，因為 nginx Server 是部屬在 docker，所以要使用 host.docker.internal</li> <li>docker run 一個 nginx container</li> <li>先測看看 localhost 不帶後贅是否可以連到預設的 nginx page</li> <li>再看不同裝置區網內連線可不可以(—ipConfig IPv4 位址)，能否連接到上述預設 page</li> <li>再測試反向代理是否轉發正確</li></ol> <pre class="language-dockerfile"><!></pre> <pre class="language-bash"><!></pre> <p>nginx.conf (假設 Server 部署在 local4041 )</p> <pre class="language-conf"><!></pre> <p>上面大概就是基礎的轉發功能，剩下的就是看專案當初的環境配置了，nginx 本身也可以 subdomain 配置，可以用來解決 cors 的問題。</p> <p>其餘可進階的配置</p> <ul><li>SPA (單頁應用) 路由設定</li> <li>靜態資源快取 (Browser Caching)</li> <li>Gzip 壓縮</li> <li>限制存取 (Access Control)</li> <li>SSL/TLS (https)</li></ul>',1);function Tt(u){var o=Ct(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-dockerfile"><span class="token comment"># Use the specific Ubuntu 22.04 image</span>
...
│   └── translation.json
└── zh/
    └── translation.json</code>`),s(m);var h=t(m,8),C=n(h);a(C,()=>`<code class="language-bash"><span class="token function">npm</span> run dev      <span class="token comment"># 啟動開發伺服器（HMR 支援）</span>
...
<span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,8),d=n(c);a(d,()=>`<code class="language-javascript"><span class="token keyword">const</span> <span class="token constant">WCV_DEFAULT_SETTING</span> <span class="token operator">=</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c),R(10),f(u,o)}const Lt=Object.freeze(Object.defineProperty({__proto__:null,default:Nt,metadata:Un},Symbol.toStringTag,{value:"Module"})),Hn={title:"CSS Render 範本",date:"2025-06-22",category:null,subCategory:null,tags:["svelte","blog","markdown"],slug:"example"},{title:au,date:tu,category:pu,subCategory:ou,tags:eu,slug:cu}=Hn;var qt=w('<p>這是第一篇文章，用來展示部落格如何從 markdown 載入內容。</p> <hr/> <h1>這是 H1 標題</h1> <h2>這是 H2 標題</h2> <h3>這是 H3 標題</h3> <hr/> <p>段落文字：這是一段普通的段落內容，展示預設的段落文字樣式。</p> <p>強調文字：<strong>粗體</strong>、<em>斜體</em>、<del>刪除線</del>。</p> <hr/> <h3>清單測試</h3> <ul><li>無序清單項目 1</li> <li>無序清單項目 2 <ul><li>子項目 a</li> <li>子項目 b</li></ul></li></ul> <ol><li>有序清單項目 1</li> <li>有序清單項目 2 <ol><li>子項目 i</li> <li>子項目 ii</li></ol></li></ol> <hr/> <h3>程式碼區塊</h3> <h4>行內程式碼</h4> <p>例如你可以這樣寫：<code>console.log("Hello Svelte!")</code></p> <h4>區塊程式碼</h4> <pre class="language-js"><!></pre>',1);function $t(u){var o=qt(),p=t(b(o),34),k=n(p);a(k,()=>`<code class="language-js"><span class="token keyword">function</span> <span class="token function">greet</span><span class="token punctuation">(</span><span class="token parameter">name</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> <span class="token template-string"><span class="token template-punctuation string">&#96;</span><span class="token string">Hello, </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">$&#123;</span>name<span class="token interpolation-punctuation punctuation">&#125;</span></span><span class="token string">!</span><span class="token template-punctuation string">&#96;</span></span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(p),f(u,o)}const Mt=Object.freeze(Object.defineProperty({__proto__:null,default:$t,metadata:Hn},Symbol.toStringTag,{value:"Module"})),U=[],Y=Object.assign({"/src/content/Backend/BackgroudService.md":os,"/src/content/Backend/DDD_layer.md":ls,"/src/content/Backend/DDD_mediator.md":is,"/src/content/Backend/DDD_outbox.md":ms,"/src/content/Backend/FSM.md":ws,"/src/content/Database/Paxon_1.md":hs,"/src/content/Database/Paxon_2.md":Ss,"/src/content/Database/consistency_1.md":Is,"/src/content/Database/consistency_2.md":As,"/src/content/Database/consistency_3.md":Ds,"/src/content/Database/db_leetcode50.md":Ls,"/src/content/Database/db_normalization.md":Ms,"/src/content/Database/db_relational.md":Us,"/src/content/Database/db_sql.md":Vs,"/src/content/Database/db_table_1.md":Ys,"/src/content/Devlop-Note/cashflow.md":Xs,"/src/content/Devlop-Note/jsPDF.md":Zs,"/src/content/Devlop-Note/pdfMerge.md":aa,"/src/content/Devlop-Note/reconcile.md":oa,"/src/content/Devlop-Note/sftp_ftps.md":la,"/src/content/Devlop-Note/structurizr.md":ia,"/src/content/Devlop-Note/summary_2025.md":ma,"/src/content/Devlop-Note/xlsx_excel.md":wa,"/src/content/Fronted/Electron_01.md":ha,"/src/content/Fronted/Kotlin_01.md":Sa,"/src/content/Fronted/ThreeJS.md":Ia,"/src/content/Fronted/angular20_AuthRoute_01.md":Aa,"/src/content/Fronted/angular20_AuthRoute_02.md":Da,"/src/content/Fronted/angular20_AuthRoute_03.md":La,"/src/content/Fronted/angular20_Http.md":Ma,"/src/content/Fronted/angular20_Signal.md":Ua,"/src/content/Fronted/angular20_tabService.md":Va,"/src/content/Fronted/angular_basic_http.md":Ya,"/src/content/Fronted/angular_basic_router.md":Xa,"/src/content/Fronted/angular_basic_start.md":Za,"/src/content/Fronted/angular_basic_value.md":at,"/src/content/Fronted/angular_basic_value_02.md":ot,"/src/content/Fronted/css.md":lt,"/src/content/Fronted/design_token.md":it,"/src/content/Http/CORS.md":mt,"/src/content/Http/filestream.md":wt,"/src/content/Http/http_connect.md":ht,"/src/content/Http/http_secretKey.md":St,"/src/content/Http/nginx.md":It,"/src/content/Project/blog.md":At,"/src/content/Project/webpreviewer.md":Dt,"/src/content/Project/websiteeditor.md":Lt,"/src/content/empty.md":Mt});for(const u in Y){const o=Y[u];U.push({category:o.metadata.category,subCategory:o.metadata.subCategory,title:o.metadata.title,slug:o.metadata.slug,date:o.metadata.date,tags:o.metadata.tags,excerpt:o.metadata.excerpt??"",component:o.default})}U.sort((u,o)=>o.date.localeCompare(u.date));const lu=as(U);export{ia as A,la as B,oa as C,aa as D,Zs as E,Xs as F,Ys as G,Vs as H,Us as I,Ms as J,Ls as K,Ds as L,As as M,Is as N,Ss as O,hs as P,ws as Q,ms as R,is as S,ls as T,os as U,lu as V,Mt as _,Lt as a,Dt as b,At as c,It as d,St as e,ht as f,wt as g,mt as h,it as i,lt as j,ot as k,at as l,Za as m,Xa as n,Ya as o,Va as p,Ua as q,Ma as r,La as s,Da as t,Aa as u,Ia as v,Sa as w,ha as x,wa as y,ma as z};
