import{b as U,d as $n,f as y,a as w}from"./Cew64nlL.js";import"./C5SEx9ip.js";import{t as Fn,h as B,a as V,P as qn,aH as Mn,d as W,V as jn,Y as Hn,W as Un,B as Bn,T as L,s as t,o as h,v as n,w as s,aI as D}from"./COc0ozwQ.js";import{r as Vn}from"./CR_4RHM7.js";function a(u,o,p=!1,k=!1,e=!1){var i=u,c="";Fn(()=>{var d=qn;if(c===(c=o()??"")){B&&V();return}if(d.nodes_start!==null&&(Mn(d.nodes_start,d.nodes_end),d.nodes_start=d.nodes_end=null),c!==""){if(B){W.data;for(var l=V(),m=l;l!==null&&(l.nodeType!==8||l.data!=="");)m=l,l=jn(l);if(l===null)throw Hn(),Un;U(W,m),i=Bn(l);return}var r=c+"";p?r=`<svg>${r}</svg>`:k&&(r=`<math>${r}</math>`);var f=$n(r);if((p||k)&&(f=L(f)),U(L(f),f.lastChild),p||k)for(;L(f);)i.before(L(f));else i.before(f)}})}const G={title:"Base Backgroud Service",date:"2025-09-25",category:"software",subCategory:"Backend",tags:["Backgroud","backend","markdown"],slug:"backgroudservice"},{title:Ka,date:Xa,category:Ja,subCategory:Qa,tags:Za,slug:nt}=G;var Wn=y('<h6>C#實作非立即性的服務排序</h6> <hr/> <h3>使用背景</h3> <p>當主程式的 DI 註冊週期是以 HTTP lifecycle 為主時，可藉由 Background Service 提供長期運行的服務容器。</p> <ol><li>非阻塞式處理：可由外部 API 觸發某些動作，立即回應用戶端而不等待處理完成</li> <li>解耦合設計：將耗時的業務邏輯從 HTTP 請求週期中分離出來</li> <li>簡易事件模式：作為一個輕量級的 Event pattern 實現，處理非即時性任務</li> <li>資源管理：避免長時間佔用 HTTP 連線資源，提升系統整體效能</li></ol> <h3>Channel 基礎原理</h3> <p>Channel 是 .NET Core 提供的 thread-safe 生產者-消費者模式實作，基於 System.Threading.Channels 命名空間。它解決了多執行緒環境下的資料傳遞問題。</p> <pre class="language-csharp"><!></pre> <h3>Channel 的監聽機制</h3> <p>寫入機制 (Producer)</p> <pre class="language-csharp"><!></pre> <p>讀取監聽機制 (Consumer)</p> <pre class="language-csharp"><!></pre> <h3>基本架構</h3> <p>DI註冊</p> <pre class="language-csharp"><!></pre> <p>Controller</p> <pre class="language-csharp"><!></pre> <p>服務內部</p> <pre class="language-csharp"><!></pre>',1);function zn(u){var o=Wn(),p=t(h(o),14),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token class-name"><span class="token keyword">var</span></span> channel <span class="token operator">=</span> Channel<span class="token punctuation">.</span><span class="token generic-method"><span class="token function">CreateUnbounded</span><span class="token generic class-name"><span class="token punctuation">&lt;</span>YourRequestType<span class="token punctuation">></span></span></span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// Channel 包含兩個部分</span>
...
<span class="token punctuation">&#125;</span></code>`),s(A),w(u,o)}const Zn=Object.freeze(Object.defineProperty({__proto__:null,default:Qn,metadata:K},Symbol.toStringTag,{value:"Module"})),X={title:"Domain-Driven - Outbox Message",date:"2025-06-23",category:"software",subCategory:"Backend",tags:["DDD","backend","design"],slug:"ddd_outbox"},{title:dt,date:gt,category:mt,subCategory:yt,tags:wt,slug:ft}=X;var ns=y('<h6>拆分主副邏輯，同時保持資料同步性</h6> <hr/> <h2>SideEffect</h2> <p>若把 DDD 流程中的主副行為拆分：</p> <ul><li>創建員工帳戶的時候 <code>&lt;TABLE_Employee&gt;</code> 新增一筆資料</li> <li>幫對應到的 <code>&lt;TABLE_Department&gt;_Headcount</code> 總人數加一</li></ul> <br/> <p>若是以依照 MVC 架構會是</p> <pre class="language-csharp"><!></pre> <p>用 DDD 寫則變成是</p> <pre class="language-csharp"><!></pre> <p>假設創建員工帳號變為須更新 5-10 張表單,函式會越來越巨大、複雜且難以測試與維護。透過 DDD 的 Domain Event 拆解副作用邏輯可異步處理，減少主流程延遲。</p> <h2>ASIO 原子性（Atomicity of Side-Effect & IO）</h2> <p>剛剛提到的行為，主邏輯成功時無法保證所有副作用（如更新部門、發送通知等）都成功執行，這違反了分散系統中常見的 資料一致性與原子性要求。</p> <p>解決方法是設計一張資料庫新表<code>&lt;DB_Outbox_Message&gt;</code>，在一筆交易中提交主邏輯與事件，且把事件訊息<code>(Event、Payload、Time)</code>寫入這張表。這樣執行失敗也有紀錄可以查驗，也可設計失敗的 Retry 機制。</p> <br/> <p>主要實踐方法是用背景應用重複執行，訪問 DB_Outbox_Message 執行該事件</p> <pre class="language-csharp"><!></pre>',1);function ss(u){var o=ns(),p=t(h(o),14),k=n(p);a(k,()=>`<code class="language-csharp">db_Employee<span class="token punctuation">.</span><span class="token function">Add</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
但是如果_R3突然掛掉了，可以找一個替代伺服器_R4，只是_R4儲存的資料需要標記，等_R3恢復後再回補</p> <pre class="language-text"><!></pre>`,1);function ds(u){var o=is(),p=t(h(o),34),k=n(p);a(k,()=>`<code class="language-text">庫存初始值：100
...
Supplier | Part | Project
---------|------|---------
S1       | P1   | J1</code>`),s(P),w(u,o)}const Ps=Object.freeze(Object.defineProperty({__proto__:null,default:Rs,metadata:pn},Symbol.toStringTag,{value:"Module"})),on={title:"關聯式資料庫",date:"2025-06-22",category:"software",subCategory:"Database",tags:["database","db","sql"],slug:"db_relational"},{title:dp,date:gp,category:mp,subCategory:yp,tags:wp,slug:fp}=on;var Ds=y('<pre class="language-pgsql"><!></pre> <p>連接 SQL Server 時是透過 TDS（Tabular Data Stream）的通訊協定來交換資料。</p> <ul><li>TDS 是 SQL Server 專用的底層通訊協定，負責在用戶端與資料庫伺服器之間傳遞</li> <li>通常透過 TCP/IP 傳輸，預設使用的連接埠為 1433。</li> <li>用戶端要連接資料庫時，會使用一段 Connection String（連線字串）</li></ul> <pre class="language-pgsql"><!></pre> <h3>Table（資料表）</h3> <p>資料表是資料的儲存核心，每個表由「列（row）」與「欄（column）」構成。</p> <pre class="language-sql"><!></pre> <h3>Primary Key（主鍵）</h3> <p>能唯一標識每一筆資料，一張表只能有一個主鍵，可以是單一欄位或多欄位組成（複合主鍵）。</p> <pre class="language-sql"><!></pre> <h3>Unique Constraint（唯一約束）</h3> <p>限制欄位值不能重複，一張表可以有多個唯一欄位。</p> <pre class="language-sql"><!></pre> <h3>Foreign Key（外鍵）</h3> <pre class="language-sql"><!></pre> <h3>Index（索引）</h3> <p>加速查詢效率，類似書本的目錄，索引可以建立在單一欄位或多個欄位上。</p> <pre class="language-sql"><!></pre>',1);function Ts(u){var o=Ds(),p=h(o),k=n(p);a(k,()=>`<code class="language-pgsql">SQL Server Instance
├── Database
│   ├── Schema
│   │   ├── Table
│   │   ├── View
...
pdfDoc<span class="token punctuation">.</span><span class="token function">save</span><span class="token punctuation">(</span><span class="token string">"fileName.pdf"</span><span class="token punctuation">)</span></code>`),s(l),w(u,o)}const Hs=Object.freeze(Object.defineProperty({__proto__:null,default:js,metadata:un},Symbol.toStringTag,{value:"Module"})),kn={title:"多個 PDF 檔案合併",date:"2025-09-16",category:"software",subCategory:"開發筆記",tags:["pdf","backend","command"],slug:"pdfmarge"},{title:Bp,date:Vp,category:Wp,subCategory:zp,tags:Gp,slug:Yp}=kn;var Us=y('<h6><a href="https://github.com/cao0085/pdfMerger" rel="nofollow">Repository</a> ，Python 執行相容性比較好，C# UI方便友善</h6> <hr/> <h3>C#</h3> <pre class="language-csharp"><!></pre> <pre class="language-csharp"><!></pre> <h3>Python3</h3> <pre class="language-bash"><!></pre> <pre class="language-python"><!></pre>',1);function Bs(u){var o=Us(),p=t(h(o),6),k=n(p);a(k,()=>`<code class="language-csharp">  <span class="token comment">// .csproj</span>
...
確認檔案產出再 Update 資料庫</p> <pre class="language-csharp"><!></pre> <pre class="language-csharp"><!></pre>`,1);function zs(u){var o=Ws(),p=t(h(o),16),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token comment">/// &lt;summary></span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(g),w(u,o)}const Gs=Object.freeze(Object.defineProperty({__proto__:null,default:zs,metadata:rn},Symbol.toStringTag,{value:"Module"})),dn={title:"SFTP、FTPS C# 連線測試",date:"2025-10-01",category:"software",subCategory:"開發筆記",tags:["tcp","ip","container"],slug:"sftp_ftps"},{title:so,date:ao,category:to,subCategory:po,tags:oo,slug:eo}=dn;var Ys=y('<h6>紀錄本地端測試方法</h6> <hr/> <h3>SFTP</h3> <p>docker-compose.yml</p> <pre class="language-yml"><!></pre> <pre class="language-csharp"><!></pre> <h3>FTPS</h3> <pre class="language-csharp"><!></pre> <p>docker-compose.yml</p> <pre class="language-yml"><!></pre> <h3>2SFTP+FTPS</h3> <pre class="language-yml"><!></pre>',1);function Ks(u){var o=Ys(),p=t(h(o),8),k=n(p);a(k,()=>`<code class="language-yml"><span class="token key atrule">services</span><span class="token punctuation">:</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),D(28),w(u,o)}const la=Object.freeze(Object.defineProperty({__proto__:null,default:ca,metadata:wn},Symbol.toStringTag,{value:"Module"})),fn={title:"插入 3D 影像",date:"2025-08-13",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"threeJs"},{title:Ao,date:Lo,category:Oo,subCategory:No,tags:$o,slug:Fo}=fn;var ua=y(`<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>匯入 .glb</h3> <p>透過用 three.js 匯入
Canvas ➜ WebGL ➜ Three.js ➜ GLB 模型 ➜ GPU 顯示</p> <pre class="language-js"><!></pre>`,1);function ka(u){var o=ua(),p=t(h(o),8),k=n(p);a(k,()=>`<code class="language-js">  <span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> <span class="token constant">THREE</span> <span class="token keyword">from</span> <span class="token string">'three'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,6),d=n(c);a(d,()=>`<code class="language-js"><span class="token keyword">this</span><span class="token punctuation">.</span>api<span class="token punctuation">.</span>get<span class="token operator">&lt;</span>any<span class="token operator">></span><span class="token punctuation">(</span><span class="token string">'/api/users'</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code>`),s(c),w(u,o)}const wa=Object.freeze(Object.defineProperty({__proto__:null,default:ya,metadata:vn},Symbol.toStringTag,{value:"Module"})),bn={title:"Angular Router",date:"2025-06-22",category:"software",subCategory:"Frontend",tags:["route","angular","api"],slug:"angular_router"},{title:Xo,date:Jo,category:Qo,subCategory:Zo,tags:ne,slug:se}=bn;var fa=y('<h6>參考這個<a href="https://github.com/mbejda/AngularFire-Starter-Template" rel="nofollow">專案範本</a>、官方文件學習</h6> <hr/> <p>專案起始 index.html</p> <pre class="language-html"><!></pre> <p>元件去抓專案的根節點，render的內容用<code>&lt;router-outlet&gt;</code>佔位</p> <pre class="language-ts"><!></pre> <p>Route</p> <p>設定該路由(Path) <code>&lt;router-outlet&gt;</code>映射的元件</p> <pre class="language-ts"><!></pre> <p>且若添加 children 屬性擇該 映射的元件 裡面也可以再放一個佔位</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <h3>Route順序和路由守衛</h3> <p>Angular自帶跳轉和瀏覽權限設定，可自行放入<code>canActivate[]</code>裡面做邏輯判斷</p> <pre class="language-ts"><!></pre>',1);function ha(u){var o=fa(),p=t(h(o),6),k=n(p);a(k,()=>`<code class="language-html"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">doctype</span> <span class="token name">html</span><span class="token punctuation">></span></span>
...
<span class="token punctuation">&#125;</span></code>`),s(v);var _=t(v,2),T=n(_);a(T,()=>'<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">#myDiv</span><span class="token punctuation">></span></span>hello<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>'),s(_);var C=t(_,4),I=n(C);a(I,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component<span class="token punctuation">,</span> effect<span class="token punctuation">,</span> viewChild<span class="token punctuation">,</span> ElementRef <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">HeroComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">add</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">this</span><span class="token punctuation">.</span>heroes <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span>heroService<span class="token punctuation">.</span><span class="token function">getHeroes</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(A);var N=t(A,4),En=n(N);a(En,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
firstName<span class="token punctuation">.</span><span class="token function">set</span><span class="token punctuation">(</span><span class="token string">'Jaime'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">firstNameCapitalized</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 'JAIME'（自動反應）</span></code>`),s($);var F=t($,4),An=n(F);a(An,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component<span class="token punctuation">,</span> signal<span class="token punctuation">,</span> computed <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(M);var H=t(M,4),Nn=n(H);a(Nn,()=>`<code class="language-js"><span class="token keyword">const</span> a <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),w(u,o)}const Pa=Object.freeze(Object.defineProperty({__proto__:null,default:Ra,metadata:Cn},Symbol.toStringTag,{value:"Module"})),Sn={title:"Design Token",date:"2025-08-18",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"webdesign"},{title:ge,date:me,category:ye,subCategory:we,tags:fe,slug:he}=Sn;var Da=y('<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>Color System</h3> <p>Primary Colors</p> <pre class="language-json"><!></pre> <p>Status Colors</p> <pre class="language-json"><!></pre> <p>Neutral Colors</p> <pre class="language-json"><!></pre> <h3>Typography System</h3> <p>Font Family</p> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre>',1);function Ta(u){var o=Da(),p=t(h(o),8),k=n(p);a(k,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(R);var P=t(R,2),x=n(P);a(x,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(P),w(u,o)}const Ia=Object.freeze(Object.defineProperty({__proto__:null,default:Ta,metadata:Sn},Symbol.toStringTag,{value:"Module"})),Rn={title:"Http Connect",date:"2025-09-03",category:"software",subCategory:"Internet",tags:["Http","tcp","backend"],slug:"http_connect"},{title:ve,date:be,category:_e,subCategory:Ce,tags:Se,slug:Re}=Rn;var Ea=y('<h3>TCP 連線的運作機制</h3> <ol><li><p>伺服器主機主動開啟 Port <code>net.Listen("tcp", ":4000")</code></p></li> <li><p>同時 <code>conn, err := listener.Accept()</code> 等待連接</p></li> <li><p>客戶端發送請求 <code>server_ip:4000</code> OS 背後做 TCP 三次握手驗證</p></li> <li><p>資料會傳送到 <code>OS緩衝區</code>，程式則會定期去緩衝區讀取資料處理</p></li></ol> <h3>Server 的核心特性</h3> <ul><li>持續運行（Long-running Process）</li> <li>對外提供通訊介面</li></ul> <pre class="language-go"><!></pre> <p>HTTP 本身是個字串，會需要嚴格的解析流程，可以導入狀態機的概念去處理如:</p> <ul><li>解析請求行 → 提取方法、路徑、版本</li> <li>解析標頭   → 逐行讀取 key: value</li> <li>解析請求體 → 根據 Content-Length 讀取</li></ul> <pre class="language-go"><!></pre>',1);function xa(u){var o=Ea(),p=t(h(o),8),k=n(p);a(k,()=>`<code class="language-go"><span class="token keyword">package</span> main
...
<span class="token punctuation">&#125;</span></code>`),s(c),w(u,o)}const Na=Object.freeze(Object.defineProperty({__proto__:null,default:Oa,metadata:Pn},Symbol.toStringTag,{value:"Module"})),Dn={title:"Svelte Blog",date:"2025-05-05",category:"software",subCategory:"專案",tags:["svelte","blog","markdown"],slug:"Svelte Blog"},{title:Ae,date:Le,category:Oe,subCategory:Ne,tags:$e,slug:Fe}=Dn;var $a=y('<h6>用 Svelte 做一個類似 Jekyll 的靜態生成網站 (你正在閱讀的)，提供 <a href="https://github.com/cao0085/svelte-blog" rel="nofollow">Repository</a></h6> <hr/> <p>我第一個程式專案就是套Jekyll + GitHub Pages 來部屬網站，朋友推薦可以玩玩看 Svelte，就想說順手把Blog 搬過來，再加上聽說靜態頁面搜尋引擎會比較友善，決定拿來就架一個文章模板網站試試。</p> <h3>前端用混合式靜態預渲染</h3> <ul><li>CSR（Client-Side Rendering）：客戶端動態載入 Markdown 轉換的 Svelte 組件</li> <li>SSG（Static Site Generation）：構建時預渲染所有文章頁面</li></ul> <pre class="language-markdown"><!></pre> <pre class="language-markdown"><!></pre> <p>也就是說構建(打包)時，SvelteKit 會：</p> <ol><li>從 <code>+page.ts</code> 的 <code>entries()</code> 函數取得所有文章的 slug 列表</li> <li>為每個 slug 預渲染一個靜態 HTML 檔案（例如：<code>build/blog/db_sql.html</code>）</li> <li>這些檔案路徑與 URL 路徑完全對應（<code>/article/db_sql</code> → <code>blog/db_sql.html</code>）</li></ol> <p>使用者訪問時：</p> <ol><li>瀏覽器請求 <code>/article/db_sql</code></li> <li>伺服器直接回傳已經預渲染好的 <code>blog/db_sql.html</code>（含完整內容）</li> <li>頁面載入後，SvelteKit 接管路由（Hydration），後續點擊文章連結變成客戶端導航</li></ol> <h3>自動化流程</h3> <p>因為應用是單純的文字紀錄，所以設計成每次 Push 到 Master 就可以用 Github Action 自動執行打包，然後輸出檔案放在另一個分支。</p> <ul><li>master (主程式碼)</li> <li>gh-pages (打包檔案)</li></ul> <p>根目錄配置 /.github/workflows/deploy.yml</p> <pre class="language-yml"><!></pre> <h3>部屬</h3> <p>之前都是用 Github Pages 直接用，這次因為路徑想改用 CloudFlare 上買的 Domain ，所以改成用 CloudFlare 連接 Github Repository 指定分支，那 CloudFlare 就會自動路由</p>',1);function Fa(u){var o=$a(),p=t(h(o),10),k=n(p);a(k,()=>`<code class="language-markdown">檔案系統對應：
src/routes/
...
└── article/                    # 子路由目錄
    ...
    └── [slug]/                 # 動態路由段落
        ...
        └── +page.ts            # 預渲染配置</code>`),s(p);var e=t(p,2),i=n(e);a(i,()=>`<code class="language-markdown">構建階段 (npm run build)
  ↓
...
生成對應的靜態 HTML 頁面
  ↓
輸出到 build/blog/&#123;slug&#125;.html</code>`),s(e);var c=t(e,18),d=n(c);a(d,()=>`<code class="language-yml"><span class="token key atrule">name</span><span class="token punctuation">:</span> Deploy to GitHub Pages
    ...
    <span class="token key atrule">steps</span><span class="token punctuation">:</span>
      ...
      <span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> Deploy to GitHub Pages
        ...
        <span class="token key atrule">with</span><span class="token punctuation">:</span>
          ...
          <span class="token key atrule">cname</span><span class="token punctuation">:</span> blog.yoshikagehub.com</code>`),s(c),D(4),w(u,o)}const qa=Object.freeze(Object.defineProperty({__proto__:null,default:Fa,metadata:Dn},Symbol.toStringTag,{value:"Module"})),Tn={title:"CSS Render 範本",date:"2025-06-22",category:"",subCategory:"",tags:["read","book","markdown"],slug:"the_beggers_strike"},{title:qe,date:Me,category:je,subCategory:He,tags:Ue,slug:Be}=Tn;var Ma=y("<p>非洲文學家</p> <hr/> <p>###　乞丐的罷工</p> <p>角色定位鮮明、閱讀起來很像長篇寓言故事。可以把世界背景想像成架空於印度之上，內容主線如同書名；在一個外來的打破平衡的事件，政府開始掃蕩下乞丐掀起革命。</p> <p>有趣的地方是把人性醜陋的特質，放到不同位階的人身上，盲從的乞丐、固執的部長、貪婪的候選人、女人、窄眼的教士和詐欺教宗，同時又有一種核心概念是在堅守自己的價值</p> <p>導致看到每個角色都會覺得 難怪你會是這個位階的人 和 嗯嗯、我如果是他我應該也會這樣做切換，</p> <p>，例如容易被煽動的乞丐、貫徹信念到底的部長、貪婪權位者、不寬心的教士和水份很高的教宗?</p>",1);function ja(u){var o=Ma();D(12),w(u,o)}const Ha=Object.freeze(Object.defineProperty({__proto__:null,default:ja,metadata:Tn},Symbol.toStringTag,{value:"Module"})),In={title:"CSS Render 範本",date:"2025-06-22",category:null,subCategory:null,tags:["svelte","blog","markdown"],slug:"example"},{title:Ve,date:We,category:ze,subCategory:Ge,tags:Ye,slug:Ke}=In;var Ua=y('<p>這是第一篇文章，用來展示部落格如何從 markdown 載入內容。</p> <hr/> <h1>這是 H1 標題</h1> <h2>這是 H2 標題</h2> <h3>這是 H3 標題</h3> <hr/> <p>段落文字：這是一段普通的段落內容，展示預設的段落文字樣式。</p> <p>強調文字：<strong>粗體</strong>、<em>斜體</em>、<del>刪除線</del>。</p> <hr/> <h3>清單測試</h3> <ul><li>無序清單項目 1</li> <li>無序清單項目 2 <ul><li>子項目 a</li> <li>子項目 b</li></ul></li></ul> <ol><li>有序清單項目 1</li> <li>有序清單項目 2 <ol><li>子項目 i</li> <li>子項目 ii</li></ol></li></ol> <hr/> <h3>程式碼區塊</h3> <h4>行內程式碼</h4> <p>例如你可以這樣寫：<code>console.log("Hello Svelte!")</code></p> <h4>區塊程式碼</h4> <pre class="language-js"><!></pre>',1);function Ba(u){var o=Ua(),p=t(h(o),34),k=n(p);a(k,()=>`<code class="language-js"><span class="token keyword">function</span> <span class="token function">greet</span><span class="token punctuation">(</span><span class="token parameter">name</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> <span class="token template-string"><span class="token template-punctuation string">&#96;</span><span class="token string">Hello, </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">$&#123;</span>name<span class="token interpolation-punctuation punctuation">&#125;</span></span><span class="token string">!</span><span class="token template-punctuation string">&#96;</span></span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(p),w(u,o)}const Va=Object.freeze(Object.defineProperty({__proto__:null,default:Ba,metadata:In},Symbol.toStringTag,{value:"Module"})),j=[],z=Object.assign({"/src/content/Backend/BackgroudService.md":Gn,"/src/content/Backend/DDD_layer.md":Xn,"/src/content/Backend/DDD_mediator.md":Zn,"/src/content/Backend/DDD_outbox.md":as,"/src/content/Backend/FSM.md":os,"/src/content/Database/Paxon_1.md":ls,"/src/content/Database/Paxon_2.md":rs,"/src/content/Database/consistency_1.md":gs,"/src/content/Database/consistency_2.md":ws,"/src/content/Database/consistency_3.md":vs,"/src/content/Database/db_leetcode50.md":Cs,"/src/content/Database/db_normalization.md":Ps,"/src/content/Database/db_relational.md":Is,"/src/content/Database/db_sql.md":As,"/src/content/Database/db_table_1.md":Ns,"/src/content/Devlop-Note/cashflow.md":qs,"/src/content/Devlop-Note/jsPDF.md":Hs,"/src/content/Devlop-Note/pdfMerge.md":Vs,"/src/content/Devlop-Note/reconcile.md":Gs,"/src/content/Devlop-Note/sftp_ftps.md":Xs,"/src/content/Devlop-Note/structurizr.md":Zs,"/src/content/Devlop-Note/summary_2025.md":aa,"/src/content/Devlop-Note/xlsx_excel.md":oa,"/src/content/Fronted/Electron_01.md":la,"/src/content/Fronted/ThreeJS.md":ra,"/src/content/Fronted/angular_basic.md":ga,"/src/content/Fronted/angular_http.md":wa,"/src/content/Fronted/angular_router.md":va,"/src/content/Fronted/angular_value.md":Ca,"/src/content/Fronted/css.md":Pa,"/src/content/Fronted/design_token.md":Ia,"/src/content/Http/http_connect.md":Aa,"/src/content/Http/http_secretKey.md":Na,"/src/content/Project/blog.md":qa,"/src/content/Read/the_beggers_strike.md":Ha,"/src/content/empty.md":Va});for(const u in z){const o=z[u];j.push({category:o.metadata.category,subCategory:o.metadata.subCategory,title:o.metadata.title,slug:o.metadata.slug,date:o.metadata.date,tags:o.metadata.tags,excerpt:o.metadata.excerpt??"",component:o.default})}j.sort((u,o)=>o.date.localeCompare(u.date));const Xe=Vn(j);export{ws as A,gs as B,rs as C,ls as D,os as E,as as F,Zn as G,Xn as H,Gn as I,Xe as J,Va as _,Ha as a,qa as b,Na as c,Aa as d,Ia as e,Pa as f,Ca as g,va as h,wa as i,ga as j,ra as k,la as l,oa as m,aa as n,Zs as o,Xs as p,Gs as q,Vs as r,Hs as s,qs as t,Ns as u,As as v,Is as w,Ps as x,Cs as y,vs as z};
