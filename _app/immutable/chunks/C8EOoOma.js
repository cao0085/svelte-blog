import{b as L,d as Xn,f as w,a as f}from"./xsVDlqqI.js";import"./0GNeBg98.js";import{a1 as Kn,h as $,a as q,j as Jn,aJ as Qn,d as B,G as Zn,ad as ns,ac as ss,C as as,J as M,a0 as a,$ as b,a3 as n,a4 as s,aK as T}from"./n9CujY7_.js";import{r as ts}from"./BP3rl4Hc.js";function t(u,e,p=!1,k=!1,o=!1){var r=u,c="";Kn(()=>{var d=Jn;if(c===(c=e()??"")){$&&q();return}if(d.nodes_start!==null&&(Qn(d.nodes_start,d.nodes_end),d.nodes_start=d.nodes_end=null),c!==""){if($){B.data;for(var l=q(),m=l;l!==null&&(l.nodeType!==8||l.data!=="");)m=l,l=Zn(l);if(l===null)throw ns(),ss;L(B,m),r=as(l);return}var i=c+"";p?i=`<svg>${i}</svg>`:k&&(i=`<math>${i}</math>`);var y=Xn(i);if((p||k)&&(y=M(y)),L(M(y),y.lastChild),p||k)for(;M(y);)r.before(M(y));else r.before(y)}})}const U={title:"Lec02",date:"2026-03-04",category:"software",subCategory:"NYCU Algorithm",tags:["algorithm","NYCU"],slug:"NYCU_02"},{title:Ip,date:Dp,category:Pp,subCategory:xp,tags:Op,slug:Mp}=U;var ps=w('<h6><a href="https://www.youtube.com/watch?v=kxIQ86qMtfk" rel="nofollow">江蕙如老師 Lec02 演算法</a></h6> <hr/> <h3>本週問題 - Stable Matching</h3> <ul><li>一百位男/女生客戶並互相知道</li> <li>每個人需要對對方做興趣排序</li> <li>需要作配對，希望做出100對happy配對必須配完，一對一</li> <li>配對完成需要happy & stable</li></ul> <p>what’s stable matching : 不存在這對男女同時喜歡對方更勝目前的配偶</p> <h3>解法</h3> <ul><li>男生提議</li> <li>女生 free engaged married (decision making)</li></ul> <pre class="language-golang"><!></pre> <h3>Gale-Shapley Algorithm</h3> <p>延遲接受</p> <pre class="language-go"><!></pre>',1);function os(u){var e=ps(),p=a(b(e),14),k=n(p);t(k,()=>`<code class="language-golang">// init free
...
女生拒絕
  - 比本來的不好
</code>`),s(p);var o=a(p,6),r=n(o);t(r,()=>`<code class="language-go"><span class="token comment">// You can edit this code!</span>
...
<span class="token punctuation">&#125;</span></code>`),s(o),f(u,e)}const es=Object.freeze(Object.defineProperty({__proto__:null,default:os,metadata:U},Symbol.toStringTag,{value:"Module"})),F={title:"HTTP - HttpClient & HttpResource",date:"2025-11-22",category:"software",subCategory:"Angular20",tags:["fronted","angular","route"],slug:"angular_http"},{title:Np,date:Lp,category:$p,subCategory:qp,tags:Bp,slug:Hp}=F;var cs=w('<h6>Angular 內建的兩種 HTTP 工具 HttpClient & HttpResource</h6> <hr/> <h4>HttpClient</h4> <p>基於 RxJS Observable 可搭配 <code>pipe()</code> operator 處理資料流。非 2XX 的回應會自動拋出錯誤，需手動 <code>subscribe()</code> 或搭配 <code>async pipe</code> 觸發。</p> <h4>HttpResource</h4> <p>Angular 新推出的 Signal-based API，當依賴的 Signal 變化時自動重新請求，回傳 Resource 物件，包含 <code>value()</code>、<code>status()</code>、<code>error()</code> 等 Signal 屬性。</p> <pre class="language-ts"><!></pre> <h3>實作策略</h3> <p>在專案中統一管理 API 請求，設計原則如下：</p> <ol><li><code>HttpResource</code> 只用於 GET，處理會隨 Signal 自動更新的資料（權限表、個人資料等）</li> <li><code>HttpClient</code> 處理其餘所有操作，特定錯誤可以在 Service 層統一攔截，業務邏輯由外部處理</li> <li>以繼承的方式對應不同 Domain，各 Domain Service 只需覆寫 <code>baseUrl</code></li></ol> <p>有特殊需求時，可直接注入對應的 Domain Service 並在元件層額外實作。</p> <pre class="language-ts"><!></pre>',1);function ls(u){var e=cs(),p=a(b(e),12),k=n(p);t(k,()=>`<code class="language-ts"><span class="token comment">// HttpClient 寫法</span>
...
<span class="token punctuation">&#125;</span></code>`),s(o),f(u,e)}const us=Object.freeze(Object.defineProperty({__proto__:null,default:ls,metadata:F},Symbol.toStringTag,{value:"Module"})),j={title:"HTTP - RxJS Observable",date:"2025-11-23",category:"software",subCategory:"Angular20",tags:["http","angular","api"],slug:"angular_http_observable"},{title:Up,date:Fp,category:jp,subCategory:Vp,tags:Gp,slug:Wp}=j;var ks=w('<h6>Angular 內建整合 RxJS，Observable 是處理非同步資料流的核心物件，也是 HttpClient 的預設回傳型別。</h6> <hr/> <p><code>pipe()</code> 將多個 operator 串接成處理鏈，每個 operator 負責一個步驟，資料依序流過：</p> <pre class="language-ts"><!></pre> <h3>常見 Operator</h3> <table><thead><tr><th>Operator</th><th>用途說明</th></tr></thead><tbody><tr><td><code>map()</code></td><td>資料轉換，取出你要的欄位、格式化資料</td></tr><tr><td><code>tap()</code></td><td>執行副作用（不改變資料），常用來 <code>console.log</code>、設定 loading</td></tr><tr><td><code>switchMap()</code></td><td>用一筆資料觸發下一個 Observable，並自動取消舊的</td></tr><tr><td><code>mergeMap()</code></td><td>觸發下一個 Observable，但不取消前一筆（適合併發）</td></tr><tr><td><code>catchError()</code></td><td>錯誤處理，不讓錯誤中斷整個流程</td></tr><tr><td><code>finalize()</code></td><td>無論成功／失敗，最後一定會執行（常用來清除狀態）</td></tr><tr><td><code>retry(n)</code></td><td>API 失敗時自動重試 n 次</td></tr><tr><td><code>timeout(ms)</code></td><td>若 Observable 超過時間未完成，自動拋出錯誤</td></tr><tr><td><code>debounceTime(ms)</code></td><td>等使用者輸入穩定後才送出請求（防抖）</td></tr></tbody></table> <p>實際使用時通常會組合多個 operator：</p> <pre class="language-ts"><!></pre>',1);function is(u){var e=ks(),p=a(b(e),6),k=n(p);t(k,()=>`<code class="language-ts"><span class="token keyword">this</span><span class="token punctuation">.</span>http<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'/api/getExportData'</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(o),f(u,e)}const rs=Object.freeze(Object.defineProperty({__proto__:null,default:is,metadata:j},Symbol.toStringTag,{value:"Module"})),V={title:"RBAC 01 - Data Design",date:"2025-12-08",category:"software",subCategory:"Angular20",tags:["frontend","angular","RBAC"],slug:"angular_rbac_01"},{title:zp,date:Yp,category:Xp,subCategory:Kp,tags:Jp,slug:Qp}=V;var ds=w('<h6>以三張核心 DB TABLE 設計 RBAC 權限系統，從最小實踐到角色擴充</h6> <hr/> <p>需求是登入後才可使用的 ERP 系統，其他一律導向 login / 401 / 403 / 404，設計重點：</p> <ol><li><strong>顆粒度</strong>：除了 admin / manager / user 層級外，還要能控制到單一使用者的行為</li> <li><strong>限制後行為</strong>：目錄無權限就不顯示；操作無權限彈出提醒框</li> <li><strong>前後端同步</strong>：阻斷 UI 入口的同時，後端仍需獨立驗證，兩端共用一組權限常數定義</li></ol> <hr/> <h3>資料表設計</h3> <p>最小實踐 3 張表：人員表 / 聲明行為表 / 連結表（多對多）</p> <pre class="language-json"><!></pre> <p>帳號一多，連結表筆數會爆增，加一張 Role 表作為集合使用（user → role → claims）</p> <pre class="language-json"><!></pre> <p>不把 <code>userRoles</code> 合進 <code>users</code> 是為了支援一個人員同時擁有多種身份（A 子公司副理、B 子公司開發人員）</p> <p>若需要對單一使用者開特權或黑名單，再開一張 <code>userClaims</code> 補充</p> <pre class="language-json"><!></pre> <hr/> <h3>SQL 查詢</h3> <pre class="language-sql"><!></pre> <hr/> <h3>前端資料模型</h3> <p>對照 DB 的常數值，避免人工字串問題</p> <pre class="language-ts"><!></pre> <hr/> <h3>維護流程</h3> <p>新增功能模組時：</p> <ol><li>DB <code>claims</code> 表新增一筆行為記錄</li> <li><code>roleClaims</code> 表綁定對應角色</li> <li>前端 <code>ClaimCode</code> 同步新增常數</li></ol>',1);function gs(u){var e=ds(),p=a(b(e),14),k=n(p);t(k,()=>`<code class="language-json"><span class="token comment">// 人員表</span>
...
<span class="token keyword">WHERE</span> <span class="token operator">NOT</span> <span class="token keyword">EXISTS</span> <span class="token punctuation">(</span>
  ...
  <span class="token keyword">WHERE</span> uc_deny<span class="token punctuation">.</span>userId <span class="token operator">=</span> <span class="token variable">@userId</span> <span class="token operator">AND</span> uc_deny<span class="token punctuation">.</span><span class="token keyword">type</span> <span class="token operator">=</span> <span class="token string">'DENY'</span> <span class="token operator">AND</span> c<span class="token punctuation">.</span>code <span class="token operator">=</span> <span class="token variable">@claimCode</span>
    <span class="token operator">AND</span> <span class="token punctuation">(</span>uc_deny<span class="token punctuation">.</span>expiresAt <span class="token operator">IS</span> <span class="token boolean">NULL</span> <span class="token operator">OR</span> uc_deny<span class="token punctuation">.</span>expiresAt <span class="token operator">></span> <span class="token function">NOW</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var i=a(l,8),y=n(i);t(y,()=>`<code class="language-ts"><span class="token comment">// 對照 DB claims.code，集中管理</span>
...
<span class="token punctuation">&#125;</span></code>`),s(i),T(8),f(u,e)}const ms=Object.freeze(Object.defineProperty({__proto__:null,default:gs,metadata:V},Symbol.toStringTag,{value:"Module"})),G={title:"RBAC 02 - Service & Guard",date:"2025-12-09",category:"software",subCategory:"Angular20",tags:["frontend","angular","RBAC"],slug:"angular_rbac_02"},{title:Zp,date:no,category:so,subCategory:ao,tags:to,slug:po}=G;var ys=w('<h6>Angular DI Service 管理登入狀態與權限資料，Guard 攔截未授權的路由訪問</h6> <hr/> <h3>AuthService</h3> <p>用 Signal 管理登入狀態，對外只暴露唯讀 signal，登入後把資料存進 localStorage 支援重新整理後恢復 session</p> <pre class="language-ts"><!></pre> <hr/> <h3>PermissionService</h3> <p>存放使用者的權限列表，提供 <code>hasClaim()</code> 作為核心查詢方法</p> <p><code>userClaims</code> 和 <code>userClaimTree</code> 都是 <code>computed</code>，依賴 <code>userClaimIds</code> 自動更新</p> <pre class="language-ts"><!></pre> <hr/> <h3>Route</h3> <pre class="language-ts"><!></pre> <hr/> <h3>Guard</h3> <p>注入 Service 實作兩個守衛，<code>authGuard</code> 檢查登入狀態、<code>permissionGuard</code> 檢查路由所需權限</p> <pre class="language-ts"><!></pre> <p>Guard 設定好後可以先用直接輸入 URL 測試路由攔截是否正常，再整合 UI 層</p>',1);function ws(u){var e=ys(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-ts"><span class="token comment">// auth.service.ts</span>
<span class="token decorator"><span class="token at operator">@</span><span class="token function">Injectable</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span> providedIn<span class="token operator">:</span> <span class="token string">'root'</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,10),r=n(o);t(r,()=>`<code class="language-ts"><span class="token comment">// permission.service.ts</span>
<span class="token decorator"><span class="token at operator">@</span><span class="token function">Injectable</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span> providedIn<span class="token operator">:</span> <span class="token string">'root'</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,8),r=n(o);t(r,()=>`<code class="language-ts"><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">RouteConfig</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(l),T(2),f(u,e)}const vs=Object.freeze(Object.defineProperty({__proto__:null,default:bs,metadata:W},Symbol.toStringTag,{value:"Module"})),z={title:"RouteReuseStrategy 01",date:"2026-01-23",category:"software",subCategory:"Angular20",tags:["fronted","angular"],slug:"angular_routeReuseStrategy01"},{title:io,date:ro,category:go,subCategory:mo,tags:yo,slug:wo}=z;var _s=w('<h6>RouteReuseStrategy 是 Angular 路由變更時會自動調用的介面，允許透過實作介面並以 DI 替換預設邏輯，控制路由元件實例的銷毀或復用。</h6> <hr/> <p>Angular 的 <code>@angular/router</code> 套件在路由導航時，會從當前的路由資訊中提取內容建立<code>ActivatedRouteSnapshot</code>物件，再由<code>RouteReuseStrategy</code>介面中定義的方法處理後續流程，而預設注入的<code>BaseRouteReuseStrategy</code>行為可以看一下原始碼註解。</p> <pre class="language-ts"><!></pre> <p>所以若想自訂路由元件的復用行為，就必須替換預設的<code>BaseRouteReuseStrategy</code>，改為實作 RouteReuseStrategy 介面定義的 5 個方法：</p> <pre class="language-typescript"><!></pre> <p>實作完成後在 <code>app.config.ts</code> 的 <code>providers</code> 中替換預設策略：</p> <pre class="language-ts"><!></pre>',1);function Ss(u){var e=_s(),p=a(b(e),6),k=n(p);t(k,()=>`<code class="language-ts"><span class="token keyword">declare</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">BaseRouteReuseStrategy</span> <span class="token keyword">implements</span> <span class="token class-name">RouteReuseStrategy</span> <span class="token punctuation">&#123;</span>
    <span class="token comment">/**
...
<span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-typescript"><span class="token keyword">interface</span> <span class="token class-name">RouteReuseStrategy</span> <span class="token punctuation">&#123;</span>
...
Angular 逐層處理路由樹時，兩層都命中同一個 handle，<code>retrieve</code> 陷入反覆呼叫的無限迴圈。</p> <pre class="language-ts"><!></pre> <p>解法是在 <code>shouldAttach</code> 和 <code>retrieve</code> 中跳過沒有 component 的路由，用屬性 <code>route.component</code> 或 <code>route.routeConfig?.loadComponent</code> 判斷</p> <pre class="language-ts"><!></pre> <h3>完整程式碼</h3> <pre class="language-ts"><!></pre>`,1);function Ts(u){var e=Rs(),p=a(b(e),6),k=n(p);t(k,()=>`<code class="language-ts"><span class="token keyword">interface</span> <span class="token class-name">RouteReuseStrategy</span> <span class="token punctuation">&#123;</span>
  <span class="token comment">// 1. 判斷是否允許將當前路由從 DOM「分離」(detach) 並保存</span>
  <span class="token function">shouldDetach</span><span class="token punctuation">(</span>route<span class="token operator">:</span> ActivatedRouteSnapshot<span class="token punctuation">)</span><span class="token operator">:</span> <span class="token builtin">boolean</span><span class="token punctuation">;</span>
  ...
  <span class="token comment">// 5. 判斷導航前後是否視為「同一個路由」(決定要重用還是銷毀重建)</span>
  <span class="token function">shouldReuseRoute</span><span class="token punctuation">(</span>future<span class="token operator">:</span> ActivatedRouteSnapshot<span class="token punctuation">,</span> curr<span class="token operator">:</span> ActivatedRouteSnapshot<span class="token punctuation">)</span><span class="token operator">:</span> <span class="token builtin">boolean</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,6),r=n(o);t(r,()=>`<code class="language-md">導航：頁面 A → 頁面 B (理想上的時序如下)
...
<span class="token punctuation">&#125;</span></code>`),s(l);var i=a(l,10),y=n(i);t(y,()=>`<code class="language-ts">
<span class="token comment">/**
 * 最大快取數量，超過時會移除最舊的快取
 */</span>
...
<span class="token punctuation">&#125;</span></code>`),s(i);var g=a(i,10),v=n(g);t(v,()=>`<code class="language-ts"><span class="token comment">/**
...
<span class="token punctuation">&#125;</span></code>`),s(g);var h=a(g,4),C=n(h);t(C,()=>`<code class="language-ts"><span class="token comment">/**
 * 取回之前保存的路由組件
 * @param route 路由快照
 * @returns 保存的組件快照
 */</span>
...
<span class="token punctuation">&#125;</span></code>`),s(h);var _=a(h,6),A=n(_);t(A,()=>`<code class="language-ts"><span class="token comment">/**
 * 決定是否應該重用路由
...
<span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">]</span>
<span class="token punctuation">&#125;</span></code>`),s(S);var R=a(S,4),D=n(R);t(D,()=>`<code class="language-ts">
<span class="token comment">/**
 * 決定是否應該重新附加（恢復）之前保存的路由
 * @param route 路由快照
 * @returns true = 使用保存的組件, false = 創建新組件
...
<span class="token function">retrieve</span><span class="token punctuation">(</span>route<span class="token operator">:</span> ActivatedRouteSnapshot<span class="token punctuation">)</span><span class="token operator">:</span> DetachedRouteHandle <span class="token operator">|</span> <span class="token keyword">null</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">return</span> <span class="token keyword">this</span><span class="token punctuation">.</span>handlers<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span>path<span class="token punctuation">)</span> <span class="token operator">||</span> <span class="token keyword">null</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span>
</code>`),s(R);var E=a(R,4),P=n(E);t(P,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> ActivatedRouteSnapshot<span class="token punctuation">,</span> DetachedRouteHandle<span class="token punctuation">,</span> RouteReuseStrategy <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/router'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">CustomRouteReuseStrategy</span> <span class="token keyword">implements</span> <span class="token class-name">RouteReuseStrategy</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(E),f(u,e)}const Es=Object.freeze(Object.defineProperty({__proto__:null,default:Ts,metadata:Y},Symbol.toStringTag,{value:"Module"})),X={title:"Router Basic",date:"2025-10-30",category:"software",subCategory:"Angular20",tags:["route","angular","api"],slug:"angular_router"},{title:Co,date:Ro,category:To,subCategory:Eo,tags:Ao,slug:Io}=X;var As=w('<h6>可以參考這個<a href="https://github.com/mbejda/AngularFire-Starter-Template" rel="nofollow">專案範本</a>、官方文件學習</h6> <hr/> <h3>Entry</h3> <p>Angular SPA 的進入點 <code>index.html</code> 中的 <code>&lt;base href="/"&gt;</code> 讓路由系統正確解析 URL。</p> <pre class="language-html"><!></pre> <p>根元件 <code>AppComponent</code> 透過 <code>&lt;router-outlet&gt;</code> 作為路由渲染的佔位符，根據當前 URL 動態替換顯示的元件。</p> <pre class="language-ts"><!></pre> <h3>Routes</h3> <p>每個 Route 物件定義 <code>path</code> 與對應元件的映射，Angular 依序比對 URL 決定渲染哪個元件。</p> <pre class="language-ts"><!></pre> <p>加入 <code>children</code> 後，父層元件的樣板中也需要放置 <code>&lt;router-outlet&gt;</code>，作為子路由的渲染位置。</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <h3>Guard</h3> <p><code>canActivate</code> 在路由執行前的守衛邏輯，可用來控制頁面存取權限。路由設定會依序比對，需注意順序。</p> <pre class="language-ts"><!></pre>',1);function Is(u){var e=As(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-html"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">doctype</span> <span class="token name">html</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span></code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">LayoutComponent</span> <span class="token punctuation">&#123;</span><span class="token punctuation">&#125;</span></code>`),s(l);var i=a(l,2),y=n(i);t(y,()=>`<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>app-container<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>`),s(i);var g=a(i,6),v=n(g);t(v,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Routes <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/router'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">const</span> routes<span class="token operator">:</span> Routes <span class="token operator">=</span> <span class="token punctuation">[</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
  <span class="token punctuation">&#123;</span> path<span class="token operator">:</span> <span class="token string">'**'</span><span class="token punctuation">,</span> redirectTo<span class="token operator">:</span> <span class="token string">'login'</span> <span class="token punctuation">&#125;</span>
<span class="token punctuation">]</span><span class="token punctuation">;</span></code>`),s(g),f(u,e)}const Ds=Object.freeze(Object.defineProperty({__proto__:null,default:Is,metadata:X},Symbol.toStringTag,{value:"Module"})),K={title:"Value Control - Forms",date:"2025-10-14",category:"software",subCategory:"Angular20",tags:["frontend","angular","forms"],slug:"angular_reactive"},{title:Do,date:Po,category:xo,subCategory:Oo,tags:Mo,slug:No}=K;var Ps=w(`<h6>Angular20 用 Reactive Forms 比較多，透過 API 建立雙向綁定的表單物件</h6> <hr/> <h3>FormControl</h3> <p>單一欄位，<code>new FormControl('')</code> 建立綁定物件</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <hr/> <h3>FormGroup</h3> <p>表單組，用 <code>FormGroup</code> 包多個 <code>FormControl</code>，可巢狀</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <hr/> <h3>FormBuilder</h3> <p>DI 注入 <code>FormBuilder</code>，語法更簡潔，可搭配 <code>FormArray</code> 和 <code>Validators</code></p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre>`,1);function xs(u){var e=Ps(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> FormControl<span class="token punctuation">,</span> ReactiveFormsModule <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/forms'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">NameEditorComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,2),r=n(o);t(r,()=>`<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>input</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>name<span class="token punctuation">"</span></span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>text<span class="token punctuation">"</span></span> <span class="token attr-name">[formControl]</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>name<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>form</span><span class="token punctuation">></span></span></code>`),s(l);var i=a(l,8),y=n(i);t(y,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> inject <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">ProfileEditorComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">onSubmit</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    <span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">warn</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>profileForm<span class="token punctuation">.</span>value<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(i);var g=a(i,2),v=n(g);t(v,()=>`<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>form</span> <span class="token attr-name">[formGroup]</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>profileForm<span class="token punctuation">"</span></span> <span class="token attr-name">(ngSubmit)</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>onSubmit()<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>input</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>text<span class="token punctuation">"</span></span> <span class="token attr-name">formControlName</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>firstName<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>button</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>submit<span class="token punctuation">"</span></span> <span class="token attr-name">[disabled]</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>!profileForm.valid<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>Submit<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>button</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>form</span><span class="token punctuation">></span></span></code>`),s(g),f(u,e)}const Os=Object.freeze(Object.defineProperty({__proto__:null,default:xs,metadata:K},Symbol.toStringTag,{value:"Module"})),J={title:"Value Control - Signal",date:"2025-10-13",category:"software",subCategory:"Angular20",tags:["fronted","angular","signal"],slug:"angular_signal_v2"},{title:Lo,date:$o,category:qo,subCategory:Bo,tags:Ho,slug:Uo}=J;var Ms=w('<h6>Signal 是 Angular 20 推薦的響應式狀態管理 API，參考 <a href="https://v20.angular.dev/guide/signals" rel="nofollow">Angular Signals</a></h6> <hr/> <h3>核心 API</h3> <p><strong>signal</strong> ：建立可寫的響應式狀態</p> <pre class="language-ts"><!></pre> <p><strong>computed</strong> ：唯讀的衍生狀態，自動追蹤依賴，依賴變動才重新計算</p> <pre class="language-ts"><!></pre> <p><strong>effect</strong> ：當依賴變動時自動執行副作用（打 API、操作 DOM、log 等）</p> <pre class="language-ts"><!></pre> <hr/> <h3>在 Component 中使用</h3> <p>Class 內通常宣告 <code>readonly</code> 保護屬性，外部透過 <code>.set()</code> / <code>.update()</code> 修改</p> <pre class="language-ts"><!></pre> <hr/> <h3>signal / computed / effect / linkedSignal</h3> <p>以購物車的「運送方式」選單說明四者的差異</p> <p><strong>signal</strong> ：直接維護兩個 signal，切換選單時手動 reset</p> <pre class="language-ts"><!></pre> <p><strong>effect</strong> ：監聽 <code>_options</code> 變動，自動 reset <code>_selected</code></p> <pre class="language-ts"><!></pre> <p><strong>linkedSignal</strong> ：<code>computed</code> 的可寫版本，來源變動時自動重新計算初始值</p> <pre class="language-ts"><!></pre> <p>進階寫法，保留當前選項在新選單中就不 reset</p> <pre class="language-ts"><!></pre> <p>小結</p> <ul><li><code>computed</code> ：純衍生狀態，無法寫入（沒有 <code>.set()</code>）</li> <li><code>effect</code> ：流程控制，適合有條件的副作用</li> <li><code>linkedSignal</code> ：可被寫入的 computed，依賴變動時重置為計算值</li></ul> <hr/> <h3>untracked()</h3> <p>讀取 signal 值但不想建立響應式依賴時使用</p> <pre class="language-ts"><!></pre> <hr/> <h3>在 DI Service 中使用</h3> <p>Signal-based Service 適合取代 RxJS BehaviorSubject 管理同步狀態</p> <pre class="language-ts"><!></pre> <hr/> <h3>ngrx/signals（可選）</h3> <p>提供強型別和結構化規範，適合大型應用</p> <p><code>signalState</code> ：結構化的 signal 物件</p> <pre class="language-ts"><!></pre> <p><code>signalStore</code> ：自帶 DI 注入，完整封裝狀態和方法</p> <pre class="language-ts"><!></pre>',1);function Ns(u){var e=Ms(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-ts"><span class="token keyword">const</span> count <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token number">0</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token function">changeRegion</span><span class="token punctuation">(</span>region<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(i);var g=a(i,4),v=n(g);t(v,()=>`<code class="language-ts"><span class="token function">constructor</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token function">effect</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(S);var R=a(S,8),D=n(R);t(D,()=>`<code class="language-ts"><span class="token decorator"><span class="token at operator">@</span><span class="token function">Injectable</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span> providedIn<span class="token operator">:</span> <span class="token string">'root'</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">AppStore</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(R);var E=a(R,10),P=n(E);t(P,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> patchState<span class="token punctuation">,</span> signalState <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@ngrx/signals'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">AppStore</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(E);var x=a(E,4),O=n(x);t(O,()=>`<code class="language-ts"><span class="token keyword">const</span> AppStore <span class="token operator">=</span> <span class="token function">signalStore</span><span class="token punctuation">(</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> input <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">CustomSlider</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(l);var i=a(l,4),y=n(i);t(y,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> input<span class="token punctuation">,</span> output <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">CustomSlider</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">onChange</span><span class="token punctuation">(</span>newValue<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>valueChange<span class="token punctuation">.</span><span class="token function">emit</span><span class="token punctuation">(</span>newValue<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(i);var g=a(i,2),v=n(g);t(v,()=>`<code class="language-html"><span class="token comment">&lt;!-- 分開綁定 --></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>custom-slider</span> <span class="token attr-name">[(value)]</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>val<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span></code>`),s(g);var h=a(g,10),C=n(h);t(C,()=>`<code class="language-ts"><span class="token decorator"><span class="token at operator">@</span><span class="token function">ViewChild</span></span><span class="token punctuation">(</span><span class="token string">'myDiv'</span><span class="token punctuation">)</span> divElement<span class="token operator">!</span><span class="token operator">:</span> ElementRef<span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(h);var _=a(h,2),A=n(_);t(A,()=>'<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">#myDiv</span><span class="token punctuation">></span></span>hello<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>'),s(_);var S=a(_,4),I=n(S);t(I,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> viewChild<span class="token punctuation">,</span> ElementRef<span class="token punctuation">,</span> effect <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">MyComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(S);var R=a(S,4),D=n(R);t(D,()=>`<code class="language-ts"><span class="token comment">// viewChild.required() 表示元素必然存在</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(R);var E=a(R,8),P=n(E);t(P,()=>`<code class="language-ts"><span class="token comment">// counter.service.ts</span>
<span class="token decorator"><span class="token at operator">@</span><span class="token function">Injectable</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span> providedIn<span class="token operator">:</span> <span class="token string">'root'</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
...
<span class="token punctuation">&#125;</span></code>`),s(E);var x=a(E,2),O=n(x);t(O,()=>`<code class="language-ts"><span class="token comment">// component A</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal<span class="token punctuation">,</span> computed <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(l);var i=a(l,2),y=n(i);t(y,()=>`<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>p</span><span class="token punctuation">></span></span>&#123;&#123; count$ | async &#125;&#125;<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>p</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>button</span> <span class="token attr-name">(click)</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>increment()<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>+1<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>button</span><span class="token punctuation">></span></span></code>`),s(i);var g=a(i,4),v=n(g);t(v,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> FormControl <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/forms'</span><span class="token punctuation">;</span>
name <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">FormControl</span><span class="token punctuation">(</span><span class="token string">''</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(g);var h=a(g,10),C=n(h);t(C,()=>`<code class="language-ts"><span class="token decorator"><span class="token at operator">@</span><span class="token function">Injectable</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span> providedIn<span class="token operator">:</span> <span class="token string">'root'</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">CounterService</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">readonly</span> count <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token number">0</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token function">increment</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span> <span class="token keyword">this</span><span class="token punctuation">.</span>count<span class="token punctuation">.</span><span class="token function">update</span><span class="token punctuation">(</span>v <span class="token operator">=></span> v <span class="token operator">+</span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(h);var _=a(h,4),A=n(_);t(A,()=>`<code class="language-ts"><span class="token decorator"><span class="token at operator">@</span><span class="token function">Injectable</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span> providedIn<span class="token operator">:</span> <span class="token string">'root'</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">CounterService</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">private</span> countSubject <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">BehaviorSubject</span><span class="token punctuation">(</span><span class="token number">0</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  count$ <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span>countSubject<span class="token punctuation">.</span><span class="token function">asObservable</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token function">increment</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span> <span class="token keyword">this</span><span class="token punctuation">.</span>countSubject<span class="token punctuation">.</span><span class="token function">next</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>countSubject<span class="token punctuation">.</span>value <span class="token operator">+</span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(_);var S=a(_,4),I=n(S);t(I,()=>`<code class="language-ts"><span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">MyComponent</span> <span class="token punctuation">&#123;</span>
  counter <span class="token operator">=</span> <span class="token function">inject</span><span class="token punctuation">(</span>CounterService<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(S),T(6),f(u,e)}const Fs=Object.freeze(Object.defineProperty({__proto__:null,default:Us,metadata:Z},Symbol.toStringTag,{value:"Module"})),nn={title:"Multi-Tab Management",date:"2026-01-05",category:"software",subCategory:"Angular20",tags:["frontend","angular","RxJS"],slug:"angular_tabService"},{title:ne,date:se,category:ae,subCategory:te,tags:pe,slug:oe}=nn;var js=w('<h6>企業內部系統常用到的分頁顯示管理，管理分頁列的狀態與切換，記錄當前開啟的路由分頁</h6> <hr/> <h3>TabService</h3> <p>通常可以搭配 RouteReuseStrategy 控制元件顯示和復用</p> <ul><li><strong>RouteReuseStrategy</strong>：攔截路由切換，快取 Component 實例</li> <li><strong>TabService</strong>：記錄哪些分頁存在、哪個是 active、呼叫 <code>router.navigate()</code> 切換路由 <ol><li>存放（已 Instance）當前的分頁（Component）</li> <li>選擇該分頁替換內容</li> <li>銷毀分頁</li></ol></li></ul> <p>至少要建立兩個資料模型</p> <pre class="language-ts"><!></pre> <hr/> <h3>BehaviorSubject 寫法</h3> <p><code>BehaviorSubject</code> 維護狀態，<code>.asObservable()</code> 提供給外部訂閱</p> <pre class="language-ts"><!></pre> <hr/> <h3>Signal 寫法</h3> <pre class="language-ts"><!></pre> <hr/> <h3>UI 層</h3> <pre class="language-ts"><!></pre>',1);function Vs(u){var e=js(),p=a(b(e),12),k=n(p);t(k,()=>`<code class="language-ts"><span class="token comment">// 每個目錄的基本資料結構，用 id 當作唯一識別</span>
<span class="token keyword">interface</span> <span class="token class-name">MenuItem</span> <span class="token punctuation">&#123;</span>
  id<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,8),r=n(o);t(r,()=>`<code class="language-ts"><span class="token comment">// tab.service.ts</span>
<span class="token decorator"><span class="token at operator">@</span><span class="token function">Injectable</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span> providedIn<span class="token operator">:</span> <span class="token string">'root'</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">TabContainerComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(l),f(u,e)}const Gs=Object.freeze(Object.defineProperty({__proto__:null,default:Vs,metadata:nn},Symbol.toStringTag,{value:"Module"})),sn={title:"Backgroud Service",date:"2025-09-25",category:"software",subCategory:"Backend",tags:["Backgroud","backend","markdown"],slug:"backgroudservice"},{title:ee,date:ce,category:le,subCategory:ue,tags:ke,slug:ie}=sn;var Ws=w('<h6>C#實作非立即性的服務排序</h6> <hr/> <h3>使用背景</h3> <p>當主程式的 DI 註冊週期是以 HTTP lifecycle 為主時，可藉由 Background Service 提供長期運行的服務容器。</p> <ol><li>非阻塞式處理：可由外部 API 觸發某些動作，立即回應用戶端而不等待處理完成</li> <li>解耦合設計：將耗時的業務邏輯從 HTTP 請求週期中分離出來</li> <li>簡易事件模式：作為一個輕量級的 Event pattern 實現，處理非即時性任務</li> <li>資源管理：避免長時間佔用 HTTP 連線資源，提升系統整體效能</li></ol> <h3>Channel 基礎原理</h3> <p>Channel 是 .NET Core 提供的 thread-safe 生產者-消費者模式實作，基於 System.Threading.Channels 命名空間。它解決了多執行緒環境下的資料傳遞問題。</p> <pre class="language-csharp"><!></pre> <h3>Channel 的監聽機制</h3> <p>寫入機制 (Producer)</p> <pre class="language-csharp"><!></pre> <p>讀取監聽機制 (Consumer)</p> <pre class="language-csharp"><!></pre> <h3>基本架構</h3> <p>DI註冊</p> <pre class="language-csharp"><!></pre> <p>Controller</p> <pre class="language-csharp"><!></pre> <p>服務內部</p> <pre class="language-csharp"><!></pre>',1);function zs(u){var e=Ws(),p=a(b(e),14),k=n(p);t(k,()=>`<code class="language-csharp"><span class="token class-name"><span class="token keyword">var</span></span> channel <span class="token operator">=</span> Channel<span class="token punctuation">.</span><span class="token generic-method"><span class="token function">CreateUnbounded</span><span class="token generic class-name"><span class="token punctuation">&lt;</span>YourRequestType<span class="token punctuation">></span></span></span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// Channel 包含兩個部分</span>
...
└─────────────────────┘           └──────────────┘            └──────────────────────┘
<span class="token comment">// FIFO 先進先出的順序處理</span></code>`),s(p);var o=a(p,6),r=n(o);t(r,()=>`<code class="language-csharp"><span class="token comment">// 非同步寫入 - 不會阻塞，立即將資料放入佇列</span>
...
builder<span class="token punctuation">.</span>Services<span class="token punctuation">.</span><span class="token generic-method"><span class="token function">AddHostedService</span><span class="token generic class-name"><span class="token punctuation">&lt;</span>YourBackgroundService<span class="token punctuation">></span></span></span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var i=a(l,4),y=n(i);t(y,()=>`<code class="language-csharp"><span class="token punctuation">[</span><span class="token attribute"><span class="token class-name">HttpPost</span><span class="token attribute-arguments"><span class="token punctuation">(</span><span class="token string">"trigger-action"</span><span class="token punctuation">)</span></span></span><span class="token punctuation">]</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(i);var g=a(i,4),v=n(g);t(v,()=>`<code class="language-csharp"><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">YourBackgroundService</span> <span class="token punctuation">:</span> <span class="token type-list"><span class="token class-name">BackgroundService</span></span>
<span class="token punctuation">&#123;</span>
...
<span class="token class-name"><span class="token keyword">var</span></span> invalidSize <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token constructor-invocation class-name">ScreenSize</span><span class="token punctuation">(</span><span class="token number">0.05m</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 拋出例外</span></code>`),s(l);var i=a(l,6),y=n(i);t(y,()=>`<code class="language-csharp"><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Phone</span> <span class="token punctuation">:</span> <span class="token type-list"><span class="token class-name">AggregateRoot</span></span>
<span class="token punctuation">&#123;</span>
...
<span class="token class-name"><span class="token keyword">var</span></span> phone <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token constructor-invocation class-name">Phone</span><span class="token punctuation">(</span><span class="token string">"123456789012345"</span><span class="token punctuation">,</span> <span class="token string">"Apple"</span><span class="token punctuation">,</span> <span class="token string">"iPhone 14"</span><span class="token punctuation">,</span> screen<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(i);var g=a(i,6),v=n(g),h=a(n(v),2),C=n(h);t(C,()=>`<code class="language-csharp"><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ScreenSize</span> <span class="token punctuation">:</span> <span class="token type-list"><span class="token class-name">ValueObject</span></span>
<span class="token punctuation">&#123;</span>
    <span class="token keyword">public</span> <span class="token return-type class-name"><span class="token keyword">decimal</span></span> Inches <span class="token punctuation">&#123;</span> <span class="token keyword">get</span><span class="token punctuation">;</span> <span class="token punctuation">&#125;</span>
...
<span class="token class-name"><span class="token keyword">var</span></span> size <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token constructor-invocation class-name">ScreenSize</span><span class="token punctuation">(</span><span class="token number">6.7m</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(h),s(v);var _=a(v,2),A=a(n(_),2),S=n(A);t(S,()=>`<code class="language-csharp"><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Description</span> <span class="token punctuation">:</span> <span class="token type-list"><span class="token class-name">ValueObject</span></span>
<span class="token punctuation">&#123;</span>
...
d1 <span class="token operator">==</span> d2 <span class="token comment">// true</span></code>`),s(A),T(2),s(_);var I=a(_,2),R=a(n(I),2),D=n(R);t(D,()=>`<code class="language-csharp">    <span class="token comment">// Domain 層定義介面：「我需要查頻段是否合法」，但不關心怎麼查</span>
    ...
    <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span></code>`),s(R);var E=a(R,2),P=n(E);t(P,()=>`<code class="language-csharp">    <span class="token comment">// Infrastructure 層提供實作：實際去查資料庫</span>
...
<span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">IDomainEvent</span> <span class="token punctuation">:</span> <span class="token type-list"><span class="token class-name">INotification</span></span> <span class="token punctuation">&#123;</span> <span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-csharp"><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Order</span> <span class="token punctuation">:</span> <span class="token type-list"><span class="token class-name">AggregateRoot</span></span>
<span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(i);var g=a(i,4),v=n(g);t(v,()=>`<code class="language-csharp"><span class="token comment">// Application 層</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(g);var h=a(g,12),C=n(h);t(C,()=>`<code class="language-undefined">// ❌ 錯誤：Order 直接包含完整 Customer 物件（兩個 Aggregate 耦合）
Order &#123;
...
builder<span class="token punctuation">.</span><span class="token function">InstallMediatR</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-csharp"><span class="token comment">// Infrastructure/Installers/MediatRInstaller.cs</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(o);var c=a(o,4),d=n(c);t(d,()=>'<code class="language-csharp"><span class="token class-name"><span class="token keyword">var</span></span> result <span class="token operator">=</span> <span class="token keyword">await</span> _mediator<span class="token punctuation">.</span><span class="token function">Send</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">LoginUserCommand</span><span class="token punctuation">(</span><span class="token string">"user"</span><span class="token punctuation">,</span> <span class="token string">"pwd"</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(c);var l=a(c,10),m=n(l);t(m,()=>'<code class="language-csharp"><span class="token keyword">await</span> _mediator<span class="token punctuation">.</span><span class="token function">Publish</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">UserLoggedInNotification</span><span class="token punctuation">(</span>userId<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(l);var i=a(l,4),y=n(i);t(y,()=>`<code class="language-csharp"><span class="token punctuation">[</span><span class="token attribute"><span class="token class-name">HttpPost</span><span class="token attribute-arguments"><span class="token punctuation">(</span><span class="token string">"login"</span><span class="token punctuation">)</span></span></span><span class="token punctuation">]</span>
...
<span class="token punctuation">&#123;</span>
    <span class="token class-name"><span class="token keyword">var</span></span> result <span class="token operator">=</span> <span class="token keyword">await</span> _mediator<span class="token punctuation">.</span><span class="token function">Send</span><span class="token punctuation">(</span>command<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token keyword">return</span> <span class="token function">Ok</span><span class="token punctuation">(</span>result<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(i);var g=a(i,12),v=n(g);t(v,()=>`<code class="language-csharp">builder<span class="token punctuation">.</span>Services<span class="token punctuation">.</span><span class="token function">AddTransient</span><span class="token punctuation">(</span><span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">IPipelineBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">,</span> <span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">LoggingBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
builder<span class="token punctuation">.</span>Services<span class="token punctuation">.</span><span class="token function">AddTransient</span><span class="token punctuation">(</span><span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">IPipelineBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">,</span> <span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">ValidationBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(g);var h=a(g,8),C=n(h);t(C,()=>`<code class="language-csharp"><span class="token comment">// .csproj</span>
...
<span class="token operator">&lt;</span><span class="token class-name">PackageReference</span> Include<span class="token operator">=</span><span class="token string">"MassTransit.RabbitMQ"</span> Version<span class="token operator">=</span><span class="token string">"8.1.2"</span> <span class="token operator">/</span><span class="token operator">></span></code>`),s(h);var _=a(h,2),A=n(_);t(A,()=>`<code class="language-csharp"><span class="token comment">// Program.cs</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(_);var S=a(_,4),I=n(S);t(I,()=>'<code class="language-csharp"><span class="token keyword">await</span> _sendEndpoint<span class="token punctuation">.</span><span class="token function">Send</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">GenerateInvoice</span> <span class="token punctuation">&#123;</span> OrderId <span class="token operator">=</span> <span class="token string">"123"</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(S);var R=a(S,4),D=n(R);t(D,()=>'<code class="language-csharp"><span class="token keyword">await</span> _publishEndpoint<span class="token punctuation">.</span><span class="token function">Publish</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">UserCreated</span> <span class="token punctuation">&#123;</span> UserId <span class="token operator">=</span> Guid<span class="token punctuation">.</span><span class="token function">NewGuid</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(R);var E=a(R,4),P=n(E);t(P,()=>`<code class="language-csharp">cfg<span class="token punctuation">.</span><span class="token function">ConfigureMediator</span><span class="token punctuation">(</span><span class="token punctuation">(</span>context<span class="token punctuation">,</span> cfg<span class="token punctuation">)</span> <span class="token operator">=></span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(E);var x=a(E,2),O=n(x);t(O,()=>`<code class="language-csharp"><span class="token punctuation">[</span><span class="token attribute"><span class="token class-name">HttpPost</span><span class="token attribute-arguments"><span class="token punctuation">(</span><span class="token string">"register"</span><span class="token punctuation">)</span></span></span><span class="token punctuation">]</span>
...
<span class="token punctuation">&#125;</span></code>`),s(x),f(u,e)}const ea=Object.freeze(Object.defineProperty({__proto__:null,default:oa,metadata:on},Symbol.toStringTag,{value:"Module"})),en={title:"Domain-Driven 05 - Outbox Pattern",date:"2026-02-15",category:"software",subCategory:"Backend",tags:["DDD","backend","design","csharp","outbox"],slug:"ddd_05"},{title:Le,date:$e,category:qe,subCategory:Be,tags:He,slug:Ue}=en;var ca=w('<h6>拆分主副邏輯，同時保持資料同步性</h6> <hr/> <h2>SideEffect</h2> <p>若把 DDD 流程中的主副行為拆分：</p> <ul><li>創建員工帳戶的時候 <code>&lt;TABLE_Employee&gt;</code> 新增一筆資料</li> <li>幫對應到的 <code>&lt;TABLE_Department&gt;_Headcount</code> 總人數加一</li></ul> <br/> <p>若是以依照 MVC 架構會是</p> <pre class="language-csharp"><!></pre> <p>用 DDD 寫則變成是</p> <pre class="language-csharp"><!></pre> <p>假設創建員工帳號變為須更新 5-10 張表單,函式會越來越巨大、複雜且難以測試與維護。透過 DDD 的 Domain Event 拆解副作用邏輯可異步處理，減少主流程延遲。</p> <h2>ASIO 原子性（Atomicity of Side-Effect & IO）</h2> <p>剛剛提到的行為，主邏輯成功時無法保證所有副作用（如更新部門、發送通知等）都成功執行，這違反了分散系統中常見的 資料一致性與原子性要求。</p> <p>解決方法是設計一張資料庫新表<code>&lt;DB_Outbox_Message&gt;</code>，在一筆交易中提交主邏輯與事件，且把事件訊息<code>(Event、Payload、Time)</code>寫入這張表。這樣執行失敗也有紀錄可以查驗，也可設計失敗的 Retry 機制。</p> <br/> <p>主要實踐方法是用背景應用重複執行，訪問 DB_Outbox_Message 執行該事件</p> <pre class="language-csharp"><!></pre>',1);function la(u){var e=ca(),p=a(b(e),14),k=n(p);t(k,()=>`<code class="language-csharp">db_Employee<span class="token punctuation">.</span><span class="token function">Add</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
db<span class="token punctuation">.</span><span class="token function">Commit</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-csharp"><span class="token comment">// Application Layer</span>
...
<span class="token punctuation">&#125;</span></code>`),s(l);var i=a(l,4),y=n(i);t(y,()=>`<code class="language-csharp"><span class="token comment">// Infrastructure/Persistence/YourDbContextFactory.cs</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(i);var g=a(i,6),v=n(g);t(v,()=>`<code class="language-bash">dotnet ef migrations <span class="token function">add</span> AddNewFeature <span class="token parameter variable">--context</span> MyDbContext // AddNewFeature 版本控制名稱, MyDbContext C<span class="token comment"># 的 DB Instance</span>
dotnet ef migrations <span class="token function">add</span> AddNewFeature <span class="token parameter variable">--project</span> DDD.Infrastructure --startup-project DDD.WebApi <span class="token parameter variable">--context</span> BaseDbContext // 跨層設定</code>`),s(g);var h=a(g,4),C=n(h);t(C,()=>'<code class="language-bash">dotnet ef database update <span class="token parameter variable">--context</span> BaseDbContext <span class="token parameter variable">--project</span> <span class="token punctuation">..</span>. --startup-project <span class="token punctuation">..</span>.</code>'),s(h);var _=a(h,6),A=n(_);t(A,()=>`<code class="language-csharp">    <span class="token keyword">public</span> <span class="token keyword">partial</span> <span class="token keyword">class</span> <span class="token class-name">InitialCreate</span> <span class="token punctuation">:</span> <span class="token type-list"><span class="token class-name">Migration</span></span>
    <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(S);var R=a(S,4),D=n(R);t(D,()=>`<code class="language-json"><span class="token comment">// 正式</span>
...
<span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(R);var E=a(R,4),P=n(E);t(P,()=>`<code class="language-csharp"><span class="token comment">// Infrastructure/Installers/DatabaseMigrationInstaller.cs</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(E);var x=a(E,4),O=n(x);t(O,()=>`<code class="language-csharp"><span class="token comment">// Program.cs</span>
...
app<span class="token punctuation">.</span><span class="token function">Run</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(x),T(2),f(u,e)}const ra=Object.freeze(Object.defineProperty({__proto__:null,default:ia,metadata:cn},Symbol.toStringTag,{value:"Module"})),ln={title:"Finite-State Machine",date:"2025-06-30",category:"software",subCategory:"Backend",tags:["FSM","backend","markdown"],slug:"FSM"},{title:Ye,date:Xe,category:Ke,subCategory:Je,tags:Qe,slug:Ze}=ln;var da=w('<h6>FSM 這是一種類比電路常見的概念，用金流常見的狀態模擬看看。</h6> <hr/> <h3>核心概念</h3> <p>狀態是封閉集合其一：Pending / Paid / Failed / RefundPending / Refunded。</p> <p>事件是唯一入口：只有明確的事件才能讓狀態改變。</p> <pre class="language-csharp"><!></pre> <table><thead><tr><th>CurrentState</th><th>Trigger</th><th>NextState</th></tr></thead><tbody><tr><td>Pending</td><td>PaySucceeded</td><td>Paid</td></tr><tr><td>Pending</td><td>PayFailed</td><td>Failed</td></tr><tr><td>Paid</td><td>StartRefund</td><td>RefundPending</td></tr><tr><td>RefundPending</td><td>RefundSucceeded</td><td>Refunded</td></tr><tr><td>RefundPending</td><td>RefundFailed</td><td>Paid</td></tr><tr><td>Failed/Refunded</td><td><em>(無任何事件)</em></td><td><em>(終點)</em></td></tr></tbody></table> <h3>簡易流程</h3> <pre class="language-csharp"><!></pre> <p>限制行為的方式</p> <pre class="language-csharp"><!></pre> <h3>測試與擴充</h3> <p>單元測試每條轉移：「Pending → PaySucceeded → Paid」。</p> <p>新增流程：只要在 enum + 轉移表多加一條，和對應 trigger 的處理；主程式 switch(fsm.CurrentState) 自動接手 DB 差異。</p>',1);function ga(u){var e=da(),p=a(b(e),10),k=n(p);t(k,()=>`<code class="language-csharp"><span class="token comment">// 狀態（State）</span>
...
PaySucceeded<span class="token punctuation">,</span> PayFailed<span class="token punctuation">,</span> StartRefund<span class="token punctuation">,</span> RefundSucceeded<span class="token punctuation">,</span> RefundFailed</code>`),s(p);var o=a(p,6),r=n(o);t(r,()=>`<code class="language-csharp">
...
fsm<span class="token punctuation">.</span><span class="token function">Fire</span><span class="token punctuation">(</span>trigger<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(c),T(6),f(u,e)}const ma=Object.freeze(Object.defineProperty({__proto__:null,default:ga,metadata:ln},Symbol.toStringTag,{value:"Module"})),un={title:"Canceling Http Requests",date:"2026-02-06",category:"software",subCategory:"Backend",tags:["Backgroud","backend","Cancel"],slug:"cancelrequest"},{title:nc,date:sc,category:ac,subCategory:tc,tags:pc,slug:oc}=un;var ya=w('<h6>主動去中斷 HTTP 請求</h6> <hr/> <h3>Http Request</h3> <p>前端 POST → Preflight (OPTIONS) → 實際 POST → 等待回應 → 收到回應</p> <pre class="language-md"><!></pre> <p>也就是在還沒有拿到 Response 前都會保持 TCP 通信，想要中斷取消該請求的方法</p> <ul><li><p>關閉瀏覽器/分頁</p></li> <li><p>JavaScript 呼叫 AbortController.abort()</p></li> <li><p>網路斷線</p></li></ul> <p>那當 TCP 連線中斷後，會希望後端終止該流程避免資源消耗，就可以使用 Cancel Token。</p> <h3>Canceling</h3> <p>概念滿單純的，就是從 <code>CancellationTokenSource</code> 創建一顆 token，當作參數傳入 <code>func(token)</code>。當 TCP 連線中斷後，Runtime 會自動將 token 狀態設為已取消，每個 func 內部就去檢查該 token 狀態來決定是否繼續執行。</p> <p>每個語言處理 token 的方式不一樣：</p> <ul><li><strong>C#</strong>：使用獨立的 <code>CancellationToken</code>，需手動呼叫 <code>ThrowIfCancellationRequested()</code> 拋出 <code>OperationCanceledException</code>，或檢查 <code>IsCancellationRequested</code> 屬性，另外很多套件和常用方法都接受 token 傳入</li> <li><strong>Go</strong>：包在 <code>context.Context</code> 裡面，透過 <code>ctx.Done()</code> channel 或 <code>ctx.Err()</code> 檢查是否取消</li></ul> <pre class="language-csharp"><!></pre> <pre class="language-go"><!></pre>',1);function wa(u){var e=ya(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-md">前端                          後端
 ...
 │←── 回傳 HTTP Response ────── │
 │── TCP 連線關閉 ──────────────→│
</code>`),s(p);var o=a(p,16),r=n(o);t(r,()=>`<code class="language-csharp"><span class="token comment">// ASP.NET Core - Controller 自動注入 CancellationToken</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-go">
...
<span class="token punctuation">&#125;</span>
    ...
    <span class="token punctuation">&#125;</span> <span class="token keyword">else</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token keyword">return</span> <span class="token boolean">false</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c);var l=a(c,2),m=n(l);t(m,()=>`<code class="language-golang">
package main
...
但是如果_R3突然掛掉了，可以找一個替代伺服器_R4，只是_R4儲存的資料需要標記，等_R3恢復後再回補</p> <pre class="language-text"><!></pre>`,1);function Ta(u){var e=Ra(),p=a(b(e),34),k=n(p);t(k,()=>`<code class="language-text">庫存初始值：100
...
R1: 99
R2: 98
R3: 98</code>`),s(p);var o=a(p,6),r=n(o);t(r,()=>`<code class="language-text">R1: 99
R2: 99
R3: 99
R4: 100
R5: 100</code>`),s(o);var c=a(o,4),d=n(c);t(d,()=>`<code class="language-text">R1: 99  ✅（有時間戳 t2）
R4: 100 ❌（舊）
R5: 100 ❌（舊）</code>`),s(c);var l=a(c,4),m=n(l);t(m,()=>`<code class="language-text">R1: 99
R2: 99
R3: 99
R4: 99
R5: 99</code>`),s(l);var i=a(l,14),y=n(i);t(y,()=>`<code class="language-text">C1 發出寫入 (搶購筆電，剩 99)

[ 原本應該寫入 ]:  R1   R2   R3  
[ 實際成功寫入 ]:  R1   R4   ❌

=&gt; 系統標記：R4 存了一份「R3 的代理資料」</code>`),s(i),f(u,e)}const Ea=Object.freeze(Object.defineProperty({__proto__:null,default:Ta,metadata:dn},Symbol.toStringTag,{value:"Module"})),gn={title:"Database Consistency 2",date:"2025-07-28",category:"software",subCategory:"Database",tags:["consistency","system","design","database"],slug:"database_consistency_2"},{title:Cc,date:Rc,category:Tc,subCategory:Ec,tags:Ac,slug:Ic}=gn;var Aa=w('<h6>維持多台 Server 資料唯一性的幾種選擇，<a href="https://ithelp.ithome.com.tw/articles/10217086" rel="nofollow">建議閱讀這裡</a></h6> <hr/> <p>實作時不同伺服器中的時間戳不可當作最新資料的判斷依據</p> <br/> <h3>Vector Clock</h3> <p>背景設定有 3 台 replica：R1、R2、R3，每個伺服器都有一個 Vector Clock (DB自己處理+1)來追蹤</p> <br/> <p>Client 讀資料會拿到的格式</p> <pre class="language-text"><!></pre> <p>Client 寫入資料</p> <pre class="language-text"><!></pre> <p>若是 R1 收到資料後 → 它把自己的版本數加 1</p> <pre class="language-text"><!></pre> <p>R2 收到資料後 → 也是一樣，把自己的欄位 R2 +1</p> <pre class="language-text"><!></pre> <p>之後的取就拿數字最大的版本當作最新來源</p>',1);function Ia(u){var e=Aa(),p=a(b(e),16),k=n(p);t(k,()=>`<code class="language-text">value = 100
version = &#123; R1: 1, R2: 1, R3: 0 &#125;</code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-text">&#123;
  value: 99,
  old_version: &#123; R1: 1, R2: 1, R3: 0 &#125;
&#125;</code>`),s(o);var c=a(o,4),d=n(c);t(d,()=>'<code class="language-text">&#123; R1: 2, R2: 1, R3: 0 &#125;</code>'),s(c);var l=a(c,4),m=n(l);t(m,()=>'<code class="language-text">&#123; R1: 1, R2: 2, R3: 0 &#125;</code>'),s(l),T(2),f(u,e)}const Da=Object.freeze(Object.defineProperty({__proto__:null,default:Ia,metadata:gn},Symbol.toStringTag,{value:"Module"})),mn={title:"Database Consistency 3",date:"2025-07-29",category:"software",subCategory:"Database",tags:["consistency","system","design","database"],slug:"database_consistency_3"},{title:Dc,date:Pc,category:xc,subCategory:Oc,tags:Mc,slug:Nc}=mn;var Pa=w('<h6>維持多台 Server 資料唯一性的幾種選擇，<a href="https://ithelp.ithome.com.tw/articles/10217086" rel="nofollow">建議閱讀這裡</a></h6> <hr/> <h3>Consensus Algorithm Requirements</h3> <ul><li>Termination: 保證所有參與決策且無故障的節點最終會做一個決定，執行的演算法不會無法終止。</li> <li>Validity: 最終的決議一定是來自某一個參與的節點</li> <li>Agreement: 當演算法完成時，所有節點都會做相同的決定</li></ul> <br/> <h3>Network Model</h3> <p>Synchronous Network Model</p> <ul><li><p>時間同步（Clock Synchronization）: 每個節點的「時鐘」彼此對齊，雖然可能有些微差異，但保證不會無限偏移（例如都在 ±ε 範圍內）。</p></li> <li><p>訊息延遲有上限（Bounded Network Delay）: 傳輸訊息最多只會延遲某個固定時間</p></li> <li><p>計算速度一致（Equal Computation Speed）: 所有節點的處理速度是同步的，彼此的運算時間不會落差太大。</p></li></ul> <p>上述是最理想的狀態，但是在現實世界不可能達成，而 Asynchronous Network 就是相反。</p> <br/> <p>Failure Model</p> <ul><li><p>Byzantine failures: 該節點不按照程式邏輯執行，惡意給予錯誤的回復，比方使用者輸入0，當提出proposal給集群時，該節點隨機傳送0或1給其餘節點</p></li> <li><p>Crash-recovery failures: 節點運算總是正確，但是可能因為發生Crash或是網路中斷，需要時間Recover，因此無法保證回覆時間</p></li> <li><p>Omission failures: 發生Crash後「消息」不會回覆。比方網路中斷導致訊息丟失，不再重傳。</p></li> <li><p>Crash failure: 發生Crash，不再回復。比方某個節點發生故障，則該節點不再回復也不再跟其他系統其他節點有來往。</p></li></ul> <br/> <h3>Paxos Algorithm</h3> <p>每個節點稱作 Processes 可以同時發起提議（Proposer）/ 接受提議（Acceptor），遵循 Asynchronous Network Model 不保證時間但保證最終會送達</p> <br/> <p><strong>Phase 1 — Preparation</strong>：讓過半數的 Acceptors 承諾不再接受比 n 小的提案</p> <p><strong>Phase 2 — Accept</strong>:Proposer 收集 ack 後，決定要提出什麼值，並發送給大家</p>',1);function xa(u){var e=Pa();T(34),f(u,e)}const Oa=Object.freeze(Object.defineProperty({__proto__:null,default:xa,metadata:mn},Symbol.toStringTag,{value:"Module"})),yn={title:"PostgreSQL 併發控制 1",date:"2026-02-03",category:"software",subCategory:"Database",tags:["database","concurrency","sql"],slug:"db_concurrency01"},{title:Lc,date:$c,category:qc,subCategory:Bc,tags:Hc,slug:Uc}=yn;var Ma=w('<h6>先了解一下資料庫效能開銷</h6> <hr/> <p>任何 DB 指令包含讀取都是 <code>begin transaction</code>到 <code>COMMIT</code></p> <pre class="language-sql"><!></pre> <p>當一個交易沒有<code>COMMIT</code>之前都會持續消耗資源</p> <pre class="language-sql"><!></pre> <h3>開銷</h3> <p>主要會分成網路連線和資料庫主機處理，所以相同程式碼在不同設備下會有不同結果</p> <pre class="language-sql"><!></pre> <p>因為一個交易不提交也會吃效能，寫邏輯時就會需要取捨一下。</p> <pre class="language-python"><!></pre> <pre class="language-sql"><!></pre> <p>結論是若可以保證資料一致性，大多情況多個提交 > 單個長交易。</p>',1);function Na(u){var e=Ma(),p=a(b(e),6),k=n(p);t(k,()=>`<code class="language-sql"><span class="token comment">-- BEGIN (START TRANSACTION)</span>
...
時間：<span class="token number">0.5</span> <span class="token operator">~</span> <span class="token number">2</span>ms（無 fsync）
      <span class="token number">5</span> <span class="token operator">~</span> <span class="token number">50</span>ms（有 fsync，取決於磁碟）</code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-sql">
...
連線被佔用（不可用給其他請求）
連線池計數器維護
連線健康檢查（heartbeat）</code>`),s(o);var c=a(o,6),d=n(c);t(d,()=>`<code class="language-sql"><span class="token comment">-- 本地資料庫 (localhost)</span>
...
差異: <span class="token operator">+</span><span class="token number">75</span><span class="token operator">%</span></code>`),s(c);var l=a(c,4),m=n(l);t(m,()=>`<code class="language-python"><span class="token comment"># 邏輯方案 A（長事務）</span>
...
方案 B: <span class="token number">30</span>ms</code>`),s(i),T(2),f(u,e)}const La=Object.freeze(Object.defineProperty({__proto__:null,default:Na,metadata:yn},Symbol.toStringTag,{value:"Module"})),wn={title:"PostgreSQL 併發控制 2",date:"2026-02-04",category:"software",subCategory:"Database",tags:["database","concurrency","sql"],slug:"db_concurrency02"},{title:Fc,date:jc,category:Vc,subCategory:Gc,tags:Wc,slug:zc}=wn;var $a=w('<h6>PostgreSQL 的併發處理 <a href="https://www.postgresql.org/docs" rel="nofollow">PostgreSQL Doc</a></h6> <hr/> <h3>交易隔離</h3> <p>交易開始後可能會有以下問題:</p> <ol><li><p>Dirty Read 髒讀 :</p> <ul><li>不保證讀到的資料都是已 Commit 的。</li></ul></li> <li><p>Nonrepeatable Read 複讀 :</p> <ul><li>保證讀取的資料是已 Commit</li> <li>不保證同個交易獲得的資料一樣(期間該交易被更新)</li></ul></li> <li><p>Phantom Read 幻讀 :</p> <ul><li>保證讀取的”現有行”數據一樣（不會被修改）</li> <li>不保證獲得的”行集合”一樣(期間插入/刪除)</li></ul></li> <li><p>Serialization 序列化 :</p> <ul><li>保證讀取的資料來源、邏輯一致</li></ul></li></ol> <h3>鎖表</h3> <p>PostgreSQL 提供以下鎖層級，根據鎖之間是否產生衝突，來決定該交易列隊等待與否，按限制性從低到高排列：</p> <h4>ACCESS SHARE（訪問共享鎖）</h4> <p>只衝突<code>ACCESS EXCLUSIVE</code>，普通的讀取。</p> <pre class="language-sql"><!></pre> <hr/> <h4>ROW SHARE（行共享鎖）</h4> <p>只衝突<code>EXCLUSIVE, ACCESS EXCLUSIVE</code>，可讀不改。</p> <pre class="language-sql"><!></pre> <p>ROW SHARE 總共有四種模式</p> <pre class="language-sql"><!></pre> <hr/> <h4>ROW EXCLUSIVE（行排他鎖）</h4> <p>衝突<code>SHARE, SHARE UPDATE EXCLUSIVE, SHARE ROW EXCLUSIVE, EXCLUSIVE, ACCESS EXCLUSIVE</code>，常見的編輯。</p> <pre class="language-sql"><!></pre> <hr/> <h4>SHARE UPDATE EXCLUSIVE（共享更新排他鎖）</h4> <p>衝突<code>SHARE UPDATE EXCLUSIVE, SHARE, SHARE ROW EXCLUSIVE, EXCLUSIVE, ACCESS EXCLUSIVE</code>，用來執行系統性設定(索引創建)，避免該表被鎖死。</p> <pre class="language-sql"><!></pre> <hr/> <h4>SHARE（共享鎖）</h4> <p>衝突<code>ROW EXCLUSIVE, SHARE UPDATE EXCLUSIVE, SHARE ROW EXCLUSIVE, EXCLUSIVE, ACCESS EXCLUSIVE</code></p> <pre class="language-sql"><!></pre> <hr/> <h4>SHARE ROW EXCLUSIVE</h4> <p>衝突<code>ROW EXCLUSIVE, SHARE UPDATE EXCLUSIVE, SHARE, SHARE ROW EXCLUSIVE, EXCLUSIVE, ACCESS EXCLUSIVE</code>，會自衝突。</p> <pre class="language-sql"><!></pre> <hr/> <h3>EXCLUSIVE（排他鎖）</h3> <p>限制性非常高，只允許<code>ACCESS SHARE</code></p> <pre class="language-sql"><!></pre> <hr/> <h3>ACCESS EXCLUSIVE（訪問排他鎖）</h3> <p>限制性最高，等同該表只能被該交易使用</p> <pre class="language-sql"><!></pre>',1);function qa(u){var e=$a(),p=a(b(e),18),k=n(p);t(k,()=>`<code class="language-sql"><span class="token keyword">BEGIN</span><span class="token punctuation">;</span>
...
<span class="token keyword">COMMIT</span><span class="token punctuation">;</span></code>`),s(p);var o=a(p,8),r=n(o);t(r,()=>`<code class="language-sql"><span class="token keyword">BEGIN</span><span class="token punctuation">;</span>
...
<span class="token keyword">SELECT</span> <span class="token operator">*</span> <span class="token keyword">FROM</span> users <span class="token keyword">WHERE</span> id <span class="token operator">=</span> <span class="token number">1</span> <span class="token keyword">FOR</span> <span class="token keyword">SHARE</span><span class="token punctuation">;</span>
<span class="token keyword">SELECT</span> <span class="token operator">*</span> <span class="token keyword">FROM</span> users <span class="token keyword">WHERE</span> id <span class="token operator">=</span> <span class="token number">1</span> <span class="token keyword">FOR</span> <span class="token keyword">KEY</span> <span class="token keyword">SHARE</span><span class="token punctuation">;</span></code>`),s(c);var l=a(c,8),m=n(l);t(m,()=>`<code class="language-sql"><span class="token comment">-- 交易 A</span>
<span class="token keyword">BEGIN</span><span class="token punctuation">;</span>
...
<span class="token keyword">COMMIT</span><span class="token punctuation">;</span></code>`),s(l);var i=a(l,8),y=n(i);t(y,()=>`<code class="language-sql"><span class="token keyword">BEGIN</span><span class="token punctuation">;</span>
...
<span class="token keyword">COMMIT</span><span class="token punctuation">;</span></code>`),s(i);var g=a(i,8),v=n(g);t(v,()=>`<code class="language-sql"><span class="token keyword">BEGIN</span><span class="token punctuation">;</span>
...
<span class="token keyword">COMMIT</span><span class="token punctuation">;</span></code>`),s(g);var h=a(g,8),C=n(h);t(C,()=>`<code class="language-sql"><span class="token comment">-- 交易 A</span>
<span class="token keyword">BEGIN</span><span class="token punctuation">;</span>
...
<span class="token keyword">COMMIT</span><span class="token punctuation">;</span></code>`),s(h);var _=a(h,8),A=n(_);t(A,()=>`<code class="language-sql"><span class="token keyword">BEGIN</span><span class="token punctuation">;</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(p);var o=a(p,6),r=n(o);t(r,()=>`<code class="language-sql"><span class="token keyword">SELECT</span> s<span class="token punctuation">.</span>user_id<span class="token punctuation">,</span> 
...
<span class="token keyword">ON</span> s<span class="token punctuation">.</span>user_id <span class="token operator">=</span> aa<span class="token punctuation">.</span>user_id<span class="token punctuation">;</span></code>`),s(o);var c=a(o,6),d=n(c);t(d,()=>`<code class="language-sql"><span class="token keyword">SELECT</span> 
...
<span class="token keyword">GROUP</span> <span class="token keyword">BY</span> 
    ...
    country<span class="token punctuation">;</span></code>`),s(c);var l=a(c,6),m=n(l);t(m,()=>`<code class="language-sql"><span class="token keyword">SELECT</span>
  <span class="token function">ROUND</span><span class="token punctuation">(</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var i=a(l,6),y=n(i);t(y,()=>`<code class="language-sql"><span class="token keyword">select</span> e1<span class="token punctuation">.</span>employee_id
<span class="token keyword">from</span> <span class="token punctuation">(</span>
    <span class="token keyword">select</span> <span class="token operator">*</span>
...
<span class="token keyword">order</span> <span class="token keyword">by</span> employee_id <span class="token keyword">asc</span></code>`),s(i);var g=a(i,6),v=n(g);t(v,()=>`<code class="language-sql"><span class="token punctuation">(</span>
...
<span class="token punctuation">(</span>
  ...
  <span class="token keyword">LIMIT</span> <span class="token number">1</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(g);var h=a(g,6),C=n(h);t(C,()=>`<code class="language-sql"><span class="token keyword">SELECT</span> id<span class="token punctuation">,</span> <span class="token function">COUNT</span><span class="token punctuation">(</span><span class="token operator">*</span><span class="token punctuation">)</span> <span class="token keyword">AS</span> num
<span class="token keyword">FROM</span> <span class="token punctuation">(</span>
...
1      | reading
1      | swimming
1      | coding</code>`),s(p);var o=a(p,6),r=n(o);t(r,()=>`<code class="language-text">OrderID | ProductID | OrderDate
--------|-----------|------------
1001    | A1        | 2025-07-01
...
--------|-----------
1001    | A1
1001    | A2</code>`),s(c);var l=a(c,6),m=n(l);t(m,()=>`<code class="language-text">StudentID | DeptID | DeptName
----------|--------|----------
1001      | D01    | Computer Science</code>`),s(l);var i=a(l,4),y=n(i);t(y,()=>`<code class="language-text">StudentID | DeptID
----------|--------
1001      | D01
1002      | D02
...
D02    | Electrical Engineering</code>`),s(i);var g=a(i,6),v=n(g);t(v,()=>`<code class="language-text">Course | Instructor | Room
-------|------------|-----
DB     | Smith      | R1
DB     | Jones      | R2</code>`),s(g);var h=a(g,4),C=n(h);t(C,()=>`<code class="language-text">-- 課程與教室（CourseRoom）
Course | Room
-------|-----
DB     | R1
...
Instructor | Room
-----------|-----
Smith      | R1</code>`),s(h);var _=a(h,6),A=n(_);t(A,()=>`<code class="language-text">錯誤
Restaurant | Crust   | Area
-----------|---------|--------
X Pizza    | Thick   | Downtown
X Pizza    | Stuffed | Downtown
X Pizza    | Thick   | Uptown
X Pizza    | Stuffed | Uptown</code>`),s(_);var S=a(_,4),I=n(S);t(I,()=>`<code class="language-text">Restaurant | Crust
Restaurant | Area</code>`),s(S);var R=a(S,6),D=n(R);t(D,()=>`<code class="language-text">-- Supplier-Part
S1 | P1
...
---------|------|---------
S1       | P1   | J1  （合理）
S1       | P1   | J2  （若 J2 並不屬於 P1）</code>`),s(R);var E=a(R,4),P=n(E);t(P,()=>`<code class="language-text">-- Supplier-Part-Project
Supplier | Part | Project
---------|------|---------
S1       | P1   | J1</code>`),s(E),f(u,e)}const Ga=Object.freeze(Object.defineProperty({__proto__:null,default:Va,metadata:hn},Symbol.toStringTag,{value:"Module"})),bn={title:"關聯式資料庫",date:"2025-06-22",category:"software",subCategory:"Database",tags:["database","db","sql"],slug:"db_relational"},{title:el,date:cl,category:ll,subCategory:ul,tags:kl,slug:il}=bn;var Wa=w('<pre class="language-pgsql"><!></pre> <p>連接 SQL Server 時是透過 TDS（Tabular Data Stream）的通訊協定來交換資料。</p> <ul><li>TDS 是 SQL Server 專用的底層通訊協定，負責在用戶端與資料庫伺服器之間傳遞</li> <li>通常透過 TCP/IP 傳輸，預設使用的連接埠為 1433。</li> <li>用戶端要連接資料庫時，會使用一段 Connection String（連線字串）</li></ul> <pre class="language-pgsql"><!></pre> <h3>Table（資料表）</h3> <p>資料表是資料的儲存核心，每個表由「列（row）」與「欄（column）」構成。</p> <pre class="language-sql"><!></pre> <h3>Primary Key（主鍵）</h3> <p>能唯一標識每一筆資料，一張表只能有一個主鍵，可以是單一欄位或多欄位組成（複合主鍵）。</p> <pre class="language-sql"><!></pre> <h3>Unique Constraint（唯一約束）</h3> <p>限制欄位值不能重複，一張表可以有多個唯一欄位。</p> <pre class="language-sql"><!></pre> <h3>Foreign Key（外鍵）</h3> <pre class="language-sql"><!></pre> <h3>Index（索引）</h3> <p>加速查詢效率，類似書本的目錄，索引可以建立在單一欄位或多個欄位上。</p> <pre class="language-sql"><!></pre>',1);function za(u){var e=Wa(),p=b(e),k=n(p);t(k,()=>`<code class="language-pgsql">SQL Server Instance
├── Database
│   ├── Schema
│   │   ├── Table
│   │   ├── View
...
<span class="token keyword">ADD</span> <span class="token keyword">CONSTRAINT</span> PK_Users <span class="token keyword">PRIMARY</span> <span class="token keyword">KEY</span> <span class="token punctuation">(</span>Id<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var i=a(l,6),y=n(i);t(y,()=>`<code class="language-sql"><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> Products <span class="token punctuation">(</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(i);var g=a(i,4),v=n(g);t(v,()=>`<code class="language-sql"><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> Orders <span class="token punctuation">(</span>
...
<span class="token keyword">SELECT</span> name<span class="token punctuation">,</span> email <span class="token keyword">FROM</span> users<span class="token punctuation">;</span></code>`),s(p);var o=a(p,28),r=n(o);t(r,()=>`<code class="language-sql"><span class="token keyword">SELECT</span> 
...
</code>`),s(p);var o=a(p,6),r=n(o);t(r,()=>`<code class="language-scss">1. 類別A <span class="token punctuation">(</span>ID=1<span class="token punctuation">)</span>
...
2. 類別B <span class="token punctuation">(</span>ID=2<span class="token punctuation">)</span>
   └─ 子類B1 <span class="token punctuation">(</span>ID=5<span class="token punctuation">)</span></code>`),s(o);var c=a(o,4),d=n(c);t(d,()=>`<code class="language-sql"><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> CategoryNested <span class="token punctuation">(</span>
  ID      <span class="token keyword">BIGINT</span>       <span class="token keyword">PRIMARY</span> <span class="token keyword">KEY</span><span class="token punctuation">,</span>
  Name    NVARCHAR<span class="token punctuation">(</span><span class="token number">100</span><span class="token punctuation">)</span> <span class="token operator">NOT</span> <span class="token boolean">NULL</span><span class="token punctuation">,</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var i=a(l,4),y=n(i);t(y,()=>`<code class="language-sql"><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> Category <span class="token punctuation">(</span>
  ID   <span class="token keyword">BIGINT</span>        <span class="token keyword">PRIMARY</span> <span class="token keyword">KEY</span><span class="token punctuation">,</span>
  Name NVARCHAR<span class="token punctuation">(</span><span class="token number">100</span><span class="token punctuation">)</span> <span class="token operator">NOT</span> <span class="token boolean">NULL</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code>`),s(i);var g=a(i,2),v=n(g);t(v,()=>`<code class="language-scss">A <span class="token punctuation">(</span>ID=1<span class="token punctuation">)</span>
...
└─ C <span class="token punctuation">(</span>ID=3<span class="token punctuation">)</span></code>`),s(g);var h=a(g,6),C=n(h);t(C,()=>`<code class="language-sql"><span class="token comment">-- 查詢某節點的所有後代（含自己）</span>
...
<span class="token keyword">ORDER</span> <span class="token keyword">BY</span> cc<span class="token punctuation">.</span>Depth<span class="token punctuation">;</span></code>`),s(h);var _=a(h,6),A=n(_);t(A,()=>`<code class="language-sql"><span class="token comment">-- 對所有 ancestor of parentId，插入新後代關係</span>
...
讓主執行緒”持續”跑【載入中】的畫面和 APP 不會被 ANR && 觸發新的事件</p> <pre class="language-kotlin"><!></pre> <h4>取得當前文章瀏覽數</h4> <p>主執行緒可以持續使用不影響，只要在開背景執行緒拿到結果後更新到該 UI 的值就可以了</p> <pre class="language-kotlin"><!></pre> <h4>瀏覽紀錄給伺服器 (純發送)</h4> <p>開發商紀錄用的，所以不管有無成功都不應該影響使用者 UI</p> <pre class="language-kotlin"><!></pre> <p>剩下還有輪詢通知(launch + while)、並行載入(async + await)和即時監聽(Flow.collect)等等</p> <h3>錯誤處理</h3> <p>UI 執行緒上不應牽涉外部邏輯，錯誤等同程式設計上有漏洞，應該直接特殊處理或崩潰</p> <p>例如 APP 在未登入的情況下，被進入到某個分頁</p> <pre class="language-kotlin"><!></pre> <p>而 Background Thread 則是需要去處理每個錯誤，防 APP 因為外力而崩潰</p> <pre class="language-kotlin"><!></pre>`,1);function ot(u){var e=pt(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-kotlin">    plugins <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,2),r=n(o);t(r,()=>`<code class="language-.toml">[versions]
agp = &quot;8.13.1&quot;
kotlin = &quot;2.0.21&quot;
coreKtx = &quot;1.10.1&quot;
junit = &quot;4.13.2&quot;
...
<span class="token keyword">fun</span> <span class="token function">MyAPP</span><span class="token punctuation">(</span>modifier<span class="token operator">:</span> Modifier <span class="token operator">=</span> Modifier<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    MaterialTheme <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(l);var i=a(l,12),y=n(i);t(y,()=>`<code class="language-kotlin"><span class="token keyword">class</span> CreatePostViewModel <span class="token operator">:</span> <span class="token function">ViewModel</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">fun</span> <span class="token function">publishPost</span><span class="token punctuation">(</span>text<span class="token operator">:</span> String<span class="token punctuation">,</span> images<span class="token operator">:</span> List<span class="token operator">&lt;</span>Uri<span class="token operator">></span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(i);var g=a(i,6),v=n(g);t(v,()=>`<code class="language-kotlin"><span class="token keyword">class</span> ArticleViewModel <span class="token operator">:</span> <span class="token function">ViewModel</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">fun</span> <span class="token function">fetchViewCount</span><span class="token punctuation">(</span>articleId<span class="token operator">:</span> String<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(g);var h=a(g,6),C=n(h);t(C,()=>`<code class="language-kotlin"><span class="token keyword">class</span> ArticleViewModel <span class="token operator">:</span> <span class="token function">ViewModel</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">fun</span> <span class="token function">recordPageView</span><span class="token punctuation">(</span>articleId<span class="token operator">:</span> String<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(h);var _=a(h,10),A=n(_);t(A,()=>`<code class="language-kotlin"><span class="token comment">// 這種錯誤應該 Crash,讓開發者知道有 Bug</span>
...
<span class="token keyword">fun</span> <span class="token function">loadPosts</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    viewModelScope<span class="token punctuation">.</span><span class="token function">launch</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(S),f(u,e)}const et=Object.freeze(Object.defineProperty({__proto__:null,default:ot,metadata:Cn},Symbol.toStringTag,{value:"Module"})),Rn={title:"插入 3D 影像",date:"2025-08-13",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"threeJs"},{title:Ll,date:$l,category:ql,subCategory:Bl,tags:Hl,slug:Ul}=Rn;var ct=w(`<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>匯入 .glb</h3> <p>透過用 three.js 匯入
Canvas ➜ WebGL ➜ Three.js ➜ GLB 模型 ➜ GPU 顯示</p> <pre class="language-js"><!></pre>`,1);function lt(u){var e=ct(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-js">  <span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> <span class="token constant">THREE</span> <span class="token keyword">from</span> <span class="token string">'three'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),f(u,e)}const rt=Object.freeze(Object.defineProperty({__proto__:null,default:it,metadata:Tn},Symbol.toStringTag,{value:"Module"})),En={title:"Design Token",date:"2025-08-18",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"webdesign"},{title:Yl,date:Xl,category:Kl,subCategory:Jl,tags:Ql,slug:Zl}=En;var dt=w('<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>Color System</h3> <p>Primary Colors</p> <pre class="language-json"><!></pre> <p>Status Colors</p> <pre class="language-json"><!></pre> <p>Neutral Colors</p> <pre class="language-json"><!></pre> <h3>Typography System</h3> <p>Font Family</p> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre>',1);function gt(u){var e=dt(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  <span class="token property">"color"</span><span class="token operator">:</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(c);var l=a(c,6),m=n(l);t(m,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(l);var i=a(l,2),y=n(i);t(y,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(i);var g=a(i,2),v=n(g);t(v,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(g);var h=a(g,2),C=n(h);t(C,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(h);var _=a(h,2),A=n(_);t(A,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(_);var S=a(_,2),I=n(S);t(I,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(S);var R=a(S,2),D=n(R);t(D,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(R);var E=a(R,2),P=n(E);t(P,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(E),f(u,e)}const mt=Object.freeze(Object.defineProperty({__proto__:null,default:gt,metadata:En},Symbol.toStringTag,{value:"Module"})),An={title:"Redis",date:"2026-02-06",category:"software",subCategory:"Golang",tags:["DDD","backend","go"],slug:"go_redis"},{title:nu,date:su,category:au,subCategory:tu,tags:pu,slug:ou}=An;var yt=w('<h6>用 Redis 的原子性去處理資料寫入前的檢查</h6> <hr/> <p>Redis 全名是 Remote Dictionary Server，特性是讀寫速度極快和保證原子性，但容量小，基本上先視作進階版 Cache 來使用</p> <h3>基本指令</h3> <pre class="language-bash"><!></pre> <pre class="language-bash"><!></pre> <h3>同步策略</h3> <ul><li><p>TTL (Time To Live)</p> <p>固定時間更新一次資料 <code>SET key value EX 300</code></p></li> <li><p>Write-Through</p> <p>資料須更新時，同時更新 DB 和 Redis，例如訂單庫存</p></li> <li><p>Cache-Aside</p> <p>讀：先查 Redis，沒有再查 DB 並回寫 Redis</p> <p>寫：先更新 DB，再刪除 Redis（下次讀取時重建）</p></li> <li><p>Event-Driven</p> <p>被動觸發</p></li></ul>',1);function wt(u){var e=yt(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-bash"><span class="token comment"># 查看所有 keys</span>
KEYS *
...
<span class="token builtin class-name">exit</span></code>`),s(p);var o=a(p,2),r=n(o);t(r,()=>`<code class="language-bash"><span class="token comment"># 查看實時日誌</span>
...
<span class="token keyword">using</span> <span class="token class-name"><span class="token keyword">var</span></span> res <span class="token operator">=</span> <span class="token keyword">await</span> client<span class="token punctuation">.</span><span class="token function">SendAsync</span><span class="token punctuation">(</span>req<span class="token punctuation">,</span> HttpCompletionOption<span class="token punctuation">.</span>ResponseHeadersRead<span class="token punctuation">,</span> ct<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var i=a(l,8),y=n(i);t(y,()=>`<code class="language-csharp"><span class="token keyword">switch</span> <span class="token punctuation">(</span>res<span class="token punctuation">.</span>data<span class="token punctuation">.</span>ReturnCode<span class="token punctuation">)</span>
<span class="token punctuation">&#123;</span>
...
<span class="token keyword">await</span> transaction<span class="token punctuation">.</span><span class="token function">CommitAsync</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(i);var g=a(i,24),v=n(g);t(v,()=>`<code class="language-csharp"><span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token operator">!</span>_allowedTransitions<span class="token punctuation">[</span>current<span class="token punctuation">]</span><span class="token punctuation">.</span><span class="token function">Contains</span><span class="token punctuation">(</span>next<span class="token punctuation">)</span><span class="token punctuation">)</span>
    <span class="token keyword">throw</span> <span class="token keyword">new</span> <span class="token constructor-invocation class-name">InvalidOperationException</span><span class="token punctuation">(</span><span class="token interpolation-string"><span class="token string">$"Invalid transition: </span><span class="token interpolation"><span class="token punctuation">&#123;</span><span class="token expression language-csharp">current</span><span class="token punctuation">&#125;</span></span><span class="token string"> → </span><span class="token interpolation"><span class="token punctuation">&#123;</span><span class="token expression language-csharp">next</span><span class="token punctuation">&#125;</span></span><span class="token string">"</span></span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(g),f(u,e)}const Ct=Object.freeze(Object.defineProperty({__proto__:null,default:St,metadata:Dn},Symbol.toStringTag,{value:"Module"})),Pn={title:"生成 PDF",date:"2025-06-22",category:"software",subCategory:"How-To",tags:["pdf","javascript","frontend"],slug:"pdf-download"},{title:fu,date:hu,category:bu,subCategory:vu,tags:_u,slug:Su}=Pn;var Rt=w('<h6>Web前端常見的需求，套件容易有意外的 Bug ，需要精確的話建議用程式碼描述的方式產出。 <a href="https://github.com/cao0085/code-pattern/tree/main/fronted-pdf-download" rel="nofollow">程式碼</a></h6> <hr/> <h3>DOM Capture（html2canvas、dom-to-image）</h3> <p>適合「版面已用 HTML/CSS 排好，直接輸出成圖」的情境，例如報表預覽、收據列印。</p> <p>原理是用 <code>document.querySelector()</code> 抓取指定 DOM，在套件內部模擬瀏覽器排版引擎，繪製到 <code>&lt;canvas&gt;</code> 後轉成 base64 / Blob 輸出。優點是不需要重新描述排版邏輯，缺點是：</p> <ul><li>複雜版面容易跑版（套件模擬不保證 100% 一致）</li> <li>外部資源（跨域圖片、自訂字體）受瀏覽器 Canvas 安全限制</li> <li>錯誤發生在套件內部，除錯困難</li></ul> <h3>Programmatic（jsPDF、pdf-lib）</h3> <p>適合「用程式動態組合內容」的情境，例如依資料生成報告、加浮水印、合併多頁。</p> <p>用程式碼直接描述文字、格線、圖片位置，不依賴 DOM，可控性高，但需要自己處理排版邏輯。外部資源（圖片、字體）建議預先轉為 base64 再傳入，避免套件內轉換失敗。</p> <hr/> <h3>jsPDF 實作</h3> <h4>字體載入</h4> <p>有兩種方式，建議用 Lazy Import，避免字型檔（通常數 MB）影響初始載入：</p> <p><strong>方式一：直接讀取 .ttf</strong></p> <pre class="language-js"><!></pre> <p><strong>方式二：.ttf 轉 .js，Lazy Import（推薦）</strong></p> <pre class="language-js"><!></pre> <hr/> <h4>圖片轉 Base64</h4> <p>外部圖片需先轉成 Base64 Data URL，再透過 Canvas 交給 jsPDF：</p> <pre class="language-js"><!></pre> <hr/> <h4>輸出</h4> <pre class="language-js"><!></pre>',1);function Tt(u){var e=Rt(),p=a(b(e),28),k=n(p);t(k,()=>`<code class="language-js">pdfDoc<span class="token punctuation">.</span><span class="token function">addFont</span><span class="token punctuation">(</span><span class="token string">'./eduSong_Unicode.ttf'</span><span class="token punctuation">,</span> <span class="token string">'eduSong_Unicode'</span><span class="token punctuation">,</span> <span class="token string">'normal'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
pdfDoc<span class="token punctuation">.</span><span class="token function">setFont</span><span class="token punctuation">(</span><span class="token string">'eduSong_Unicode'</span><span class="token punctuation">,</span> <span class="token string">'normal'</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-js"><span class="token keyword">async</span> <span class="token function">ensurePdfLib</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
<span class="token keyword">const</span> pdfUrl <span class="token operator">=</span> <span class="token constant">URL</span><span class="token punctuation">.</span><span class="token function">createObjectURL</span><span class="token punctuation">(</span>blob<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l),f(u,e)}const Et=Object.freeze(Object.defineProperty({__proto__:null,default:Tt,metadata:Pn},Symbol.toStringTag,{value:"Module"})),xn={title:"PDF 檔案合併",date:"2025-09-16",category:"software",subCategory:"How-To",tags:["pdf","csharp","python"],slug:"pdf-merge"},{title:Cu,date:Ru,category:Tu,subCategory:Eu,tags:Au,slug:Iu}=xn;var At=w('<h6><a href="https://github.com/cao0085/pdfMerger" rel="nofollow">Repository</a></h6> <hr/> <p>合併 PDF 有 C# 和 Python 兩個選項，Python 的執行環境相容性較好（跨平台），C# 則適合整合進既有的 .NET 應用或搭配 Windows UI。</p> <hr/> <h3>C#（iText7）</h3> <pre class="language-xml"><!></pre> <pre class="language-csharp"><!></pre> <hr/> <h3>Python（pypdf）</h3> <pre class="language-bash"><!></pre> <pre class="language-python"><!></pre> <hr/> <h3>加密 PDF 處理</h3> <p>合併時若遇到有密碼保護的 PDF，兩種方式各有不同的處理方法。</p> <p><strong>C# — <code>SetUnethicalReading</code></strong></p> <p>iText7 提供 <code>SetUnethicalReading(true)</code>，可在不提供密碼的情況下強制讀取部分加密 PDF（僅限讀取權限設定，非使用者密碼加密）：</p> <pre class="language-csharp"><!></pre> <p><strong>Python — <code>decrypt</code></strong></p> <p>若 PDF 有使用者密碼，需先解密再操作：</p> <pre class="language-python"><!></pre> <p>若密碼未知，兩種方式都無法處理，只能跳過或標記為人工處理。</p>',1);function It(u){var e=At(),p=a(b(e),10),k=n(p);t(k,()=>`<code class="language-xml"><span class="token comment">&lt;!-- .csproj --></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>PackageReference</span> <span class="token attr-name">Include</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>itext7.bouncy-castle-adapter<span class="token punctuation">"</span></span> <span class="token attr-name">Version</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>8.0.5<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span></code>`),s(p);var o=a(p,2),r=n(o);t(r,()=>`<code class="language-csharp"><span class="token class-name"><span class="token keyword">var</span></span> pdfFiles <span class="token operator">=</span> Directory<span class="token punctuation">.</span><span class="token function">GetFiles</span><span class="token punctuation">(</span>folderPath<span class="token punctuation">,</span> <span class="token string">"*.pdf"</span><span class="token punctuation">,</span> SearchOption<span class="token punctuation">.</span>TopDirectoryOnly<span class="token punctuation">)</span>
...
<span class="token keyword">def</span> <span class="token function">merge_pdfs</span><span class="token punctuation">(</span>input_folder<span class="token operator">=</span><span class="token string">"input"</span><span class="token punctuation">,</span> output_folder<span class="token operator">=</span><span class="token string">"output"</span><span class="token punctuation">,</span> output_filename<span class="token operator">=</span><span class="token string">"merged.pdf"</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
    ...
    <span class="token keyword">finally</span><span class="token punctuation">:</span>
        merger<span class="token punctuation">.</span>close<span class="token punctuation">(</span><span class="token punctuation">)</span></code>`),s(l);var i=a(l,12),y=n(i);t(y,()=>`<code class="language-csharp"><span class="token class-name"><span class="token keyword">var</span></span> reader <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token constructor-invocation class-name">PdfReader</span><span class="token punctuation">(</span>sourcePath<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token keyword">using</span> <span class="token class-name"><span class="token keyword">var</span></span> sourceDoc <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token constructor-invocation class-name">PdfDocument</span><span class="token punctuation">(</span>reader<span class="token punctuation">)</span><span class="token punctuation">;</span>
merger<span class="token punctuation">.</span><span class="token function">Merge</span><span class="token punctuation">(</span>sourceDoc<span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> sourceDoc<span class="token punctuation">.</span><span class="token function">GetNumberOfPages</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(i);var g=a(i,6),v=n(g);t(v,()=>`<code class="language-python"><span class="token keyword">from</span> pypdf <span class="token keyword">import</span> PdfReader
...
<span class="token keyword">if</span> reader<span class="token punctuation">.</span>is_encrypted<span class="token punctuation">:</span>
    reader<span class="token punctuation">.</span>decrypt<span class="token punctuation">(</span><span class="token string">"password"</span><span class="token punctuation">)</span>  <span class="token comment"># 已知密碼才能處理</span></code>`),s(g),T(2),f(u,e)}const Dt=Object.freeze(Object.defineProperty({__proto__:null,default:It,metadata:xn},Symbol.toStringTag,{value:"Module"})),On={title:"處理對帳檔案",date:"2025-09-30",category:"software",subCategory:"How-To",tags:["payment","reconcile","csharp"],slug:"payment-reconciliation"},{title:Du,date:Pu,category:xu,subCategory:Ou,tags:Mu,slug:Nu}=On;var Pt=w('<h6>金流商通常在 N 個工作日後，提供一份撥款檔案作為實際金流的核實依據</h6> <hr/> <p>這個流程通常是每日定時自動執行，但實務上會遇到：網路中斷、金流商未按時提供、資料格式錯誤等異常，因此流程中需要設計 <strong>Checkpoint</strong>（重試斷點），讓人工介入後能從中斷點繼續節省資源。常見流程：</p> <pre class="language-undefined"><!></pre> <hr/> <h3>1. 取得遠端檔案</h3> <p>透過 SFTP 下載指定日期範圍的 CSV 檔案，寫入本地路徑後回傳檔案清單。若發生異常，可從 Error Log 取得原始參數直接重試此步驟。</p> <pre class="language-csharp"><!></pre> <hr/> <h3>2. 讀入記憶體</h3> <p>確認檔案存在後讀取，跳過第 N 行（通常是金流商的標頭說明）。重試斷點：確認本地檔案路徑存在即可重試。</p> <pre class="language-csharp"><!></pre> <hr/> <h3>3. 解析 & 儲存</h3> <p>解析每一列資料、與內部 DB 比對，包在 try/catch 中。解析失敗的原始資料保留至 <code>failedRows</code>，等待人工檢閱。重試斷點：將 failedRows 回丟此方法重新處理。</p> <pre class="language-csharp"><!></pre> <hr/> <h3>4. 產出靜態檔案</h3> <p>若需要將對帳結果輸出為 CSV 給外部使用，以 DB 為 SSOT，在 Table 欄位記錄匯出狀態：</p> <pre class="language-csharp"><!></pre> <p>產檔時<strong>先寫檔、再更新 DB</strong>，確保兩者一致：</p> <pre class="language-csharp"><!></pre>',1);function xt(u){var e=Pt(),p=a(b(e),6),k=n(p);t(k,()=>'<code class="language-undefined">1. 取得遠端檔案 → 2. 讀入記憶體 → 3. 解析 &amp; 儲存 → 4. 產出靜態檔案備份</code>'),s(p);var o=a(p,8),r=n(o);t(r,()=>`<code class="language-csharp"><span class="token keyword">public</span> <span class="token keyword">async</span> <span class="token return-type class-name">Task<span class="token punctuation">&lt;</span>List<span class="token punctuation">&lt;</span><span class="token keyword">string</span><span class="token punctuation">></span><span class="token punctuation">></span></span> <span class="token function">DownloadRemoteFileAsync</span><span class="token punctuation">(</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(l);var i=a(l,8),y=n(i);t(y,()=>`<code class="language-csharp"><span class="token comment">// 欄位設計</span>
...
FileName <span class="token operator">=</span> <span class="token keyword">null</span></code>`),s(i);var g=a(i,4),v=n(g);t(v,()=>`<code class="language-csharp"><span class="token keyword">public</span> <span class="token keyword">async</span> <span class="token return-type class-name">Task</span> <span class="token function">GenerateStaticFile</span><span class="token punctuation">(</span><span class="token class-name"><span class="token keyword">string</span></span> storeId<span class="token punctuation">)</span>
<span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(g),f(u,e)}const Ot=Object.freeze(Object.defineProperty({__proto__:null,default:xt,metadata:On},Symbol.toStringTag,{value:"Module"})),Mn={title:"測試 SFTP / FTPS",date:"2025-10-01",category:"software",subCategory:"How-To",tags:["sftp","ftps","docker","csharp"],slug:"sftp-ftps-local-test"},{title:Lu,date:$u,category:qu,subCategory:Bu,tags:Hu,slug:Uu}=Mn;var Mt=w('<h6>公司測試區進出驗證資料沒有很方便，用 Docker 在本地起 SFTP / FTPS Server 比較好開發。</h6> <hr/> <h3>SFTP</h3> <p>SSH 加密通道傳輸，Port 22，較普遍</p> <p><strong>docker-compose.yml</strong></p> <pre class="language-yml"><!></pre> <p><strong>C#（SSH.NET）</strong></p> <pre class="language-csharp"><!></pre> <hr/> <h3>FTPS</h3> <p>FTP + TLS/SSL，Port 21，部分舊系統採用，需注意 Passive Mode Port 範圍</p> <p><strong>docker-compose.yml</strong></p> <pre class="language-yml"><!></pre> <p><strong>C#（FluentFTP）</strong></p> <pre class="language-csharp"><!></pre> <hr/> <h3>多個 Server</h3> <p>需要同時模擬多個金流商連線時，可在同一個 compose 檔定義多個 service：</p> <pre class="language-yml"><!></pre>',1);function Nt(u){var e=Mt(),p=a(b(e),10),k=n(p);t(k,()=>`<code class="language-yml"><span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">sftp</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">restart</span><span class="token punctuation">:</span> unless<span class="token punctuation">-</span>stopped</code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-csharp"><span class="token keyword">using</span> <span class="token namespace">Renci<span class="token punctuation">.</span>SshNet</span><span class="token punctuation">;</span>
...
client<span class="token punctuation">.</span><span class="token function">Connect</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var i=a(l,8),y=n(i);t(y,()=>`<code class="language-yml"><span class="token key atrule">services</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">cashvendor-ftps</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">environment</span><span class="token punctuation">:</span>
      ...
      <span class="token punctuation">-</span> CHROOT_LOCAL_USER=YES
      <span class="token punctuation">-</span> REVERSE_LOOKUP_ENABLE=NO
    <span class="token key atrule">restart</span><span class="token punctuation">:</span> unless<span class="token punctuation">-</span>stopped</code>`),s(i),f(u,e)}const Lt=Object.freeze(Object.defineProperty({__proto__:null,default:Nt,metadata:Mn},Symbol.toStringTag,{value:"Module"})),Nn={title:"Structurizr C4 Model",date:"2025-06-22",category:"software",subCategory:"How-To",tags:["c4model","architecture","docker"],slug:"structurizr-c4"},{title:Fu,date:ju,category:Vu,subCategory:Gu,tags:Wu,slug:zu}=Nn;var $t=w('<h6><a href="https://github.com/cao0085/code-pattern/tree/main/structurizr" rel="nofollow">Example</a>，<a href="https://structurizr.com/" rel="nofollow">Structurizr</a></h6> <hr/> <h6>2025/10/15 更新：改用 Figma 桌面版來畫架構圖操作更直覺！</h6> <hr/> <p>C4 Model 是一種分層描述系統架構的方式，從高到低依序為：<code>System → Container → Component</code> 每一層都可以單獨渲染成一張架構圖，適合用來溝通不同粒度的設計。</p> <h3>啟動</h3> <pre class="language-yml"><!></pre> <p>首次啟動會在掛載目錄生成基本專案檔，再依需求修改。</p> <hr/> <h3>workspace.dsl</h3> <p>主設定檔，引入 model 和 view 的定義：</p> <pre class="language-text"><!></pre> <hr/> <h3>index-model.dsl</h3> <p>依層級定義系統結構，每層都可以渲染出一張圖：</p> <pre class="language-text"><!></pre> <hr/> <h3>index-view.dsl</h3> <p>指定要渲染哪些 model，注意層級需降一階：model 裡是 <code>softwareSystem</code>，view 裡要用 <code>container</code> 來指定它：</p> <pre class="language-text"><!></pre>',1);function qt(u){var e=$t(),p=a(b(e),12),k=n(p);t(k,()=>`<code class="language-yml"><span class="token comment"># docker-compose.yml</span>
<span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">structurizr</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">volumes</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> .<span class="token punctuation">:</span>/usr/local/structurizr</code>`),s(p);var o=a(p,10),r=n(o);t(r,()=>`<code class="language-text">workspace &quot;YourProjectName&quot; &#123;
...
component YourSystem.InitPage_1 &quot;InitData&quot; &#123;
    include *
&#125;</code>`),s(l),f(u,e)}const Bt=Object.freeze(Object.defineProperty({__proto__:null,default:qt,metadata:Nn},Symbol.toStringTag,{value:"Module"})),Ln={title:"軟體開發 2025",date:"2025-12-31",category:"software",subCategory:"How-To",tags:["summary","backend","architecture"],slug:"2025-dev-summary"},{title:Yu,date:Xu,category:Ku,subCategory:Ju,tags:Qu,slug:Zu}=Ln;var Ht=w('<h6>今年寫業務邏輯為重，關鍵字抓對技術上不會有問題，有更多時間能思考如何寫出好維護的程式碼，這邊小結一下今年所學的幾個觀念。</h6> <hr/> <h3>虛實物件分離</h3> <p>以發票為例，狀態應僅有四種：未開立、已開立、已折讓、已作廢；這些能被<strong>觀察</strong>的狀態。那從「發票作廢」開始延伸，</p> <p>以前需拿著 <strong><em>實體發票</em></strong> 在時限內繳回政府，實體流轉本身就是進度的追蹤依據：</p> <ol><li>發票在買方手上 → 交易尚未取消</li> <li>發票已繳回賣方 → 雙方同意，賣方可申報</li> <li>發票隨申報表送出 → 向稅務機關申報作廢</li> <li>稅務機關已收存 → 作廢完成</li></ol> <p>但在電子化時代達成「已作廢」的過程變得複雜：</p> <ol><li>內部階段：客服受理 > 客戶簽名 > 會計審核</li> <li>外部階段：平台傳輸 > 財政部驗證 > 等候結果</li> <li>終點：財政部核可 → 觸發事件，將狀態改為「已作廢」。</li></ol> <p>上述流程會衍生出 <strong>不能被觀察</strong> 的狀態，例如待處理、待上傳等等 …</p> <p>若能清楚分離「實體狀態」與「流程狀態」就可以設計為：</p> <ul><li><strong>主表</strong>：記錄發票的實體狀態（未開立 / 已開立 / 已折讓 / 已作廢）← 對應稅務規定</li> <li><strong>子表</strong>：記錄作廢流程狀態（State 1~9）← 對應內部流程 <ul><li>State 1~4：內部審核（受理、簽名、核對…）</li> <li>State 5~8：與財政部往來（上傳、驗證、查詢…）</li> <li>State 9：財政部核准 → 觸發同步，更新主表為「已作廢」</li></ul></li></ul> <p>主表保持簡潔子表完整追蹤進度。這是閱讀 Domain-Driven Design 後的小啟發，就算沒有用到架構也是以融入現有的業務邏輯。</p> <hr/> <h3>彈性與異常處理</h3> <p>當新項目開發到一半，發現必須改舊有程式碼才能避免 0.02% 的重複紀錄，兩個選項：</p> <ol><li>花一個月，改舊程式讓資料完全正確</li> <li>花五個工作天，額外寫定時流程去補償</li></ol> <p>市場上品質好、價格低、供貨穩定三者不可兼得，在軟體工程領域也是如此；要如何處理現在決於業務性質：</p> <ul><li><strong>金流系統</strong>（牽涉商譽、三方資料）→ 選方案一，確保一致性</li> <li><strong>記帳對帳</strong>（允許延遲）→ 選方案二，開發快、可維護性高</li></ul> <p>只要能明確定義「異常」和後續處理方式，它就成為可控的預期行為，而非系統錯誤。根據風險等級設計容錯策略，不需要每處都追求零錯誤。</p> <hr/> <h3>效能提升</h3> <p>初學時容易被效能問題卡住，糾結 <code>Array vs Set</code>、React 要不要包 <code>memo()</code>、<code>state & debounce</code> 等等。但其實寫高階語言或框架時，這些優化是讓程式從 80 分到 88 分的微幅提升，相較之下維護性與可讀性更重要。例如：</p> <ul><li>用 <code>Array</code> 而非 <code>List</code> 是為了防止不小心添加元素</li> <li>整理成 <code>Map</code> 而非 <code>list.find()</code> 是為了清楚表達意圖、防呆</li></ul> <p>真正要有感的效能提升，會是來自架構層面的思考：</p> <ul><li>查詢邏輯要在後端還是資料庫？有加 Index 嗎？</li> <li>資料可以讓客戶端暫存嗎？封包大小符合建議值嗎？</li> <li>花兩個月優化程式碼，還是評估橫向擴展或升級硬體更划算？</li></ul> <p>能從源頭修改，效能提升最多。工程師的職責是選擇並善用現有的成熟工具，而非花時間最大化每個細節。（延伸閱讀：<a href="https://youtu.be/HnwJZjEhrf8" rel="nofollow">細節不決定成敗</a>）</p>',1);function Ut(u){var e=Ht();T(50),f(u,e)}const Ft=Object.freeze(Object.defineProperty({__proto__:null,default:Ut,metadata:Ln},Symbol.toStringTag,{value:"Module"})),$n={title:"處理 Excel 檔案",date:"2025-06-22",category:"software",subCategory:"How-To",tags:["xlsx","javascript","excel"],slug:"excel-xlsx"},{title:nk,date:sk,category:ak,subCategory:tk,tags:pk,slug:ok}=$n;var jt=w('<h6>記錄一下套件怎麼用 <a href="https://www.npmjs.com/package/xlsx/v/0.14.1?activeTab=readme" rel="nofollow">xlsx 0.14.1</a></h6> <hr/> <h3>Workbook & Worksheet</h3> <p><code>Workbook</code> 代表一份完整的 .xlsx 檔案，<code>Worksheet</code> 代表其中一個分頁，兩者都可以有多個。</p> <pre class="language-js"><!></pre> <hr/> <h3>Sheet Content</h3> <p>兩種常用的資料填入方式：</p> <pre class="language-js"><!></pre> <hr/> <h3>儲存格合併</h3> <pre class="language-js"><!></pre> <hr/> <h3>一對多資料的多列合併</h3> <p>最常見的情境：一筆訂單對應多筆商品，輸出時訂單欄位要合併顯示。</p> <p><strong>Step 1：攤平資料，標記第一列與合併數量</strong></p> <pre class="language-js"><!></pre> <p><strong>Step 2：計算合併範圍</strong></p> <pre class="language-js"><!></pre> <p><strong>Step 3：完整輸出</strong></p> <pre class="language-js"><!></pre>',1);function Vt(u){var e=jt(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token constant">XLSX</span> <span class="token keyword">from</span> <span class="token string">'xlsx'</span><span class="token punctuation">;</span>
...
<span class="token constant">XLSX</span><span class="token punctuation">.</span><span class="token function">writeFile</span><span class="token punctuation">(</span>wb2<span class="token punctuation">,</span> <span class="token string">'output2.xlsx'</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(p);var o=a(p,8),r=n(o);t(r,()=>`<code class="language-js"><span class="token comment">// AOA（Array of Arrays）：二維陣列，[row1, row2...]，每個 row 對應一列</span>
...
flatList<span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">row<span class="token punctuation">,</span> rowIndex</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
    ...
    mergeKeys<span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token parameter">key</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(i);var g=a(i,4),v=n(g);t(v,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> <span class="token constant">XLSX</span> <span class="token keyword">from</span> <span class="token string">'xlsx'</span><span class="token punctuation">;</span>
...
<span class="token function">saveAs</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token class-name">Blob</span><span class="token punctuation">(</span><span class="token punctuation">[</span>buf<span class="token punctuation">]</span><span class="token punctuation">,</span> <span class="token punctuation">&#123;</span> <span class="token literal-property property">type</span><span class="token operator">:</span> <span class="token string">'application/octet-stream'</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">,</span> <span class="token template-string"><span class="token template-punctuation string">&#96;</span><span class="token string">report_</span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">$&#123;</span>Date<span class="token punctuation">.</span><span class="token function">now</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token interpolation-punctuation punctuation">&#125;</span></span><span class="token string">.xlsx</span><span class="token template-punctuation string">&#96;</span></span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(g),f(u,e)}const Gt=Object.freeze(Object.defineProperty({__proto__:null,default:Vt,metadata:$n},Symbol.toStringTag,{value:"Module"})),qn={title:"CORS & SOP",date:"2025-10-27",category:"software",subCategory:"Internet",tags:["http","SOP","CORS"],slug:"cors"},{title:ek,date:ck,category:lk,subCategory:uk,tags:kk,slug:ik}=qn;var Wt=w('<h2>常常看到 CORS 今天才知道有 SOP</h2> <p>瀏覽器原生就有一個預設的安全機制叫做 <code>Same-Origin Policy (SOP)</code>，它只允許網頁接收來自相同來源（Same Origin）的資料。</p> <p>這個限制在實務上會造成一些不便：如果前後端分別部署在不同的 Server 上，前端就無法直接向後端發送請求取得資料。傳統的解決方式是讓後端先接收外部資料，再轉發給前端。</p> <p>為了突破這個限制，讓跨來源的資料交換更方便，<code>CORS（Cross-Origin Resource Sharing）</code> 機制因此誕生。</p> <h3>Same-Origin Policy</h3> <p>主要用來防範 <strong>跨站請求偽造（CSRF）</strong> 等攻擊。由於瀏覽器發送請求時會自動帶上當前網站的 Origin，且 JavaScript 無法隨意偽造這個值，因此 SOP 可以有效防止惡意網站冒用使用者身份。</p> <p>假設你登入了銀行網站 A，此時瀏覽器會儲存 A 網站的 Cookie（包含登入憑證）。如果沒有 SOP 保護，當你訪問惡意網站 B 時，B 網站的 JavaScript 就能向 A 銀行發送請求，並自動帶上你的登入 Cookie，進而盜取資料或進行轉帳。有了 SOP，瀏覽器會阻擋 B 網站讀取來自 A 網站的回應資料。</p> <pre class="language-md"><!></pre> <h3>Cross-Origin Resource Sharing</h3> <p>當進入 CORS 流程時，瀏覽器會先檢查該請求是簡單請求還是預檢請求。</p> <p>為什麼要分兩種請求？主要是為了保護舊的後端伺服器。簡單請求通常只是讀取資料，比較安全，可以直接送出。但如果是可能修改資料的請求（如 PUT、DELETE）或帶有自訂 Header，就需要先用預檢確認後端有支援 CORS，避免對不支援的舊伺服器造成意外影響。</p> <p><strong>簡單請求 (Simple Request)</strong></p> <p>符合以下條件的請求會被視為簡單請求：</p> <ul><li>HTTP Method 為 <code>GET</code>、<code>HEAD</code> 或 <code>POST</code></li> <li>Content-Type 只能是 <code>application/x-www-form-urlencoded</code>、<code>multipart/form-data</code> 或 <code>text/plain</code></li> <li>沒有自訂的 Header</li></ul> <p>簡單請求會直接送出，伺服器透過回應 Header 告知瀏覽器是否允許該跨來源請求。</p> <p><strong>預檢請求 (Preflight Request)</strong></p> <p>不符合簡單請求條件的請求，瀏覽器會先發送一個 <code>OPTIONS</code> 方法的預檢請求，詢問伺服器是否允許實際請求。只有當預檢通過後，才會發送真正的請求。</p> <pre class="language-md"><!></pre> <p><strong>常見的 CORS Headers</strong></p> <p>伺服器端需要設定的主要 Headers：</p> <ul><li><code>Access-Control-Allow-Origin</code>: 指定允許的來源，可設為特定網域或 <code>*</code>（所有來源）</li> <li><code>Access-Control-Allow-Methods</code>: 允許的 HTTP 方法，如 <code>GET, POST, PUT, DELETE</code></li> <li><code>Access-Control-Allow-Headers</code>: 允許的自訂 Headers</li> <li><code>Access-Control-Allow-Credentials</code>: 是否允許攜帶憑證（如 Cookie）</li> <li><code>Access-Control-Max-Age</code>: 預檢請求的快取時間（秒）</li></ul> <p><strong>範例設定</strong></p> <pre class="language-javascript"><!></pre> <p>分兩種請求主要是保護舊的後端伺服器。簡單請求通常只是讀取資料，可以直接送出。但如果是可能修改資料的請求（如 PUT、DELETE）或帶有自訂 Header，就需要先用預檢確認後端有支援 CORS，避免對不支援的舊伺服器造成意外影響。</p> <p><strong>實際測試 CORS</strong></p> <p>架好後端後，用瀏覽器打開任意網站（例如 <code>https://policy.medium.com/medium-terms-of-service-9db0094a1e0f</code>），開啟開發者工具的主控台執行：</p> <pre class="language-js"><!></pre> <p>此時前端會看到 CORS 錯誤，但如果觀察後端 Log，會發現請求有成功並回應，只是瀏覽器阻擋了回應。</p> <p>回到瀏覽器切換到「網路」面板，找到這個請求，查看「要求標頭」中的 <code>Origin</code> 欄位（例如 <code>https://policy.medium.com</code>）這就是瀏覽器自動帶上的來源網域。回到後端程式碼，加上允許的來源並重啟：</p> <pre class="language-golang"><!></pre> <p>重新執行 fetch，就可以成功取得資料了。</p> <p><strong>完整程式碼</strong></p> <pre class="language-golang"><!></pre>',1);function zt(u){var e=Wt(),p=a(b(e),14),k=n(p);t(k,()=>`<code class="language-md">    B 網站的 JS 發起請求到 A Server
    ...
    (Yes)      (No)
    直接發送    進入 CORS 流程
    正常讀取</code>`),s(p);var o=a(p,20),r=n(o);t(r,()=>`<code class="language-md">    瀏覽器發送 OPTIONS 請求
            ↓
    ...
    (Yes)         (No)
    發送實際請求    阻擋請求
    取得回應      顯示 CORS 錯誤</code>`),s(o);var c=a(o,10),d=n(c);t(d,()=>`<code class="language-javascript"><span class="token comment">// Node.js Express 範例</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(c);var l=a(c,8),m=n(l);t(m,()=>`<code class="language-js"><span class="token function">fetch</span><span class="token punctuation">(</span><span class="token string">'http://127.0.0.1:8080/api'</span><span class="token punctuation">,</span> <span class="token punctuation">&#123;</span><span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">.</span><span class="token function">then</span><span class="token punctuation">(</span><span class="token parameter">d</span> <span class="token operator">=></span> console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>d<span class="token punctuation">)</span><span class="token punctuation">)</span></code>`),s(l);var i=a(l,6),y=n(i);t(y,()=>`<code class="language-golang">w.Header().Set(&quot;Access-Control-Allow-Origin&quot;, &quot;https://policy.medium.com&quot;) // 允許特定網域
w.Header().Set(&quot;Access-Control-Allow-Origin&quot;, &quot;*&quot;) // 允許所有來源</code>`),s(i);var g=a(i,6),v=n(g);t(v,()=>`<code class="language-golang">// golang
package main 
...
&#125;</code>`),s(g),f(u,e)}const Yt=Object.freeze(Object.defineProperty({__proto__:null,default:zt,metadata:qn},Symbol.toStringTag,{value:"Module"})),Bn={title:"HTTP & FileStream",date:"2025-10-27",category:null,subCategory:null,tags:["http","filestream"],slug:"filestream"},{title:rk,date:dk,category:gk,subCategory:mk,tags:yk,slug:wk}=Bn;var Xt=w('<p>實作串流相關 API</p> <hr/> <h3>FileStream 特性</h3> <ul><li>指針機制：串流有一個內部指針，讀取時會向前移動，讀完後就到了末尾</li> <li>記憶體效率：串流設計用來處理大文件，不會把整個文件載入記憶體</li> <li>即時處理：數據是可以邊讀邊處理的，適合有獨立資料結構導向的檔案類型</li></ul> <p><strong>適合的類型</strong> : <code>.txt</code>, <code>.csv</code>,<code>.jsonl</code>,<code>.mp3</code>, <code>.mp4</code></p> <p><strong>不適合的類型</strong> : <code>.json</code>, <code>.zip</code>, <code>.rar</code></p> <pre class="language-csharp"><!></pre> <p>這邊可邊接收邊處理，是因為 <strong>HTTP 不同 Request 參數類型，會有不同的執行時機</strong>，例如:</p> <ul><li><p>String / Object：Body 完整接收後才執行，資料立即可用（適合小型資料、JSON）</p></li> <li><p>IFormFile：Headers 接收後就執行，檔案資訊立即可用但內容需等待串流（適合大型檔案）</p></li></ul>',1);function Kt(u){var e=Xt(),p=a(b(e),12),k=n(p);t(k,()=>`<code class="language-csharp"><span class="token comment">// 串流處理：記憶體效率高</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),T(4),f(u,e)}const Jt=Object.freeze(Object.defineProperty({__proto__:null,default:Kt,metadata:Bn},Symbol.toStringTag,{value:"Module"})),Hn={title:"Http Connect",date:"2025-09-03",category:"software",subCategory:"Internet",tags:["Http","tcp","backend"],slug:"http_connect"},{title:fk,date:hk,category:bk,subCategory:vk,tags:_k,slug:Sk}=Hn;var Qt=w('<h3>TCP 連線的運作機制</h3> <ol><li><p>伺服器主機主動開啟 Port <code>net.Listen("tcp", ":4000")</code></p></li> <li><p>同時 <code>conn, err := listener.Accept()</code> 等待連接</p></li> <li><p>客戶端發送請求 <code>server_ip:4000</code> OS 背後做 TCP 三次握手驗證</p></li> <li><p>資料會傳送到 <code>OS緩衝區</code>，程式則會定期去緩衝區讀取資料處理</p></li></ol> <h3>Server 的核心特性</h3> <ul><li>持續運行（Long-running Process）</li> <li>對外提供通訊介面</li></ul> <pre class="language-go"><!></pre> <p>HTTP 本身是個字串，會需要嚴格的解析流程，可以導入狀態機的概念去處理如:</p> <ul><li>解析請求行 → 提取方法、路徑、版本</li> <li>解析標頭   → 逐行讀取 key: value</li> <li>解析請求體 → 根據 Content-Length 讀取</li></ul> <pre class="language-go"><!></pre>',1);function Zt(u){var e=Qt(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-go"><span class="token keyword">package</span> main
...
<span class="token punctuation">&#125;</span></code>`),s(p);var o=a(p,6),r=n(o);t(r,()=>`<code class="language-go"><span class="token keyword">type</span> HTTPRequest <span class="token keyword">struct</span> <span class="token punctuation">&#123;</span>
...
<span class="token comment">// https request -> Service Server</span></code>`),s(p);var o=a(p,2),r=n(o);t(r,()=>`<code class="language-csharp"><span class="token comment">// Service Server</span>
...
<span class="token punctuation">&#125;</span></code>`),s(c),f(u,e)}const tp=Object.freeze(Object.defineProperty({__proto__:null,default:ap,metadata:Un},Symbol.toStringTag,{value:"Module"})),Fn={title:"Nginx",date:"2025-11-27",category:"software",subCategory:"Internet",tags:["http","nginx"],slug:"nginx"},{title:Dk,date:Pk,category:xk,subCategory:Ok,tags:Mk,slug:Nk}=Fn;var pp=w('<h6>公司內部開發的時候用看看Nginx，就不用搬筆電跑來跑去</h6> <hr/> <p>可以這樣配置測試環境</p> <ol><li>本地先 run 一個要被訪問的 Server</li> <li>配置 nginx.conf，因為 nginx Server 是部屬在 docker，所以要使用 host.docker.internal</li> <li>docker run 一個 nginx container</li> <li>先測看看 localhost 不帶後贅是否可以連到預設的 nginx page</li> <li>再看不同裝置區網內連線可不可以(—ipConfig IPv4 位址)，能否連接到上述預設 page</li> <li>再測試反向代理是否轉發正確</li></ol> <pre class="language-dockerfile"><!></pre> <pre class="language-bash"><!></pre> <p>nginx.conf (假設 Server 部署在 local4041 )</p> <pre class="language-conf"><!></pre> <p>上面大概就是基礎的轉發功能，剩下的就是看專案當初的環境配置了，nginx 本身也可以 subdomain 配置，可以用來解決 cors 的問題。</p> <p>其餘可進階的配置</p> <ul><li>SPA (單頁應用) 路由設定</li> <li>靜態資源快取 (Browser Caching)</li> <li>Gzip 壓縮</li> <li>限制存取 (Access Control)</li> <li>SSL/TLS (https)</li></ul>',1);function op(u){var e=pp(),p=a(b(e),8),k=n(p);t(k,()=>`<code class="language-dockerfile"><span class="token comment"># Use the specific Ubuntu 22.04 image</span>
...
<span class="token instruction"><span class="token keyword">CMD</span> [<span class="token string">"nginx"</span>, <span class="token string">"-g"</span>, <span class="token string">"daemon off;"</span>]</span></code>`),s(p);var o=a(p,2),r=n(o);t(r,()=>`<code class="language-bash"><span class="token function">docker</span> stop my-proxy
...
<span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">-p</span> <span class="token number">80</span>:80 <span class="token parameter variable">--name</span> my-proxy my-nginx-proxy</code>`),s(o);var c=a(o,4),d=n(c);t(d,()=>`<code class="language-conf">events &#123;
...
└── article/                    # 子路由目錄
    ...
    └── [slug]/                 # 動態路由段落
        ...
        └── +page.ts            # 預渲染配置</code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-markdown"><span class="token front-matter-block"><span class="token punctuation">---</span>
...
│       └── HomePage.module.css
└── constants/                   # 常數配置
    └── env.ts                  # 環境變數</code>`),s(p);var o=a(p,10),r=n(o);t(r,()=>`<code class="language-typescript"><span class="token comment">// store 配置範例</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">,</span> <span class="token punctuation">[</span>theme<span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(i);var g=a(i,8),v=n(g);t(v,()=>`<code class="language-markdown">public/language/
├── en/
│   └── translation.json
└── zh/
    └── translation.json</code>`),s(g);var h=a(g,8),C=n(h);t(C,()=>`<code class="language-bash"><span class="token function">npm</span> run dev      <span class="token comment"># 啟動開發伺服器（HMR 支援）</span>
...
│ • 檔案樹 │ • 編輯器 │  • 即時預覽    │
│ • 切換   │ • 內容   │  • 內建伺服器  │
└──────────┴──────────┴───────────────┘</code>`),s(p);var o=a(p,4),r=n(o);t(r,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(o);var c=a(o,8),d=n(c);t(d,()=>`<code class="language-javascript"><span class="token keyword">const</span> <span class="token constant">WCV_DEFAULT_SETTING</span> <span class="token operator">=</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c),T(10),f(u,e)}const mp=Object.freeze(Object.defineProperty({__proto__:null,default:gp,metadata:Gn},Symbol.toStringTag,{value:"Module"})),Wn={title:"金錢多重宇宙（上）",date:"2026-02-15",category:"book",subCategory:"Finance",tags:["read","blog","Money"],slug:"nackedmoney1"},{title:ni,date:si,category:ai,subCategory:ti,tags:pi,slug:oi}=Wn;var yp=w(`<h6>理解一下金錢背後的意義</h6> <hr/> <h3>購買力</h3> <p>貨幣之所以能作為有價值商品的交換媒介，根源不在於它本身的材質，也不在於政府的強制力，而是社會對其價值的共同信念，這才是貨幣體系的真正基礎。</p> <ul><li><p>任何物品，只要有共識，都可以成為交易媒介：
...
真正推動世界的是生產力、勞動分工、資源配置與商品流通。當人們開始分工交換，就需要一種媒介來解決「需求雙重巧合」的困境，於是貨幣應運而生。它只是將「我為你做了什麼」抽象化，變成一個可儲存、可轉移的憑證。</p></li></ul> <h3>供需法則</h3> <p>貨幣固然是社會共識的載體，但它同時也是一種商品——它同樣遵循供需法則，只是我們用另一個詞來描述這種現象。</p> <h4>通膨與通縮</h4> <p>貨幣本身沒有內在價值，它的「價格」就是我們能用它換到多少東西。而這個價格，同樣由供給與需求決定：供給（央行印了多少錢）與需求（整個經濟體需要多少貨幣來完成交易）之間的平衡，決定了物價的漲跌。</p> <ul><li>通膨 = 貨幣貶值（相對於商品）</li> <li>通縮 = 貨幣升值（相對於商品）</li></ul> <h4>大麥克指數</h4> <p>之所以成為觀察貨幣現象的經典指標，是因為它巧妙兼顧了一籃子成本的綜合反映：</p> <ul><li><p>國內成本：店面成本、地價、水電、運輸、稅賦</p></li> <li><p>人力成本：當地工資水準</p></li> <li><p>國際原物料：牛肉、麵粉、包裝材料（受全球價格影響）</p></li></ul> <p>換句話說，它濃縮了某個經濟體內部各種要素成本的總和。當我們用同一種商品（麥當勞標準化生產的漢堡）來跨國比較時，就能看出不同國家的貨幣是真被低估還是高估——它把抽象的「購買力平價」理論。</p> <h4>固定通膨</h4> <p>從純經濟效率的角度看，物價穩定最好。但現實世界有一個現象：微幅的通貨膨脹，幾乎是所有現代經濟體的共同選擇，假設一個情境：</p> <ul><li>情況A：每年幫你加薪2%，可以買到300個大麥克</li> <li>情況B：每年幫你減薪2%，可以買到302個大麥克</li></ul> <p>有趣的是曾有學者做過實驗，選擇 A 的比例反而比較高。關鍵是人們對名義收入的下降，有極強烈的排斥心理。名義工資具有「向下僵固性」—— 一旦被調降，士氣打擊、勞資衝突、消費緊縮都會接踵而來。但如果只是物價溫和上漲，而名義工資也跟著上漲，人們並不會強烈感受到自己被剝削。微幅通膨就像是經濟體的潤滑油：</p> <ul><li><p>實質工資可以透過物價調整，而不必直接砍名義工資</p></li> <li><p>傾向現在花錢，因為未來的錢購買力會稍低</p></li> <li><p>債務的實質價值隨著通膨被稀釋</p></li></ul> <h3>銀行誕生</h3> <p>想像一個古代的村莊，有一座「稻米銀行」它可以提供什麼服務？</p> <ol><li><p>建倉解決儲備問題: 農民A有多餘的稻米，但放在家裡怕發霉、怕老鼠。農民把稻米存進去。穀倉開了收據給農民，憑收據可以隨時來領回稻米。</p></li> <li><p>發行兌換券：漸漸地，大家發現拿著那張收據更方便——不用扛著沈重的稻米去市場，直接用收據就能買賣。這張收據就成為這世界最早的「紙幣」</p></li> <li><p>發現閒置：穀倉老闆發現一件有趣的事，農民A的稻米存進來後，不會馬上全部領走。大部分時候，穀倉裡總是堆著很多沒人動的稻米就是「閒置資金」</p></li> <li><p>放貸賺利差：與其讓這些稻米躺著發霉，不如把它們借出去賺點利息。農民B想播種但缺稻種，願意用明年的收成加上利息來借，但得拿田地來抵押。</p></li></ol> <p>這個模式看起來很完美，但它也藏著一個致命風險，借出去的稻米和存戶隨時可能來領的稻米是同一批。</p> <ul><li><p>穀倉總共存了 1,000 袋稻米</p></li> <li><p>老闆把其中 800 袋借給了農民B（用土地抵押）</p></li> <li><p>穀倉裡實際只剩下 200 袋現貨</p></li></ul> <p>有天村裡突然謠傳：「穀倉老闆把稻米全借給農民B了，但農民B今年歉收，可能還不出來！」，農民A聽了嚇一跳，趕緊拿著收據去領米，但穀倉裡其實剩下 200 袋。</p> <h4>擠兌崩盤</h4> <ul><li><p>農民B真的還不出來：農民B那一年歉收，他無力償還 800 袋稻米的本息。銀行只好拍賣他的土地來還債。</p></li> <li><p>土地價格崩盤：銀行當初評估這塊地值 1,000 袋稻米。但現在，為了急著變現還給存戶，銀行低價拋售最後只賣到 500 袋。這筆錢遠遠不夠還給存戶。</p></li> <li><p>信任恐慌，資產再降價：存戶拿不到錢更多人恐慌，更多人擠兌。銀行為了籌現金，只好繼續低價拍賣其他抵押品——價格越賣越低，資產負債表的洞越破越大。最後，銀行破產。</p></li></ul> <p>銀行解決了資金融通的效率問題，但也帶來了擠兌、信用擴張與收縮的內生風險。現代金融體系的一切設計 —— 存款保險、資本適足率、最後貸款者角色都是在試圖馴服這個從「稻米穀倉」時代就存在的結構性脆弱。</p> <h3>中央銀行與聯準會</h3> <p>它們扮演著「銀行的銀行」這個特殊角色——它不直接面對一般民眾，而是透過調控商業銀行的行為，間接影響整個經濟的資金水位。</p> <h4>職責核心</h4> <ul><li><p>準備金制度：銀行收到存戶存款後，不能全數放貸，必須依法保留一定比例（例如 10%）作為準備金，以應付存戶日常提領。這筆準備金可以是庫存現金，也可以是存在中央銀行的存款。</p></li> <li><p>擔任最後貸款人：當商業銀行發生擠兌或流動性危機、同業都不願拆借資金時，央行可以緊急提供融資，防止單一銀行的問題蔓延成系統性風暴。</p></li> <li><p>調整準備金利率：央行透過支付利息給商業銀行的超額準備金，來影響銀行願意把錢留在央行的意願，當利率高於放貸給民間就可以把錢留在政府內。</p></li></ul> <h4>印鈔如何流入市場</h4> <p>央行「印鈔」不是把現金從直升機撒下去，而是透過公開市場操作完成：</p> <ul><li><p>當央行決定增加市場資金（擴張貨幣），它會向商業銀行或金融機構買入債券（通常是政府公債）</p></li> <li><p>央行支付的金額（新印的錢）進入銀行體系，成為銀行的準備金</p></li> <li><p>銀行有了更多準備金，就有能力放出更多貸款，這筆錢最終流入實體經濟</p></li></ul> <p>反過來，當央行想收回資金（緊縮貨幣），就賣出債券，把市場上的錢收回來。這個過程本質上是用「央行信用」交換「市場上的債券」，從而調控資金總量。</p> <h4>購買力的重分配</h4> <p>央行印鈔本身並不創造財富，也不消滅財富——它改變的是財富的「時間價值」與「分配結構」。</p> <ul><li><p>當央行擴大貨幣供給，單位貨幣的購買力會被稀釋。持有現金的人（存款戶、領固定薪資者）實質購買力下降；而先拿到這筆錢的人（政府、企業、借款者）可以用貶值前的價格購買資產或商品。</p></li> <li><p>反過來說，通貨緊縮時，現金的購買力上升，持有現金的人受益，但負債者的負擔加重。</p></li></ul> <p>換句話說，貨幣政策改變的不是「社會有多少財富」，而是「未來的實質購買力在誰手上、何時被使用」。央行的角色是在「避免銀行體系崩潰」與「調控貨幣的供需」之間尋找平衡。它不能憑空創造財富，但它可以決定：你手中的貨幣，明天還能買到多少東西。</p> <h3>人民幣與美元：中國持有美元公債的原因</h3> <p>在自由市場條件下，國際貿易順差理應透過價格機制自動趨於平衡：</p> <ol><li><p>當一國出口大於進口，企業手中累積大量美元外匯</p></li> <li><p>美元形成對人民幣的升值壓力——企業拋售美元換取人民幣，推動人民幣匯率上升</p></li> <li><p>人民幣升值後產生雙重效應：進口商品變得相對便宜（鼓勵進口），出口商品在國際市場價格上漲（抑制出口）</p></li> <li><p>出口訂單因此流向其他成本更低的國家，市場份額重新分配</p></li></ol> <p>如此，貿易順差自然逐步縮減，最終趨近國際收支平衡。這是古典經濟學描述的「自動調節機制」。然而，中國政府透過近似於通縮調節的手段，將這筆資金截留在國家手中。</p> <ol><li><p>央行透過外匯管制強制企業結匯，再以發行央票、提高存款準備率等沖銷操作回收因購匯而釋放的人民幣流動性</p></li> <li><p>積累的美元外匯並未直接用於國內，而是透過購買美國國債的方式，將這筆資金「回流」至美國金融市場。這等於中國將自身的實質購買力，以極低的利率「借給」了美國政府，讓美國得以繼續維持其貿易赤字與財政支出。</p></li></ol> <p>長期風險與結構性矛盾</p> <p>這種安排雖然穩住了人民幣匯率、保障了出口產業，但也埋下了兩大長期隱憂：</p> <p>美國的償債能力問題：美國長期以來仰賴發行國債，向全球借入資金來彌補其貿易赤字與財政赤字。這種模式的基礎是美元的國際儲備貨幣地位，但假若市場對美國政府產生「擠兌」疑慮——即大規模拋售美債——在美國無法同時大幅印鈔（這將引發美元崩盤）的前提下，償還本金將成為不可能任務。這本質上是「借新還舊」的龐氏結構。</p> <p>國內資源的配置扭曲：這筆鉅額資金原本可以用於國內基礎建設、社會福利、技術研發或民生補貼。然而，當國家選擇將購買力「借給」美國，實際上犧牲了當代國民的潛在福利，轉而持有對一個潛在競爭對手的債權。這不僅是財務投資回報率的問題，更是國家發展機會成本的權衡。</p> <p>造成此一現象的深層原因，在於政府對資本帳戶、匯率形成機制及金融體系擁有極大的控制權，得以暫時壓抑市場的自動調節功能，防止＿＿＿＿＿＿。</p>`,1);function wp(u){var e=yp();T(98),f(u,e)}const fp=Object.freeze(Object.defineProperty({__proto__:null,default:wp,metadata:Wn},Symbol.toStringTag,{value:"Module"})),zn={title:"金錢多重宇宙（下）",date:"2026-02-15",category:"book",subCategory:"Finance",tags:["read","blog","Money"],slug:"nackedmoney2"},{title:ei,date:ci,category:li,subCategory:ui,tags:ki,slug:ii}=zn;var hp=w("<h6>理解一下金錢背後的意義</h6> <hr/> <h3>中國持有美元公債的原因</h3> <p>在自由市場條件下，國際貿易順差理應透過價格機制自動趨於平衡：</p> <ol><li><p>當一國出口大於進口，企業手中累積大量美元外匯</p></li> <li><p>美元形成對人民幣的升值壓力 —— 企業拋售美元換取人民幣，推動人民幣匯率上升</p></li> <li><p>人民幣升值後產生雙重效應：進口商品變得相對便宜（鼓勵進口），出口商品在國際市場價格上漲（抑制出口）</p></li> <li><p>出口訂單因此流向其他成本更低的國家，市場份額重新分配</p></li></ol> <p>如此，貿易順差自然逐步縮減，最終趨近國際收支平衡。這是古典經濟學描述的「自動調節機制」。</p> <h4>政府干預</h4> <p>然而中國政府透過近似於通縮調節的手段，將這筆資金截留在國家手中。</p> <ol><li><p>央行透過外匯管制強制企業結匯，再以發行央票、提高存款準備率等沖銷操作回收因購匯而釋放的人民幣流動性</p></li> <li><p>積累的美元外匯並未直接用於國內，而是透過購買美國國債的方式，將這筆資金「回流」至美國金融市場。這等於中國將自身的實質購買力，以極低的利率「借給」了美國政府，讓美國得以繼續維持其貿易赤字與財政支出。</p></li></ol> <p>當然執行上無法完全截留，還是有一大部分留在房地產和金融資產裡面。</p> <h4>長期風險</h4> <p>這種安排雖然穩住了人民幣匯率、保障了出口產業，但也埋下了兩大長期隱憂：</p> <ul><li><p>美國的償債能力問題：美國長期以來仰賴發行國債，向全球借入資金來彌補其貿易赤字與財政赤字。這種模式的基礎是美元的國際儲備貨幣地位，但假若市場對美國政府產生「擠兌」疑慮，在美國無法同時大幅印鈔（這將引發美元崩盤）的前提下，償還本金將成為不可能任務。這本質上是「借新還舊」的龐氏結構。</p></li> <li><p>國內資源的配置扭曲：這筆鉅額資金原本可以用於國內基礎建設、社會福利、技術研發或民生補貼。然而，當國家選擇將購買力「借給」美國，實際上犧牲了當代國民的潛在福利，轉而持有對一個潛在競爭對手的債權。</p></li></ul>",1);function bp(u){var e=hp();T(24),f(u,e)}const vp=Object.freeze(Object.defineProperty({__proto__:null,default:bp,metadata:zn},Symbol.toStringTag,{value:"Module"})),Yn={title:"CSS Render 範本",date:"2025-06-22",category:null,subCategory:null,tags:["svelte","blog","markdown"],slug:"example"},{title:ri,date:di,category:gi,subCategory:mi,tags:yi,slug:wi}=Yn;var _p=w('<p>這是第一篇文章，用來展示部落格如何從 markdown 載入內容。</p> <hr/> <h1>這是 H1 標題</h1> <h2>這是 H2 標題</h2> <h3>這是 H3 標題</h3> <hr/> <p>段落文字：這是一段普通的段落內容，展示預設的段落文字樣式。</p> <p>強調文字：<strong>粗體</strong>、<em>斜體</em>、<del>刪除線</del>。</p> <hr/> <h3>清單測試</h3> <ul><li>無序清單項目 1</li> <li>無序清單項目 2 <ul><li>子項目 a</li> <li>子項目 b</li></ul></li></ul> <ol><li>有序清單項目 1</li> <li>有序清單項目 2 <ol><li>子項目 i</li> <li>子項目 ii</li></ol></li></ol> <hr/> <h3>程式碼區塊</h3> <h4>行內程式碼</h4> <p>例如你可以這樣寫：<code>console.log("Hello Svelte!")</code></p> <h4>區塊程式碼</h4> <pre class="language-js"><!></pre>',1);function Sp(u){var e=_p(),p=a(b(e),34),k=n(p);t(k,()=>`<code class="language-js"><span class="token keyword">function</span> <span class="token function">greet</span><span class="token punctuation">(</span><span class="token parameter">name</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> <span class="token template-string"><span class="token template-punctuation string">&#96;</span><span class="token string">Hello, </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">$&#123;</span>name<span class="token interpolation-punctuation punctuation">&#125;</span></span><span class="token string">!</span><span class="token template-punctuation string">&#96;</span></span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(p),f(u,e)}const Cp=Object.freeze(Object.defineProperty({__proto__:null,default:Sp,metadata:Yn},Symbol.toStringTag,{value:"Module"})),N=[],H=Object.assign({"/src/content/Algorithm/Lec02.md":es,"/src/content/Angular20/angular20_Http_Api.md":us,"/src/content/Angular20/angular20_Http_RxJS.md":rs,"/src/content/Angular20/angular20_RBAC_01.md":ms,"/src/content/Angular20/angular20_RBAC_02.md":fs,"/src/content/Angular20/angular20_RBAC_03.md":vs,"/src/content/Angular20/angular20_RouteReuseStrategy_01.md":Cs,"/src/content/Angular20/angular20_RouteReuseStrategy_02.md":Es,"/src/content/Angular20/angular20_Router.md":Ds,"/src/content/Angular20/angular20_Value_Forms.md":Os,"/src/content/Angular20/angular20_Value_Signal.md":Ls,"/src/content/Angular20/angular20_Value_component.md":Bs,"/src/content/Angular20/angular20_Value_overview.md":Fs,"/src/content/Angular20/angular20_tabService.md":Gs,"/src/content/Backend/BackgroudService.md":Ys,"/src/content/Backend/DDD_01_Architecture.md":Js,"/src/content/Backend/DDD_02_Layers.md":na,"/src/content/Backend/DDD_03_DomainObject.md":ta,"/src/content/Backend/DDD_04_MediatR.md":ea,"/src/content/Backend/DDD_05_Outbox.md":ua,"/src/content/Backend/EFCore_Codefirst.md":ra,"/src/content/Backend/FSM.md":ma,"/src/content/Backend/HttpCancel.md":fa,"/src/content/Database/Paxon_1.md":va,"/src/content/Database/Paxon_2.md":Ca,"/src/content/Database/consistency_1.md":Ea,"/src/content/Database/consistency_2.md":Da,"/src/content/Database/consistency_3.md":Oa,"/src/content/Database/db_concurrency_1.md":La,"/src/content/Database/db_concurrency_2.md":Ba,"/src/content/Database/db_leetcode50.md":Fa,"/src/content/Database/db_normalization.md":Ga,"/src/content/Database/db_relational.md":Ya,"/src/content/Database/db_sql.md":Ja,"/src/content/Database/db_table_1.md":nt,"/src/content/Fronted/Electron_01.md":tt,"/src/content/Fronted/Kotlin_01.md":et,"/src/content/Fronted/ThreeJS.md":ut,"/src/content/Fronted/css.md":rt,"/src/content/Fronted/design_token.md":mt,"/src/content/Golang/Redis.md":ft,"/src/content/Golang/summary.md":vt,"/src/content/How-To/cashflow.md":Ct,"/src/content/How-To/jsPDF.md":Et,"/src/content/How-To/pdfMerge.md":Dt,"/src/content/How-To/reconcile.md":Ot,"/src/content/How-To/sftp_ftps.md":Lt,"/src/content/How-To/structurizr.md":Bt,"/src/content/How-To/summary_2025.md":Ft,"/src/content/How-To/xlsx_excel.md":Gt,"/src/content/Http/CORS.md":Yt,"/src/content/Http/filestream.md":Jt,"/src/content/Http/http_connect.md":np,"/src/content/Http/http_secretKey.md":tp,"/src/content/Http/nginx.md":ep,"/src/content/Project/blog.md":up,"/src/content/Project/webpreviewer.md":rp,"/src/content/Project/websiteeditor.md":mp,"/src/content/Read/nakedMoney_01.md":fp,"/src/content/Read/nakedMoney_02.md":vp,"/src/content/empty.md":Cp});for(const u in H){const e=H[u];N.push({category:e.metadata.category,subCategory:e.metadata.subCategory,title:e.metadata.title,slug:e.metadata.slug,date:e.metadata.date,tags:e.metadata.tags,excerpt:e.metadata.excerpt??"",component:e.default})}N.sort((u,e)=>e.date.localeCompare(u.date));const fi=ts(N);export{Es as $,Ja as A,Ya as B,Ga as C,Fa as D,Ba as E,La as F,Oa as G,Da as H,Ea as I,Ca as J,va as K,fa as L,ma as M,ra as N,ua as O,ea as P,ta as Q,na as R,Js as S,Ys as T,Gs as U,Fs as V,Bs as W,Ls as X,Os as Y,Ds as Z,Cp as _,vp as a,Cs as a0,vs as a1,fs as a2,ms as a3,rs as a4,us as a5,es as a6,fi as a7,fp as b,mp as c,rp as d,up as e,ep as f,tp as g,np as h,Jt as i,Yt as j,Gt as k,Ft as l,Bt as m,Lt as n,Ot as o,Dt as p,Et as q,Ct as r,vt as s,ft as t,mt as u,rt as v,ut as w,et as x,tt as y,nt as z};
