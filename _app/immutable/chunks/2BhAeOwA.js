import{b as B,d as Hn,f as y,a as w}from"./Cew64nlL.js";import"./C5SEx9ip.js";import{t as Bn,h as U,a as V,P as Un,aH as Vn,d as W,V as Wn,Y as zn,W as Gn,B as Yn,T as O,s as t,o as h,v as n,w as s,aI as R}from"./COc0ozwQ.js";import{r as Kn}from"./CR_4RHM7.js";function a(u,o,p=!1,k=!1,e=!1){var i=u,c="";Bn(()=>{var d=Un;if(c===(c=o()??"")){U&&V();return}if(d.nodes_start!==null&&(Vn(d.nodes_start,d.nodes_end),d.nodes_start=d.nodes_end=null),c!==""){if(U){W.data;for(var l=V(),m=l;l!==null&&(l.nodeType!==8||l.data!=="");)m=l,l=Wn(l);if(l===null)throw zn(),Gn;B(W,m),i=Yn(l);return}var r=c+"";p?r=`<svg>${r}</svg>`:k&&(r=`<math>${r}</math>`);var f=Hn(r);if((p||k)&&(f=O(f)),B(O(f),f.lastChild),p||k)for(;O(f);)i.before(O(f));else i.before(f)}})}const G={title:"Base Backgroud Service",date:"2025-09-25",category:"software",subCategory:"Backend",tags:["Backgroud","backend","markdown"],slug:"backgroudservice"},{title:mt,date:yt,category:wt,subCategory:ft,tags:ht,slug:vt}=G;var Xn=y('<h6>C#實作非立即性的服務排序</h6> <hr/> <h3>使用背景</h3> <p>當主程式的 DI 註冊週期是以 HTTP lifecycle 為主時，可藉由 Background Service 提供長期運行的服務容器。</p> <ol><li>非阻塞式處理：可由外部 API 觸發某些動作，立即回應用戶端而不等待處理完成</li> <li>解耦合設計：將耗時的業務邏輯從 HTTP 請求週期中分離出來</li> <li>簡易事件模式：作為一個輕量級的 Event pattern 實現，處理非即時性任務</li> <li>資源管理：避免長時間佔用 HTTP 連線資源，提升系統整體效能</li></ol> <h3>Channel 基礎原理</h3> <p>Channel 是 .NET Core 提供的 thread-safe 生產者-消費者模式實作，基於 System.Threading.Channels 命名空間。它解決了多執行緒環境下的資料傳遞問題。</p> <pre class="language-csharp"><!></pre> <h3>Channel 的監聽機制</h3> <p>寫入機制 (Producer)</p> <pre class="language-csharp"><!></pre> <p>讀取監聽機制 (Consumer)</p> <pre class="language-csharp"><!></pre> <h3>基本架構</h3> <p>DI註冊</p> <pre class="language-csharp"><!></pre> <p>Controller</p> <pre class="language-csharp"><!></pre> <p>服務內部</p> <pre class="language-csharp"><!></pre>',1);function Jn(u){var o=Xn(),p=t(h(o),14),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token class-name"><span class="token keyword">var</span></span> channel <span class="token operator">=</span> Channel<span class="token punctuation">.</span><span class="token generic-method"><span class="token function">CreateUnbounded</span><span class="token generic class-name"><span class="token punctuation">&lt;</span>YourRequestType<span class="token punctuation">></span></span></span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// Channel 包含兩個部分</span>
...
└─────────────────────┘           └──────────────┘            └──────────────────────┘
<span class="token comment">// FIFO 先進先出的順序處理</span></code>`),s(p);var e=t(p,6),i=n(e);a(i,()=>`<code class="language-csharp"><span class="token comment">// 非同步寫入 - 不會阻塞，立即將資料放入佇列</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c);var l=t(c,6),m=n(l);a(m,()=>`<code class="language-csharp"><span class="token comment">// 註冊 Channel 用於背景服務通訊</span>
...
builder<span class="token punctuation">.</span>Services<span class="token punctuation">.</span><span class="token generic-method"><span class="token function">AddHostedService</span><span class="token generic class-name"><span class="token punctuation">&lt;</span>YourBackgroundService<span class="token punctuation">></span></span></span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var r=t(l,4),f=n(r);a(f,()=>`<code class="language-csharp"><span class="token punctuation">[</span><span class="token attribute"><span class="token class-name">HttpPost</span><span class="token attribute-arguments"><span class="token punctuation">(</span><span class="token string">"trigger-action"</span><span class="token punctuation">)</span></span></span><span class="token punctuation">]</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(r);var g=t(r,4),b=n(g);a(b,()=>`<code class="language-csharp"><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">YourBackgroundService</span> <span class="token punctuation">:</span> <span class="token type-list"><span class="token class-name">BackgroundService</span></span>
<span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,4),d=n(c);a(d,()=>'<code class="language-csharp"><span class="token class-name"><span class="token keyword">var</span></span> result <span class="token operator">=</span> <span class="token keyword">await</span> _mediator<span class="token punctuation">.</span><span class="token function">Send</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">LoginUserCommand</span><span class="token punctuation">(</span><span class="token string">"user"</span><span class="token punctuation">,</span> <span class="token string">"pwd"</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(c);var l=t(c,10),m=n(l);a(m,()=>'<code class="language-csharp"><span class="token keyword">await</span> _mediator<span class="token punctuation">.</span><span class="token function">Publish</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">UserLoggedInNotification</span><span class="token punctuation">(</span>userId<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(l);var r=t(l,4),f=n(r);a(f,()=>`<code class="language-csharp"><span class="token punctuation">[</span><span class="token attribute"><span class="token class-name">HttpPost</span><span class="token attribute-arguments"><span class="token punctuation">(</span><span class="token string">"login"</span><span class="token punctuation">)</span></span></span><span class="token punctuation">]</span>
...
<span class="token punctuation">&#123;</span>
    <span class="token class-name"><span class="token keyword">var</span></span> result <span class="token operator">=</span> <span class="token keyword">await</span> _mediator<span class="token punctuation">.</span><span class="token function">Send</span><span class="token punctuation">(</span>command<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token keyword">return</span> <span class="token function">Ok</span><span class="token punctuation">(</span>result<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(r);var g=t(r,12),b=n(g);a(b,()=>`<code class="language-csharp">builder<span class="token punctuation">.</span>Services<span class="token punctuation">.</span><span class="token function">AddTransient</span><span class="token punctuation">(</span><span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">IPipelineBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">,</span> <span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">LoggingBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
builder<span class="token punctuation">.</span>Services<span class="token punctuation">.</span><span class="token function">AddTransient</span><span class="token punctuation">(</span><span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">IPipelineBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">,</span> <span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">ValidationBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(g);var v=t(g,8),S=n(v);a(S,()=>`<code class="language-csharp"><span class="token comment">// .csproj</span>
...
<span class="token operator">&lt;</span><span class="token class-name">PackageReference</span> Include<span class="token operator">=</span><span class="token string">"MassTransit.RabbitMQ"</span> Version<span class="token operator">=</span><span class="token string">"8.1.2"</span> <span class="token operator">/</span><span class="token operator">></span></code>`),s(v);var _=t(v,2),D=n(_);a(D,()=>`<code class="language-csharp"><span class="token comment">// Program.cs</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(_);var C=t(_,4),E=n(C);a(E,()=>'<code class="language-csharp"><span class="token keyword">await</span> _sendEndpoint<span class="token punctuation">.</span><span class="token function">Send</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">GenerateInvoice</span> <span class="token punctuation">&#123;</span> OrderId <span class="token operator">=</span> <span class="token string">"123"</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(C);var P=t(C,4),x=n(P);a(x,()=>'<code class="language-csharp"><span class="token keyword">await</span> _publishEndpoint<span class="token punctuation">.</span><span class="token function">Publish</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token constructor-invocation class-name">UserCreated</span> <span class="token punctuation">&#123;</span> UserId <span class="token operator">=</span> Guid<span class="token punctuation">.</span><span class="token function">NewGuid</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>'),s(P);var T=t(P,4),I=n(T);a(I,()=>`<code class="language-csharp">cfg<span class="token punctuation">.</span><span class="token function">ConfigureMediator</span><span class="token punctuation">(</span><span class="token punctuation">(</span>context<span class="token punctuation">,</span> cfg<span class="token punctuation">)</span> <span class="token operator">=></span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(T);var A=t(T,2),q=n(A);a(q,()=>`<code class="language-csharp"><span class="token punctuation">[</span><span class="token attribute"><span class="token class-name">HttpPost</span><span class="token attribute-arguments"><span class="token punctuation">(</span><span class="token string">"register"</span><span class="token punctuation">)</span></span></span><span class="token punctuation">]</span>
...
<span class="token punctuation">&#125;</span></code>`),s(A),w(u,o)}const ps=Object.freeze(Object.defineProperty({__proto__:null,default:ts,metadata:K},Symbol.toStringTag,{value:"Module"})),X={title:"Domain-Driven - Outbox Message",date:"2025-06-23",category:"software",subCategory:"Backend",tags:["DDD","backend","design"],slug:"ddd_outbox"},{title:Ot,date:qt,category:Lt,subCategory:Nt,tags:$t,slug:Ft}=X;var os=y('<h6>拆分主副邏輯，同時保持資料同步性</h6> <hr/> <h2>SideEffect</h2> <p>若把 DDD 流程中的主副行為拆分：</p> <ul><li>創建員工帳戶的時候 <code>&lt;TABLE_Employee&gt;</code> 新增一筆資料</li> <li>幫對應到的 <code>&lt;TABLE_Department&gt;_Headcount</code> 總人數加一</li></ul> <br/> <p>若是以依照 MVC 架構會是</p> <pre class="language-csharp"><!></pre> <p>用 DDD 寫則變成是</p> <pre class="language-csharp"><!></pre> <p>假設創建員工帳號變為須更新 5-10 張表單,函式會越來越巨大、複雜且難以測試與維護。透過 DDD 的 Domain Event 拆解副作用邏輯可異步處理，減少主流程延遲。</p> <h2>ASIO 原子性（Atomicity of Side-Effect & IO）</h2> <p>剛剛提到的行為，主邏輯成功時無法保證所有副作用（如更新部門、發送通知等）都成功執行，這違反了分散系統中常見的 資料一致性與原子性要求。</p> <p>解決方法是設計一張資料庫新表<code>&lt;DB_Outbox_Message&gt;</code>，在一筆交易中提交主邏輯與事件，且把事件訊息<code>(Event、Payload、Time)</code>寫入這張表。這樣執行失敗也有紀錄可以查驗，也可設計失敗的 Retry 機制。</p> <br/> <p>主要實踐方法是用背景應用重複執行，訪問 DB_Outbox_Message 執行該事件</p> <pre class="language-csharp"><!></pre>',1);function es(u){var o=os(),p=t(h(o),14),k=n(p);a(k,()=>`<code class="language-csharp">db_Employee<span class="token punctuation">.</span><span class="token function">Add</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c),w(u,o)}const cs=Object.freeze(Object.defineProperty({__proto__:null,default:es,metadata:X},Symbol.toStringTag,{value:"Module"})),J={title:"Finite-State Machine",date:"2025-06-30",category:"software",subCategory:"Backend",tags:["FSM","backend","markdown"],slug:"FSM"},{title:Mt,date:jt,category:Ht,subCategory:Bt,tags:Ut,slug:Vt}=J;var ls=y('<h6>FSM 這是一種類比電路常見的概念，用金流常見的狀態模擬看看。</h6> <hr/> <h3>核心概念</h3> <p>狀態是封閉集合其一：Pending / Paid / Failed / RefundPending / Refunded。</p> <p>事件是唯一入口：只有明確的事件才能讓狀態改變。</p> <pre class="language-csharp"><!></pre> <table><thead><tr><th>CurrentState</th><th>Trigger</th><th>NextState</th></tr></thead><tbody><tr><td>Pending</td><td>PaySucceeded</td><td>Paid</td></tr><tr><td>Pending</td><td>PayFailed</td><td>Failed</td></tr><tr><td>Paid</td><td>StartRefund</td><td>RefundPending</td></tr><tr><td>RefundPending</td><td>RefundSucceeded</td><td>Refunded</td></tr><tr><td>RefundPending</td><td>RefundFailed</td><td>Paid</td></tr><tr><td>Failed/Refunded</td><td><em>(無任何事件)</em></td><td><em>(終點)</em></td></tr></tbody></table> <h3>簡易流程</h3> <pre class="language-csharp"><!></pre> <p>限制行為的方式</p> <pre class="language-csharp"><!></pre> <h3>測試與擴充</h3> <p>單元測試每條轉移：「Pending → PaySucceeded → Paid」。</p> <p>新增流程：只要在 enum + 轉移表多加一條，和對應 trigger 的處理；主程式 switch(fsm.CurrentState) 自動接手 DB 差異。</p>',1);function us(u){var o=ls(),p=t(h(o),10),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token comment">// 狀態（State）</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p);var e=t(p,4),i=n(e);a(i,()=>`<code class="language-go">
...
<span class="token punctuation">&#125;</span>
    ...
    <span class="token punctuation">&#125;</span> <span class="token keyword">else</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token keyword">return</span> <span class="token boolean">false</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c);var l=t(c,2),m=n(l);a(m,()=>`<code class="language-golang">
package main
...
但是如果_R3突然掛掉了，可以找一個替代伺服器_R4，只是_R4儲存的資料需要標記，等_R3恢復後再回補</p> <pre class="language-text"><!></pre>`,1);function fs(u){var o=ws(),p=t(h(o),34),k=n(p);a(k,()=>`<code class="language-text">庫存初始值：100
...
<span class="token keyword">GROUP</span> <span class="token keyword">BY</span> 
    ...
    country<span class="token punctuation">;</span></code>`),s(c);var l=t(c,6),m=n(l);a(m,()=>`<code class="language-sql"><span class="token keyword">SELECT</span>
  <span class="token function">ROUND</span><span class="token punctuation">(</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var r=t(l,6),f=n(r);a(f,()=>`<code class="language-sql"><span class="token keyword">select</span> e1<span class="token punctuation">.</span>employee_id
...
<span class="token keyword">order</span> <span class="token keyword">by</span> employee_id <span class="token keyword">asc</span></code>`),s(r);var g=t(r,6),b=n(g);a(b,()=>`<code class="language-sql"><span class="token punctuation">(</span>
...
<span class="token punctuation">(</span>
  ...
  <span class="token keyword">LIMIT</span> <span class="token number">1</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(g);var v=t(g,6),S=n(v);a(S,()=>`<code class="language-sql"><span class="token keyword">SELECT</span> id<span class="token punctuation">,</span> <span class="token function">COUNT</span><span class="token punctuation">(</span><span class="token operator">*</span><span class="token punctuation">)</span> <span class="token keyword">AS</span> num
<span class="token keyword">FROM</span> <span class="token punctuation">(</span>
...
--------|-----------
1001    | A1
1001    | A2</code>`),s(c);var l=t(c,6),m=n(l);a(m,()=>`<code class="language-text">StudentID | DeptID | DeptName
----------|--------|----------
1001      | D01    | Computer Science</code>`),s(l);var r=t(l,4),f=n(r);a(f,()=>`<code class="language-text">StudentID | DeptID
----------|--------
1001      | D01
1002      | D02
...
D02    | Electrical Engineering</code>`),s(r);var g=t(r,6),b=n(g);a(b,()=>`<code class="language-text">Course | Instructor | Room
-------|------------|-----
DB     | Smith      | R1
DB     | Jones      | R2</code>`),s(g);var v=t(g,4),S=n(v);a(S,()=>`<code class="language-text">-- 課程與教室（CourseRoom）
Course | Room
-------|-----
DB     | R1
...
Instructor | Room
-----------|-----
Smith      | R1</code>`),s(v);var _=t(v,6),D=n(_);a(D,()=>`<code class="language-text">錯誤
...
Restaurant | Area</code>`),s(C);var P=t(C,6),x=n(P);a(x,()=>`<code class="language-text">-- Supplier-Part
S1 | P1
...
---------|------|---------
S1       | P1   | J1  （合理）
S1       | P1   | J2  （若 J2 並不屬於 P1）</code>`),s(P);var T=t(P,4),I=n(T);a(I,()=>`<code class="language-text">-- Supplier-Part-Project
Supplier | Part | Project
---------|------|---------
S1       | P1   | J1</code>`),s(T),w(u,o)}const Is=Object.freeze(Object.defineProperty({__proto__:null,default:xs,metadata:pn},Symbol.toStringTag,{value:"Module"})),on={title:"關聯式資料庫",date:"2025-06-22",category:"software",subCategory:"Database",tags:["database","db","sql"],slug:"db_relational"},{title:Op,date:qp,category:Lp,subCategory:Np,tags:$p,slug:Fp}=on;var As=y('<pre class="language-pgsql"><!></pre> <p>連接 SQL Server 時是透過 TDS（Tabular Data Stream）的通訊協定來交換資料。</p> <ul><li>TDS 是 SQL Server 專用的底層通訊協定，負責在用戶端與資料庫伺服器之間傳遞</li> <li>通常透過 TCP/IP 傳輸，預設使用的連接埠為 1433。</li> <li>用戶端要連接資料庫時，會使用一段 Connection String（連線字串）</li></ul> <pre class="language-pgsql"><!></pre> <h3>Table（資料表）</h3> <p>資料表是資料的儲存核心，每個表由「列（row）」與「欄（column）」構成。</p> <pre class="language-sql"><!></pre> <h3>Primary Key（主鍵）</h3> <p>能唯一標識每一筆資料，一張表只能有一個主鍵，可以是單一欄位或多欄位組成（複合主鍵）。</p> <pre class="language-sql"><!></pre> <h3>Unique Constraint（唯一約束）</h3> <p>限制欄位值不能重複，一張表可以有多個唯一欄位。</p> <pre class="language-sql"><!></pre> <h3>Foreign Key（外鍵）</h3> <pre class="language-sql"><!></pre> <h3>Index（索引）</h3> <p>加速查詢效率，類似書本的目錄，索引可以建立在單一欄位或多個欄位上。</p> <pre class="language-sql"><!></pre>',1);function Os(u){var o=As(),p=h(o),k=n(p);a(k,()=>`<code class="language-pgsql">SQL Server Instance
├── Database
│   ├── Schema
│   │   ├── Table
│   │   ├── View
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(c);var l=t(c,6),m=n(l);a(m,()=>`<code class="language-sql"><span class="token keyword">ALTER</span> <span class="token keyword">TABLE</span> Users
<span class="token keyword">ADD</span> <span class="token keyword">CONSTRAINT</span> PK_Users <span class="token keyword">PRIMARY</span> <span class="token keyword">KEY</span> <span class="token punctuation">(</span>Id<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var r=t(l,6),f=n(r);a(f,()=>`<code class="language-sql"><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> Products <span class="token punctuation">(</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(r);var g=t(r,4),b=n(g);a(b,()=>`<code class="language-sql"><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> Orders <span class="token punctuation">(</span>
...
</code>`),s(p);var e=t(p,6),i=n(e);a(i,()=>`<code class="language-scss">1. 類別A <span class="token punctuation">(</span>ID=1<span class="token punctuation">)</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var r=t(l,4),f=n(r);a(f,()=>`<code class="language-sql"><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> Category <span class="token punctuation">(</span>
  ID   <span class="token keyword">BIGINT</span>        <span class="token keyword">PRIMARY</span> <span class="token keyword">KEY</span><span class="token punctuation">,</span>
  Name NVARCHAR<span class="token punctuation">(</span><span class="token number">100</span><span class="token punctuation">)</span> <span class="token operator">NOT</span> <span class="token boolean">NULL</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code>`),s(r);var g=t(r,2),b=n(g);a(b,()=>`<code class="language-scss">A <span class="token punctuation">(</span>ID=1<span class="token punctuation">)</span>
...
└─ C <span class="token punctuation">(</span>ID=3<span class="token punctuation">)</span></code>`),s(g);var v=t(g,6),S=n(v);a(S,()=>`<code class="language-sql"><span class="token comment">-- 查詢某節點的所有後代（含自己）</span>
...
<span class="token keyword">ORDER</span> <span class="token keyword">BY</span> cc<span class="token punctuation">.</span>Depth<span class="token punctuation">;</span></code>`),s(v);var _=t(v,6),D=n(_);a(D,()=>`<code class="language-sql"><span class="token comment">-- 對所有 ancestor of parentId，插入新後代關係</span>
...
<span class="token keyword">using</span> <span class="token class-name"><span class="token keyword">var</span></span> res <span class="token operator">=</span> <span class="token keyword">await</span> client<span class="token punctuation">.</span><span class="token function">SendAsync</span><span class="token punctuation">(</span>req<span class="token punctuation">,</span>HttpCompletionOption<span class="token punctuation">.</span>ResponseHeadersRead<span class="token punctuation">,</span>ct<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(c);var l=t(c,6),m=n(l);a(m,()=>`<code class="language-csharp"><span class="token keyword">switch</span> <span class="token punctuation">(</span>res<span class="token punctuation">.</span>data<span class="token punctuation">.</span>ReturnCode<span class="token punctuation">)</span>
<span class="token punctuation">&#123;</span>
...
pdfDoc<span class="token punctuation">.</span><span class="token function">setFont</span><span class="token punctuation">(</span><span class="token string">'eduSong_Unicode'</span><span class="token punctuation">,</span> <span class="token string">'normal'</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(c);var l=t(c,4),m=n(l);a(m,()=>`<code class="language-js"><span class="token keyword">const</span> blob <span class="token operator">=</span> pdfDoc<span class="token punctuation">.</span><span class="token function">output</span><span class="token punctuation">(</span><span class="token string">'blob'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
pdfDoc<span class="token punctuation">.</span><span class="token function">save</span><span class="token punctuation">(</span><span class="token string">"fileName.pdf"</span><span class="token punctuation">)</span></code>`),s(l),w(u,o)}const zs=Object.freeze(Object.defineProperty({__proto__:null,default:Ws,metadata:un},Symbol.toStringTag,{value:"Module"})),kn={title:"多個 PDF 檔案合併",date:"2025-09-16",category:"software",subCategory:"開發筆記",tags:["pdf","backend","command"],slug:"pdfmarge"},{title:uo,date:ko,category:ro,subCategory:io,tags:go,slug:mo}=kn;var Gs=y('<h6><a href="https://github.com/cao0085/pdfMerger" rel="nofollow">Repository</a> ，Python 執行相容性比較好，C# UI方便友善</h6> <hr/> <h3>C#</h3> <pre class="language-csharp"><!></pre> <pre class="language-csharp"><!></pre> <h3>Python3</h3> <pre class="language-bash"><!></pre> <pre class="language-python"><!></pre>',1);function Ys(u){var o=Gs(),p=t(h(o),6),k=n(p);a(k,()=>`<code class="language-csharp">  <span class="token comment">// .csproj</span>
...
<span class="token operator">&lt;</span><span class="token operator">/</span>ItemGroup<span class="token operator">></span></code>`),s(p);var e=t(p,2),i=n(e);a(i,()=>`<code class="language-csharp"><span class="token keyword">using</span> <span class="token namespace">System</span><span class="token punctuation">;</span>
...
pip <span class="token function">install</span> cryptography</code>`),s(c);var l=t(c,2),m=n(l);a(m,()=>`<code class="language-python"><span class="token comment">#!/usr/bin/env python3</span>
...
確認檔案產出再 Update 資料庫</p> <pre class="language-csharp"><!></pre> <pre class="language-csharp"><!></pre>`,1);function Js(u){var o=Xs(),p=t(h(o),16),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token comment">/// &lt;summary></span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(p);var e=t(p,6),i=n(e);a(i,()=>`<code class="language-csharp"><span class="token keyword">public</span> <span class="token keyword">async</span> <span class="token return-type class-name">Task<span class="token punctuation">&lt;</span>List<span class="token punctuation">&lt;</span><span class="token keyword">string</span><span class="token punctuation">></span><span class="token punctuation">></span></span> <span class="token function">ReadFileAndGetValidLines</span><span class="token punctuation">(</span><span class="token class-name"><span class="token keyword">string</span></span> path<span class="token punctuation">)</span>
<span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(c);var l=t(c,2),m=n(l);a(m,()=>`<code class="language-csharp"><span class="token keyword">public</span> <span class="token keyword">async</span> <span class="token return-type class-name">Task</span> <span class="token function">SaveRawDataToFile</span><span class="token punctuation">(</span><span class="token class-name"><span class="token keyword">string</span></span> savedPath<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">string</span></span> fileName<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">string</span> <span class="token punctuation">[</span><span class="token punctuation">]</span></span> data<span class="token punctuation">)</span>
<span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(l);var r=t(l,6),f=n(r);a(f,()=>`<code class="language-csharp">CreateDate <span class="token operator">=</span> DateTime<span class="token punctuation">.</span>Now<span class="token punctuation">,</span>
Exported <span class="token operator">=</span> <span class="token class-name">false</span>
FileName <span class="token operator">=</span> <span class="token keyword">null</span></code>`),s(r);var g=t(r,2),b=n(g);a(b,()=>`<code class="language-csharp"><span class="token comment">/// &lt;summary></span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(g),w(u,o)}const Qs=Object.freeze(Object.defineProperty({__proto__:null,default:Js,metadata:rn},Symbol.toStringTag,{value:"Module"})),dn={title:"SFTP、FTPS C# 連線測試",date:"2025-10-01",category:"software",subCategory:"開發筆記",tags:["tcp","ip","container"],slug:"sftp_ftps"},{title:_o,date:Co,category:So,subCategory:Po,tags:Ro,slug:To}=dn;var Zs=y('<h6>紀錄本地端測試方法</h6> <hr/> <h3>SFTP</h3> <p>docker-compose.yml</p> <pre class="language-yml"><!></pre> <pre class="language-csharp"><!></pre> <h3>FTPS</h3> <pre class="language-csharp"><!></pre> <p>docker-compose.yml</p> <pre class="language-yml"><!></pre> <h3>2SFTP+FTPS</h3> <pre class="language-yml"><!></pre>',1);function na(u){var o=Zs(),p=t(h(o),8),k=n(p);a(k,()=>`<code class="language-yml"><span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">sftp</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">environment</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> SFTP_USERS=user01<span class="token punctuation">:</span>password01<span class="token punctuation">:</span><span class="token number">1001</span>  <span class="token comment"># 設置 SFTP 用戶</span></code>`),s(p);var e=t(p,2),i=n(e);a(i,()=>`<code class="language-csharp"><span class="token keyword">using</span> <span class="token namespace">Renci<span class="token punctuation">.</span>SshNet</span><span class="token punctuation">;</span>
...
ftpsClient<span class="token punctuation">.</span><span class="token function">Connect</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(c);var l=t(c,4),m=n(l);a(m,()=>`<code class="language-yml"><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">'3.8'</span>
...
<span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">ftps</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">restart</span><span class="token punctuation">:</span> unless<span class="token punctuation">-</span>stopped</code>`),s(l);var r=t(l,4),f=n(r);a(f,()=>`<code class="language-yml"><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">'3.8'</span>
...
<span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">structurizr</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">volumes</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> .<span class="token punctuation">:</span>/usr/local/structurizr</code>`),s(p);var e=t(p,4),i=n(e);a(i,()=>`<code class="language-text">workspace &quot;YourProjectName&quot; &#123;
...
YourSystem.InitPage_1 -&gt; YourSystem.InitPage_2 &quot;connection&quot;</code>`),s(c);var l=t(c,10),m=n(l);a(m,()=>`<code class="language-text">container YourSystem &quot;Name&quot; &#123;
    include *
&#125;
...
</code>`),s(c);var l=t(c,8),m=n(l);a(m,()=>`<code class="language-js"><span class="token keyword">const</span> orderList <span class="token operator">=</span> <span class="token punctuation">[</span>
  <span class="token punctuation">&#123;</span>
...
flattenedList<span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">row<span class="token punctuation">,</span> rowIndex</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code>`),s(r);var g=t(r,4),b=n(g);a(b,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> <span class="token constant">XLSX</span> <span class="token keyword">from</span> <span class="token string">'xlsx'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),R(28),w(u,o)}const da=Object.freeze(Object.defineProperty({__proto__:null,default:ia,metadata:wn},Symbol.toStringTag,{value:"Module"})),fn={title:"插入 3D 影像",date:"2025-08-13",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"threeJs"},{title:Qo,date:Zo,category:ne,subCategory:se,tags:ae,slug:te}=fn;var ga=y(`<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>匯入 .glb</h3> <p>透過用 three.js 匯入
Canvas ➜ WebGL ➜ Three.js ➜ GLB 模型 ➜ GPU 顯示</p> <pre class="language-js"><!></pre>`,1);function ma(u){var o=ga(),p=t(h(o),8),k=n(p);a(k,()=>`<code class="language-js">  <span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> <span class="token constant">THREE</span> <span class="token keyword">from</span> <span class="token string">'three'</span><span class="token punctuation">;</span>
...
└── hello-world.component.spec.ts</code>`),s(p);var e=t(p,6),i=n(e);a(i,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">"@angular/core"</span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,4),d=n(c);a(d,()=>`<code class="language-html">    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>main<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
        ...
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>input</span>
            ...
            <span class="token attr-name">(keyup.enter)</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>addItem(newItem.value); newItem.value = ''<span class="token punctuation">"</span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>`),s(c);var l=t(c,18),m=n(l);a(m,()=>`<code class="language-js"><span class="token comment">// 依序放入同步/非同步自定義驗證規則</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(l);var r=t(l,2),f=n(r);a(f,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(r);var g=t(r,8),b=n(g);a(b,()=>`<code class="language-ts"><span class="token decorator"><span class="token at operator">@</span><span class="token function">Component</span></span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">CardComponent</span> <span class="token punctuation">&#123;</span><span class="token punctuation">&#125;</span></code>`),s(g);var v=t(g,4),S=n(v);a(S,()=>`<code class="language-ts"><span class="token operator">&lt;</span>app<span class="token operator">-</span>card<span class="token operator">></span>
...
<span class="token operator">&lt;</span><span class="token operator">/</span>app<span class="token operator">-</span>card<span class="token operator">></span></code>`),s(v);var _=t(v,4),D=n(_);a(D,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>my-dialog</span><span class="token punctuation">></span></span></code>`),s(C),w(u,o)}const ha=Object.freeze(Object.defineProperty({__proto__:null,default:fa,metadata:hn},Symbol.toStringTag,{value:"Module"})),vn={title:"Angular Http Observable",date:"2025-06-22",category:"software",subCategory:"Frontend",tags:["http","angular","api"],slug:"angular_http_observable"},{title:ke,date:re,category:ie,subCategory:de,tags:ge,slug:me}=vn;var va=y('<h6>RxJS Observable</h6> <hr/> <p>在 Angular 裡，HttpClient 的每個方法都會回傳一個 RxJS Observable，這些 Observable 屬於 cold 類型 —— 在訂閱（subscribe）時才真正發送請求。</p> <p>多次訂閱同一個 Observable 會觸發多次獨立的後端呼叫；若在請求途中解除訂閱，Angular 會直接 中止（abort）尚未完成的 HTTP 連線。</p> <pre class="language-js"><!></pre> <p>簡易封裝才可以靈活使用 pipe()、switchMap() …</p> <pre class="language-js"><!></pre> <h3>Observable 常見 Method</h3> <table><thead><tr><th>Operator</th><th>用途說明</th></tr></thead><tbody><tr><td><code>map()</code></td><td>資料轉換，取出你要的欄位、格式化資料</td></tr><tr><td><code>tap()</code></td><td>執行副作用（不改變資料），常用來 <code>console.log</code>, 設定 loading</td></tr><tr><td><code>switchMap()</code></td><td>用一筆資料觸發下一個 Observable，並自動取消舊的</td></tr><tr><td><code>mergeMap()</code></td><td>觸發下一個 Observable，但不取消前一筆（適合併發）</td></tr><tr><td><code>catchError()</code></td><td>錯誤處理，不讓錯誤中斷整個流程</td></tr><tr><td><code>finalize()</code></td><td>無論成功/失敗，最後一定會執行（常用來清除狀態）</td></tr><tr><td><code>retry(n)</code></td><td>API 失敗時，自動重試 n 次</td></tr><tr><td><code>timeout(ms)</code></td><td>若 Observable 超過時間未完成，會自動報錯</td></tr><tr><td><code>debounceTime(ms)</code></td><td>等使用者輸入穩定後才送出請求（防抖）</td></tr></tbody></table> <pre class="language-js"><!></pre>',1);function ba(u){var o=va(),p=t(h(o),8),k=n(p);a(k,()=>`<code class="language-js"><span class="token keyword">this</span><span class="token punctuation">.</span>http<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'/api/getExportData'</span><span class="token punctuation">)</span>
...
<span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,6),d=n(c);a(d,()=>`<code class="language-js"><span class="token keyword">this</span><span class="token punctuation">.</span>api<span class="token punctuation">.</span>get<span class="token operator">&lt;</span>any<span class="token operator">></span><span class="token punctuation">(</span><span class="token string">'/api/users'</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code>`),s(c),w(u,o)}const _a=Object.freeze(Object.defineProperty({__proto__:null,default:ba,metadata:vn},Symbol.toStringTag,{value:"Module"})),bn={title:"Angular Router",date:"2025-06-22",category:"software",subCategory:"Frontend",tags:["route","angular","api"],slug:"angular_router"},{title:ye,date:we,category:fe,subCategory:he,tags:ve,slug:be}=bn;var Ca=y('<h6>參考這個<a href="https://github.com/mbejda/AngularFire-Starter-Template" rel="nofollow">專案範本</a>、官方文件學習</h6> <hr/> <p>專案起始 index.html</p> <pre class="language-html"><!></pre> <p>元件去抓專案的根節點，render的內容用<code>&lt;router-outlet&gt;</code>佔位</p> <pre class="language-ts"><!></pre> <p>Route</p> <p>設定該路由(Path) <code>&lt;router-outlet&gt;</code>映射的元件</p> <pre class="language-ts"><!></pre> <p>且若添加 children 屬性擇該 映射的元件 裡面也可以再放一個佔位</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <h3>Route順序和路由守衛</h3> <p>Angular自帶跳轉和瀏覽權限設定，可自行放入<code>canActivate[]</code>裡面做邏輯判斷</p> <pre class="language-ts"><!></pre>',1);function Sa(u){var o=Ca(),p=t(h(o),6),k=n(p);a(k,()=>`<code class="language-html"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">doctype</span> <span class="token name">html</span><span class="token punctuation">></span></span>
...
<span class="token keyword">export</span> <span class="token keyword">const</span> routes<span class="token operator">:</span> Routes <span class="token operator">=</span> <span class="token punctuation">[</span>
  <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">]</span>
  <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
<span class="token punctuation">]</span><span class="token punctuation">;</span></code>`),s(c);var l=t(c,4),m=n(l);a(m,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">LayoutComponent</span> <span class="token punctuation">&#123;</span><span class="token punctuation">&#125;</span></code>`),s(l);var r=t(l,2),f=n(r);a(f,()=>`<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>app-container<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>`),s(r);var g=t(r,6),b=n(g);a(b,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Routes <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/router'</span><span class="token punctuation">;</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>custom-slider</span> <span class="token attr-name">[defineValue]</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>50<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span></code>`),s(c);var l=t(c,10),m=n(l);a(m,()=>`<code class="language-js">@<span class="token function">Component</span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span><span class="token operator">...</span><span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">CustomSlider</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(l);var r=t(l,4),f=n(r);a(f,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> input<span class="token punctuation">,</span> output <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">CustomSlider</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">onValueChange</span><span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">newValue</span><span class="token operator">:</span> number</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">this</span><span class="token punctuation">.</span>defineValueChange<span class="token punctuation">.</span><span class="token function">emit</span><span class="token punctuation">(</span>newValue<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(r);var g=t(r,2),b=n(g);a(b,()=>`<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>custom-slider</span>
...
<span class="token punctuation">/></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>custom-slider</span> <span class="token attr-name">[(defineValue)]</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>50<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span></code>`),s(g);var v=t(g,8),S=n(v);a(S,()=>`<code class="language-js">@<span class="token function">ViewChild</span><span class="token punctuation">(</span><span class="token string">'myDiv'</span><span class="token punctuation">)</span> divElement<span class="token operator">!</span><span class="token operator">:</span> ElementRef<span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(v);var _=t(v,2),D=n(_);a(D,()=>'<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">#myDiv</span><span class="token punctuation">></span></span>hello<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>'),s(_);var C=t(_,4),E=n(C);a(E,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component<span class="token punctuation">,</span> effect<span class="token punctuation">,</span> viewChild<span class="token punctuation">,</span> ElementRef <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">MyComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(C);var P=t(C,4),x=n(P);a(x,()=>`<code class="language-js"><span class="token comment">// div = viewChild.required('myDiv', &#123; read: ElementRef &#125;);</span>
<span class="token function">effect</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code>`),s(P);var T=t(P,4),I=n(T);a(I,()=>`<code class="language-ts"><span class="token comment">// hero.service.ts</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">HeroService</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(T);var A=t(T,2),q=n(A);a(q,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> HeroService <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'../services/hero.service'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">HeroComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">add</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">this</span><span class="token punctuation">.</span>heroes <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span>heroService<span class="token punctuation">.</span><span class="token function">getHeroes</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(A);var L=t(A,4),Ln=n(L);a(Ln,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
firstName<span class="token punctuation">.</span><span class="token function">update</span><span class="token punctuation">(</span><span class="token parameter">name</span> <span class="token operator">=></span> name<span class="token punctuation">.</span><span class="token function">toUpperCase</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(L);var N=t(L,2),Nn=n(N);a(Nn,()=>`<code class="language-ts"><span class="token keyword">const</span> firstName <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token string">'Morgan'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
firstName<span class="token punctuation">.</span><span class="token function">set</span><span class="token punctuation">(</span><span class="token string">'Jaime'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">firstNameCapitalized</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 'JAIME'（自動反應）</span></code>`),s(N);var $=t(N,4),$n=n($);a($n,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component<span class="token punctuation">,</span> signal<span class="token punctuation">,</span> computed <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(F);var M=t(F,4),Mn=n(M);a(Mn,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal<span class="token punctuation">,</span> effect<span class="token punctuation">,</span> untracked <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),w(u,o)}const Ia=Object.freeze(Object.defineProperty({__proto__:null,default:xa,metadata:Cn},Symbol.toStringTag,{value:"Module"})),Sn={title:"Design Token",date:"2025-08-18",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"webdesign"},{title:qe,date:Le,category:Ne,subCategory:$e,tags:Fe,slug:Me}=Sn;var Aa=y('<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>Color System</h3> <p>Primary Colors</p> <pre class="language-json"><!></pre> <p>Status Colors</p> <pre class="language-json"><!></pre> <p>Neutral Colors</p> <pre class="language-json"><!></pre> <h3>Typography System</h3> <p>Font Family</p> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre>',1);function Oa(u){var o=Aa(),p=t(h(o),8),k=n(p);a(k,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(p);var e=t(p,4),i=n(e);a(i,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  <span class="token property">"color"</span><span class="token operator">:</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,4),d=n(c);a(d,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  <span class="token property">"color"</span><span class="token operator">:</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c);var l=t(c,6),m=n(l);a(m,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(l);var r=t(l,2),f=n(r);a(f,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(r);var g=t(r,2),b=n(g);a(b,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(g);var v=t(g,2),S=n(v);a(S,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(v);var _=t(v,2),D=n(_);a(D,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(_);var C=t(_,2),E=n(C);a(E,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(C);var P=t(C,2),x=n(P);a(x,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(P);var T=t(P,2),I=n(T);a(I,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(T),w(u,o)}const qa=Object.freeze(Object.defineProperty({__proto__:null,default:Oa,metadata:Sn},Symbol.toStringTag,{value:"Module"})),Pn={title:"CORS & SOP",date:"2025-10-27",category:"software",subCategory:"Internet",tags:["http","SOP","CORS"],slug:"cors"},{title:je,date:He,category:Be,subCategory:Ue,tags:Ve,slug:We}=Pn;var La=y('<h2>常常看到 CORS 今天才知道有 SOP</h2> <p>瀏覽器原生就有一個預設的安全機制叫做 <code>Same-Origin Policy (SOP)</code>，它只允許網頁接收來自相同來源（Same Origin）的資料。</p> <p>這個限制在實務上會造成一些不便：如果前後端分別部署在不同的 Server 上，前端就無法直接向後端發送請求取得資料。傳統的解決方式是讓後端先接收外部資料，再轉發給前端。</p> <p>為了突破這個限制，讓跨來源的資料交換更方便，<code>CORS（Cross-Origin Resource Sharing）</code> 機制因此誕生。</p> <h3>Same-Origin Policy</h3> <p>主要用來防範 <strong>跨站請求偽造（CSRF）</strong> 等攻擊。由於瀏覽器發送請求時會自動帶上當前網站的 Origin，且 JavaScript 無法隨意偽造這個值，因此 SOP 可以有效防止惡意網站冒用使用者身份。</p> <p>假設你登入了銀行網站 A，此時瀏覽器會儲存 A 網站的 Cookie（包含登入憑證）。如果沒有 SOP 保護，當你訪問惡意網站 B 時，B 網站的 JavaScript 就能向 A 銀行發送請求，並自動帶上你的登入 Cookie，進而盜取資料或進行轉帳。有了 SOP，瀏覽器會阻擋 B 網站讀取來自 A 網站的回應資料。</p> <pre class="language-md"><!></pre> <h3>Cross-Origin Resource Sharing</h3> <p>當進入 CORS 流程時，瀏覽器會先檢查該請求是簡單請求還是預檢請求。</p> <p>為什麼要分兩種請求？主要是為了保護舊的後端伺服器。簡單請求通常只是讀取資料，比較安全，可以直接送出。但如果是可能修改資料的請求（如 PUT、DELETE）或帶有自訂 Header，就需要先用預檢確認後端有支援 CORS，避免對不支援的舊伺服器造成意外影響。</p> <p><strong>簡單請求 (Simple Request)</strong></p> <p>符合以下條件的請求會被視為簡單請求：</p> <ul><li>HTTP Method 為 <code>GET</code>、<code>HEAD</code> 或 <code>POST</code></li> <li>Content-Type 只能是 <code>application/x-www-form-urlencoded</code>、<code>multipart/form-data</code> 或 <code>text/plain</code></li> <li>沒有自訂的 Header</li></ul> <p>簡單請求會直接送出，伺服器透過回應 Header 告知瀏覽器是否允許該跨來源請求。</p> <p><strong>預檢請求 (Preflight Request)</strong></p> <p>不符合簡單請求條件的請求，瀏覽器會先發送一個 <code>OPTIONS</code> 方法的預檢請求，詢問伺服器是否允許實際請求。只有當預檢通過後，才會發送真正的請求。</p> <pre class="language-md"><!></pre> <p><strong>常見的 CORS Headers</strong></p> <p>伺服器端需要設定的主要 Headers：</p> <ul><li><code>Access-Control-Allow-Origin</code>: 指定允許的來源，可設為特定網域或 <code>*</code>（所有來源）</li> <li><code>Access-Control-Allow-Methods</code>: 允許的 HTTP 方法，如 <code>GET, POST, PUT, DELETE</code></li> <li><code>Access-Control-Allow-Headers</code>: 允許的自訂 Headers</li> <li><code>Access-Control-Allow-Credentials</code>: 是否允許攜帶憑證（如 Cookie）</li> <li><code>Access-Control-Max-Age</code>: 預檢請求的快取時間（秒）</li></ul> <p><strong>範例設定</strong></p> <pre class="language-javascript"><!></pre> <p>分兩種請求主要是保護舊的後端伺服器。簡單請求通常只是讀取資料，可以直接送出。但如果是可能修改資料的請求（如 PUT、DELETE）或帶有自訂 Header，就需要先用預檢確認後端有支援 CORS，避免對不支援的舊伺服器造成意外影響。</p> <p><strong>實際測試 CORS</strong></p> <p>架好後端後，用瀏覽器打開任意網站（例如 <code>https://policy.medium.com/medium-terms-of-service-9db0094a1e0f</code>），開啟開發者工具的主控台執行：</p> <pre class="language-js"><!></pre> <p>此時前端會看到 CORS 錯誤，但如果觀察後端 Log，會發現請求有成功並回應，只是瀏覽器阻擋了回應。</p> <p>回到瀏覽器切換到「網路」面板，找到這個請求，查看「要求標頭」中的 <code>Origin</code> 欄位（例如 <code>https://policy.medium.com</code>）這就是瀏覽器自動帶上的來源網域。回到後端程式碼，加上允許的來源並重啟：</p> <pre class="language-golang"><!></pre> <p>重新執行 fetch，就可以成功取得資料了。</p> <p><strong>完整程式碼</strong></p> <pre class="language-golang"><!></pre>',1);function Na(u){var o=La(),p=t(h(o),14),k=n(p);a(k,()=>`<code class="language-md">    B 網站的 JS 發起請求到 A Server
    ...
    (Yes)      (No)
    直接發送    進入 CORS 流程
    正常讀取</code>`),s(p);var e=t(p,20),i=n(e);a(i,()=>`<code class="language-md">    瀏覽器發送 OPTIONS 請求
            ↓
    ...
    (Yes)         (No)
    發送實際請求    阻擋請求
    取得回應      顯示 CORS 錯誤</code>`),s(e);var c=t(e,10),d=n(c);a(d,()=>`<code class="language-javascript"><span class="token comment">// Node.js Express 範例</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(c);var l=t(c,8),m=n(l);a(m,()=>`<code class="language-js"><span class="token function">fetch</span><span class="token punctuation">(</span><span class="token string">'http://127.0.0.1:8080/api'</span><span class="token punctuation">,</span> <span class="token punctuation">&#123;</span><span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">.</span><span class="token function">then</span><span class="token punctuation">(</span><span class="token parameter">d</span> <span class="token operator">=></span> console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>d<span class="token punctuation">)</span><span class="token punctuation">)</span></code>`),s(l);var r=t(l,6),f=n(r);a(f,()=>`<code class="language-golang">w.Header().Set(&quot;Access-Control-Allow-Origin&quot;, &quot;https://policy.medium.com&quot;) // 允許特定網域
w.Header().Set(&quot;Access-Control-Allow-Origin&quot;, &quot;*&quot;) // 允許所有來源</code>`),s(r);var g=t(r,6),b=n(g);a(b,()=>`<code class="language-golang">// golang
package main 
...
&#125;</code>`),s(g),w(u,o)}const $a=Object.freeze(Object.defineProperty({__proto__:null,default:Na,metadata:Pn},Symbol.toStringTag,{value:"Module"})),Rn={title:"HTTP & FileStream",date:"2025-10-27",category:null,subCategory:null,tags:["http","filestream"],slug:"filestream"},{title:ze,date:Ge,category:Ye,subCategory:Ke,tags:Xe,slug:Je}=Rn;var Fa=y('<p>實作串流相關 API</p> <hr/> <h3>FileStream 特性</h3> <ul><li>指針機制：串流有一個內部指針，讀取時會向前移動，讀完後就到了末尾</li> <li>記憶體效率：串流設計用來處理大文件，不會把整個文件載入記憶體</li> <li>即時處理：數據是可以邊讀邊處理的，適合有獨立資料結構導向的檔案類型</li></ul> <p><strong>適合的類型</strong> : <code>.txt</code>, <code>.csv</code>,<code>.jsonl</code>,<code>.mp3</code>, <code>.mp4</code></p> <p><strong>不適合的類型</strong> : <code>.json</code>, <code>.zip</code>, <code>.rar</code></p> <pre class="language-csharp"><!></pre> <p>這邊可邊接收邊處理，是因為 <strong>HTTP 不同 Request 參數類型，會有不同的執行時機</strong>，例如:</p> <ul><li><p>String / Object：Body 完整接收後才執行，資料立即可用（適合小型資料、JSON）</p></li> <li><p>IFormFile：Headers 接收後就執行，檔案資訊立即可用但內容需等待串流（適合大型檔案）</p></li></ul>',1);function Ma(u){var o=Fa(),p=t(h(o),12),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token comment">// 串流處理：記憶體效率高</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),R(4),w(u,o)}const ja=Object.freeze(Object.defineProperty({__proto__:null,default:Ma,metadata:Rn},Symbol.toStringTag,{value:"Module"})),Tn={title:"Http Connect",date:"2025-09-03",category:"software",subCategory:"Internet",tags:["Http","tcp","backend"],slug:"http_connect"},{title:Qe,date:Ze,category:nc,subCategory:sc,tags:ac,slug:tc}=Tn;var Ha=y('<h3>TCP 連線的運作機制</h3> <ol><li><p>伺服器主機主動開啟 Port <code>net.Listen("tcp", ":4000")</code></p></li> <li><p>同時 <code>conn, err := listener.Accept()</code> 等待連接</p></li> <li><p>客戶端發送請求 <code>server_ip:4000</code> OS 背後做 TCP 三次握手驗證</p></li> <li><p>資料會傳送到 <code>OS緩衝區</code>，程式則會定期去緩衝區讀取資料處理</p></li></ol> <h3>Server 的核心特性</h3> <ul><li>持續運行（Long-running Process）</li> <li>對外提供通訊介面</li></ul> <pre class="language-go"><!></pre> <p>HTTP 本身是個字串，會需要嚴格的解析流程，可以導入狀態機的概念去處理如:</p> <ul><li>解析請求行 → 提取方法、路徑、版本</li> <li>解析標頭   → 逐行讀取 key: value</li> <li>解析請求體 → 根據 Content-Length 讀取</li></ul> <pre class="language-go"><!></pre>',1);function Ba(u){var o=Ha(),p=t(h(o),8),k=n(p);a(k,()=>`<code class="language-go"><span class="token keyword">package</span> main
...
<span class="token punctuation">&#125;</span></code>`),s(p);var e=t(p,6),i=n(e);a(i,()=>`<code class="language-go"><span class="token keyword">type</span> HTTPRequest <span class="token keyword">struct</span> <span class="token punctuation">&#123;</span>
...
<span class="token comment">// https request -> Service Server</span></code>`),s(p);var e=t(p,2),i=n(e);a(i,()=>`<code class="language-csharp"><span class="token comment">// Service Server</span>
...
<span class="token instruction"><span class="token keyword">CMD</span> [<span class="token string">"nginx"</span>, <span class="token string">"-g"</span>, <span class="token string">"daemon off;"</span>]</span></code>`),s(p);var e=t(p,2),i=n(e);a(i,()=>`<code class="language-bash"><span class="token function">docker</span> stop my-proxy
...
<span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">-p</span> <span class="token number">80</span>:80 <span class="token parameter variable">--name</span> my-proxy my-nginx-proxy</code>`),s(e);var c=t(e,4),d=n(c);a(d,()=>`<code class="language-conf">events &#123;
...
└── article/                    # 子路由目錄
    ...
    └── [slug]/                 # 動態路由段落
        ...
        └── +page.ts            # 預渲染配置</code>`),s(p);var e=t(p,4),i=n(e);a(i,()=>`<code class="language-markdown"><span class="token front-matter-block"><span class="token punctuation">---</span>
...
<span class="token punctuation">---</span></span></code>`),s(e);var c=t(e,2),d=n(c);a(d,()=>`<code class="language-markdown">構建階段 (npm run build)
  ↓
...
生成對應的靜態 HTML 頁面
  ↓
輸出到 build/blog/&#123;slug&#125;.html</code>`),s(c);var l=t(c,16),m=n(l);a(m,()=>`<code class="language-yml"><span class="token key atrule">name</span><span class="token punctuation">:</span> Deploy to GitHub Pages
...
│       └── HomePage.module.css
└── constants/                   # 常數配置
    └── env.ts                  # 環境變數</code>`),s(p);var e=t(p,10),i=n(e);a(i,()=>`<code class="language-typescript"><span class="token comment">// store 配置範例</span>
<span class="token keyword">export</span> <span class="token keyword">const</span> store <span class="token operator">=</span> <span class="token function">configureStore</span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(e);var c=t(e,4),d=n(c);a(d,()=>`<code class="language-markdown">/                           # 首頁
├── category_1              # 分類頁面 1（Mix）
├── category_2              # 分類頁面 2
├── BrandPage               # 品牌頁面
├── BrandPage/css           # CSS 設計預覽頁面
└── *                       # 404 導向首頁</code>`),s(c);var l=t(c,4),m=n(l);a(m,()=>'<code class="language-typescript"><span class="token keyword">const</span> element <span class="token operator">=</span> <span class="token function">useRoutes</span><span class="token punctuation">(</span>routes<span class="token punctuation">)</span></code>'),s(l);var r=t(l,6),f=n(r);a(f,()=>`<code class="language-typescript"><span class="token comment">// 主題切換實作</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">,</span> <span class="token punctuation">[</span>theme<span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(r);var g=t(r,8),b=n(g);a(b,()=>`<code class="language-markdown">public/language/
├── en/
│   └── translation.json
└── zh/
    └── translation.json</code>`),s(g);var v=t(g,8),S=n(v);a(S,()=>`<code class="language-bash"><span class="token function">npm</span> run dev      <span class="token comment"># 啟動開發伺服器（HMR 支援）</span>
...
│ • 檔案樹 │ • 編輯器 │  • 即時預覽    │
│ • 切換   │ • 內容   │  • 內建伺服器  │
└──────────┴──────────┴───────────────┘</code>`),s(p);var e=t(p,4),i=n(e);a(i,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,8),d=n(c);a(d,()=>`<code class="language-javascript"><span class="token keyword">const</span> <span class="token constant">WCV_DEFAULT_SETTING</span> <span class="token operator">=</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c),R(10),w(u,o)}const pt=Object.freeze(Object.defineProperty({__proto__:null,default:tt,metadata:An},Symbol.toStringTag,{value:"Module"})),On={title:"CSS Render 範本",date:"2025-06-22",category:"",subCategory:"",tags:["read","book","markdown"],slug:"the_beggers_strike"},{title:qc,date:Lc,category:Nc,subCategory:$c,tags:Fc,slug:Mc}=On;var ot=y("<p>非洲文學家</p> <hr/> <p>###　乞丐的罷工</p> <p>角色定位鮮明、閱讀起來很像長篇寓言故事。可以把世界背景想像成架空於印度之上，內容主線如同書名；在一個外來的打破平衡的事件，政府開始掃蕩下乞丐掀起革命。</p> <p>有趣的地方是把人性醜陋的特質，放到不同位階的人身上，盲從的乞丐、固執的部長、貪婪的候選人、女人、窄眼的教士和詐欺教宗，同時又有一種核心概念是在堅守自己的價值</p> <p>導致看到每個角色都會覺得 難怪你會是這個位階的人 和 嗯嗯、我如果是他我應該也會這樣做切換，</p> <p>，例如容易被煽動的乞丐、貫徹信念到底的部長、貪婪權位者、不寬心的教士和水份很高的教宗?</p>",1);function et(u){var o=ot();R(12),w(u,o)}const ct=Object.freeze(Object.defineProperty({__proto__:null,default:et,metadata:On},Symbol.toStringTag,{value:"Module"})),qn={title:"CSS Render 範本",date:"2025-06-22",category:null,subCategory:null,tags:["svelte","blog","markdown"],slug:"example"},{title:jc,date:Hc,category:Bc,subCategory:Uc,tags:Vc,slug:Wc}=qn;var lt=y('<p>這是第一篇文章，用來展示部落格如何從 markdown 載入內容。</p> <hr/> <h1>這是 H1 標題</h1> <h2>這是 H2 標題</h2> <h3>這是 H3 標題</h3> <hr/> <p>段落文字：這是一段普通的段落內容，展示預設的段落文字樣式。</p> <p>強調文字：<strong>粗體</strong>、<em>斜體</em>、<del>刪除線</del>。</p> <hr/> <h3>清單測試</h3> <ul><li>無序清單項目 1</li> <li>無序清單項目 2 <ul><li>子項目 a</li> <li>子項目 b</li></ul></li></ul> <ol><li>有序清單項目 1</li> <li>有序清單項目 2 <ol><li>子項目 i</li> <li>子項目 ii</li></ol></li></ol> <hr/> <h3>程式碼區塊</h3> <h4>行內程式碼</h4> <p>例如你可以這樣寫：<code>console.log("Hello Svelte!")</code></p> <h4>區塊程式碼</h4> <pre class="language-js"><!></pre>',1);function ut(u){var o=lt(),p=t(h(o),34),k=n(p);a(k,()=>`<code class="language-js"><span class="token keyword">function</span> <span class="token function">greet</span><span class="token punctuation">(</span><span class="token parameter">name</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> <span class="token template-string"><span class="token template-punctuation string">&#96;</span><span class="token string">Hello, </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">$&#123;</span>name<span class="token interpolation-punctuation punctuation">&#125;</span></span><span class="token string">!</span><span class="token template-punctuation string">&#96;</span></span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(p),w(u,o)}const kt=Object.freeze(Object.defineProperty({__proto__:null,default:ut,metadata:qn},Symbol.toStringTag,{value:"Module"})),j=[],z=Object.assign({"/src/content/Backend/BackgroudService.md":Qn,"/src/content/Backend/DDD_layer.md":ss,"/src/content/Backend/DDD_mediator.md":ps,"/src/content/Backend/DDD_outbox.md":cs,"/src/content/Backend/FSM.md":ks,"/src/content/Database/Paxon_1.md":ds,"/src/content/Database/Paxon_2.md":ys,"/src/content/Database/consistency_1.md":hs,"/src/content/Database/consistency_2.md":_s,"/src/content/Database/consistency_3.md":Ps,"/src/content/Database/db_leetcode50.md":Ds,"/src/content/Database/db_normalization.md":Is,"/src/content/Database/db_relational.md":qs,"/src/content/Database/db_sql.md":$s,"/src/content/Database/db_table_1.md":js,"/src/content/Devlop-Note/cashflow.md":Us,"/src/content/Devlop-Note/jsPDF.md":zs,"/src/content/Devlop-Note/pdfMerge.md":Ks,"/src/content/Devlop-Note/reconcile.md":Qs,"/src/content/Devlop-Note/sftp_ftps.md":sa,"/src/content/Devlop-Note/structurizr.md":pa,"/src/content/Devlop-Note/summary_2025.md":ca,"/src/content/Devlop-Note/xlsx_excel.md":ka,"/src/content/Fronted/Electron_01.md":da,"/src/content/Fronted/ThreeJS.md":ya,"/src/content/Fronted/angular_basic.md":ha,"/src/content/Fronted/angular_http.md":_a,"/src/content/Fronted/angular_router.md":Pa,"/src/content/Fronted/angular_value.md":Da,"/src/content/Fronted/css.md":Ia,"/src/content/Fronted/design_token.md":qa,"/src/content/Http/CORS.md":$a,"/src/content/Http/filestream.md":ja,"/src/content/Http/http_connect.md":Ua,"/src/content/Http/http_secretKey.md":za,"/src/content/Http/nginx.md":Ka,"/src/content/Project/blog.md":Qa,"/src/content/Project/webpreviewer.md":st,"/src/content/Project/websiteeditor.md":pt,"/src/content/Read/the_beggers_strike.md":ct,"/src/content/empty.md":kt});for(const u in z){const o=z[u];j.push({category:o.metadata.category,subCategory:o.metadata.subCategory,title:o.metadata.title,slug:o.metadata.slug,date:o.metadata.date,tags:o.metadata.tags,excerpt:o.metadata.excerpt??"",component:o.default})}j.sort((u,o)=>o.date.localeCompare(u.date));const zc=Kn(j);export{$s as A,qs as B,Is as C,Ds as D,Ps as E,_s as F,hs as G,ys as H,ds as I,ks as J,cs as K,ps as L,ss as M,Qn as N,zc as O,kt as _,ct as a,pt as b,st as c,Qa as d,Ka as e,za as f,Ua as g,ja as h,$a as i,qa as j,Ia as k,Da as l,Pa as m,_a as n,ha as o,ya as p,da as q,ka as r,ca as s,pa as t,sa as u,Qs as v,Ks as w,zs as x,Us as y,js as z};
