import{b as H,d as En,f as w,a as h}from"./Cew64nlL.js";import"./C5SEx9ip.js";import{t as Tn,h as B,a as V,P as xn,aH as An,d as z,V as On,Y as Nn,W as Ln,B as $n,T as O,s as t,o as b,v as n,w as s,aI as E}from"./COc0ozwQ.js";import{r as qn}from"./CR_4RHM7.js";function a(u,o,p=!1,k=!1,e=!1){var r=u,c="";Tn(()=>{var d=xn;if(c===(c=o()??"")){B&&V();return}if(d.nodes_start!==null&&(An(d.nodes_start,d.nodes_end),d.nodes_start=d.nodes_end=null),c!==""){if(B){z.data;for(var l=V(),g=l;l!==null&&(l.nodeType!==8||l.data!=="");)g=l,l=On(l);if(l===null)throw Nn(),Ln;H(z,g),r=$n(l);return}var i=c+"";p?i=`<svg>${i}</svg>`:k&&(i=`<math>${i}</math>`);var y=En(i);if((p||k)&&(y=O(y)),H(O(y),y.lastChild),p||k)for(;O(y);)r.before(O(y));else r.before(y)}})}const G={title:"Finite-State Machine",date:"2025-06-22",category:"software",subCategory:"Backend",tags:["FSM","backend","markdown"],slug:"FSM"},{title:va,date:_a,category:Ca,subCategory:Sa,tags:Ra,slug:Da}=G;var Fn=w('<h6>導入類比電路的概念來實作，用金流串接當作範例</h6> <hr/> <h3>核心概念</h3> <p>狀態是封閉集合：Pending / Paid / Failed / RefundPending / Refunded。事件（Trigger）是唯一入口：只有明確的事件才能讓狀態改變。</p> <pre class="language-csharp"><!></pre> <table><thead><tr><th>CurrentState</th><th>Trigger</th><th>NextState</th></tr></thead><tbody><tr><td>Pending</td><td>PaySucceeded</td><td>Paid</td></tr><tr><td>Pending</td><td>PayFailed</td><td>Failed</td></tr><tr><td>Paid</td><td>StartRefund</td><td>RefundPending</td></tr><tr><td>RefundPending</td><td>RefundSucceeded</td><td>Refunded</td></tr><tr><td>RefundPending</td><td>RefundFailed</td><td>Paid</td></tr><tr><td>Failed/Refunded</td><td><em>(無任何事件)</em></td><td><em>(終點)</em></td></tr></tbody></table> <h3>簡易流程</h3> <pre class="language-csharp"><!></pre> <p>限制行為的方式</p> <pre class="language-csharp"><!></pre> <h3>測試與擴充</h3> <p>單元測試每條轉移：「Pending → PaySucceeded → Paid」。</p> <p>新增流程：只要在 enum + 轉移表多加一條，和對應 trigger 的處理；主程式 switch(fsm.CurrentState) 自動接手 DB 差異。</p>',1);function jn(u){var o=Fn(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-csharp"><span class="token comment">// 狀態（State）</span>
...
<span class="token punctuation">(</span>
  ...
  <span class="token keyword">LIMIT</span> <span class="token number">1</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(m);var f=t(m,6),S=n(f);a(S,()=>`<code class="language-sql"><span class="token keyword">SELECT</span> id<span class="token punctuation">,</span> <span class="token function">COUNT</span><span class="token punctuation">(</span><span class="token operator">*</span><span class="token punctuation">)</span> <span class="token keyword">AS</span> num
<span class="token keyword">FROM</span> <span class="token punctuation">(</span>
...
-------|------------|-----
DB     | Smith      | R1
DB     | Jones      | R2</code>`),s(m);var f=t(m,4),S=n(f);a(S,()=>`<code class="language-text">-- 課程與教室（CourseRoom）
Course | Room
-------|-----
DB     | R1
...
Instructor | Room
-----------|-----
Smith      | R1</code>`),s(f);var v=t(f,6),I=n(v);a(I,()=>`<code class="language-text">錯誤
...
Supplier | Part | Project
---------|------|---------
S1       | P1   | J1</code>`),s(D),h(u,o)}const cs=Object.freeze(Object.defineProperty({__proto__:null,default:es,metadata:nn},Symbol.toStringTag,{value:"Module"})),sn={title:"關聯式資料庫",date:"2025-06-22",category:"software",subCategory:"Database",tags:["database","db","sql"],slug:"db_relational"},{title:mt,date:yt,category:ft,subCategory:wt,tags:ht,slug:bt}=sn;var ls=w('<pre class="language-pgsql"><!></pre> <p>連接 SQL Server 時是透過 TDS（Tabular Data Stream）的通訊協定來交換資料。</p> <ul><li>TDS 是 SQL Server 專用的底層通訊協定，負責在用戶端與資料庫伺服器之間傳遞</li> <li>通常透過 TCP/IP 傳輸，預設使用的連接埠為 1433。</li> <li>用戶端要連接資料庫時，會使用一段 Connection String（連線字串）</li></ul> <pre class="language-pgsql"><!></pre> <h3>Table（資料表）</h3> <p>資料表是資料的儲存核心，每個表由「列（row）」與「欄（column）」構成。</p> <pre class="language-sql"><!></pre> <h3>Primary Key（主鍵）</h3> <p>能唯一標識每一筆資料，一張表只能有一個主鍵，可以是單一欄位或多欄位組成（複合主鍵）。</p> <pre class="language-sql"><!></pre> <h3>Unique Constraint（唯一約束）</h3> <p>限制欄位值不能重複，一張表可以有多個唯一欄位。</p> <pre class="language-sql"><!></pre> <h3>Foreign Key（外鍵）</h3> <pre class="language-sql"><!></pre> <h3>Index（索引）</h3> <p>加速查詢效率，類似書本的目錄，索引可以建立在單一欄位或多個欄位上。</p> <pre class="language-sql"><!></pre>',1);function us(u){var o=ls(),p=b(o),k=n(p);a(k,()=>`<code class="language-pgsql">SQL Server Instance
├── Database
│   ├── Schema
│   │   ├── Table
│   │   ├── View
...
└─ C <span class="token punctuation">(</span>ID=3<span class="token punctuation">)</span></code>`),s(m);var f=t(m,6),S=n(f);a(S,()=>`<code class="language-sql"><span class="token comment">-- 查詢某節點的所有後代（含自己）</span>
...
<span class="token keyword">ORDER</span> <span class="token keyword">BY</span> cc<span class="token punctuation">.</span>Depth<span class="token punctuation">;</span></code>`),s(f);var v=t(f,6),I=n(v);a(I,()=>`<code class="language-sql"><span class="token comment">-- 對所有 ancestor of parentId，插入新後代關係</span>
...
<span class="token keyword">return</span> Response<span class="token punctuation">;</span></code>`),s(l),E(18),h(u,o)}const hs=Object.freeze(Object.defineProperty({__proto__:null,default:ws,metadata:pn},Symbol.toStringTag,{value:"Module"})),on={title:"Download PDF",date:"2025-06-22",category:"software",subCategory:"開發筆記",tags:["pdf","js","dom"],slug:"jsPDF"},{title:jt,date:Mt,category:Ut,subCategory:Ht,tags:Bt,slug:Vt}=on;var bs=w('<h6>紀錄下載影像相關處理</h6> <hr/> <h3>畫面截圖（html2canvas、dom-to-image…）</h3> <p>原理大多是用<code>document.query(ID / class)</code>抓取指定的<code>DOM</code>，在套件內<strong>模擬</strong>JS排版樣式引擎(所以可能會跑版)，繪圖在 HTML<code>&lt;canvas&gt;</code>Element 後再轉成 base64/Blob 格式輸出。</p> <p>要注意的是瀏覽器對於能當作繪製<code>&lt;canvas&gt;</code>的來源控管較為嚴格，例如在瀏覽器渲染的 img 來源可以使用，套件內被擋下來的問題，再來就是錯誤是發生在套件內部不好除錯。</p> <h3>向量型（jsPDF、pdf-lib…）</h3> <p>用程式碼直接描述格線、文字 ，也可以插入圖片當作背景。要注意的一樣是外部來源的合法(圖片、字體)，圖片可先在.js 轉換成 base64 當作來源給套件使用，減少套件內轉換失敗的風險。</p> <h3>jsPDF</h3> <p>添加字體方式有兩種方式讀取.ttf和.js，一樣讓套件讀取處理過的資源部屬比較穩定</p> <p>網站下載 .ttf 字體向量檔案</p> <pre class="language-js"><!></pre> <p>把 .ttf 轉成.js 再import到模組，因為字型檔案很大要用到再載入就好</p> <pre class="language-js"><!></pre> <p>圖片轉URL</p> <pre class="language-js"><!></pre> <p>下載和預覽</p> <pre class="language-js"><!></pre> <p><a href="https://github.com/cao0085/code-pattern/tree/main/fronted-pdf-download" rel="nofollow">相關程式碼</a></p>',1);function vs(u){var o=bs(),p=t(b(o),20),k=n(p);a(k,()=>`<code class="language-js"><span class="token comment">// var pdfDoc = 建立一個 jsPDF 提供的物件(&#123; unit: 'mm', format: 'a4' &#125;)</span>
...
pdfDoc<span class="token punctuation">.</span><span class="token function">save</span><span class="token punctuation">(</span><span class="token string">"fileName.pdf"</span><span class="token punctuation">)</span></code>`),s(l),E(2),h(u,o)}const _s=Object.freeze(Object.defineProperty({__proto__:null,default:vs,metadata:on},Symbol.toStringTag,{value:"Module"})),en={title:"多個 PDF 檔案合併",date:"2025-09-16",category:"software",subCategory:"開發筆記",tags:["pdf","backend","command"],slug:"pdfmarge"},{title:zt,date:Wt,category:Gt,subCategory:Yt,tags:Xt,slug:Jt}=en;var Cs=w('<h6><a href="https://github.com/cao0085/pdfMerger" rel="nofollow">Repository</a> ，Python 執行相容性比較好，C# UI方便友善</h6> <hr/> <h3>C#</h3> <pre class="language-csharp"><!></pre> <pre class="language-csharp"><!></pre> <h3>Python3</h3> <pre class="language-bash"><!></pre> <pre class="language-python"><!></pre>',1);function Ss(u){var o=Cs(),p=t(b(o),6),k=n(p);a(k,()=>`<code class="language-csharp">  <span class="token comment">// .csproj</span>
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">"__main__"</span><span class="token punctuation">:</span>
    ...
    merge_pdfs<span class="token punctuation">(</span><span class="token punctuation">)</span></code>`),s(l),h(u,o)}const Rs=Object.freeze(Object.defineProperty({__proto__:null,default:Ss,metadata:en},Symbol.toStringTag,{value:"Module"})),cn={title:"SFTP、FTPS C# 連線測試",date:"2025-06-22",category:"software",subCategory:"開發筆記",tags:["tcp","ip","container"],slug:"sftp_ftps"},{title:Kt,date:Qt,category:Zt,subCategory:np,tags:sp,slug:ap}=cn;var Ds=w('<h6>紀錄本地端測試方法</h6> <hr/> <h3>SFTP</h3> <p>docker-compose.yml</p> <pre class="language-yml"><!></pre> <pre class="language-csharp"><!></pre> <h3>FTPS</h3> <pre class="language-csharp"><!></pre> <p>docker-compose.yml</p> <pre class="language-yml"><!></pre>',1);function Is(u){var o=Ds(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-yml"><span class="token key atrule">services</span><span class="token punctuation">:</span>
...
<span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">ftps</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">restart</span><span class="token punctuation">:</span> unless<span class="token punctuation">-</span>stopped</code>`),s(l),h(u,o)}const Ps=Object.freeze(Object.defineProperty({__proto__:null,default:Is,metadata:cn},Symbol.toStringTag,{value:"Module"})),ln={title:"Structurizr C4Model",date:"2025-06-22",category:"software",subCategory:"開發筆記",tags:["model","UML","ERD"],slug:"structurizr"},{title:tp,date:pp,category:op,subCategory:ep,tags:cp,slug:lp}=ln;var Es=w('<h6><a href="https://structurizr.com/" rel="nofollow">Structurizr</a></h6> <hr/> <p><a href="https://github.com/cao0085/code-pattern/tree/main/structurizr" rel="nofollow">File</a></p> <br/> <h3>docker-compose.yml</h3> <p>初次建立和執行會生成基本的專案檔</p> <pre class="language-yml"><!></pre> <h3>workspace.dsl</h3> <pre class="language-text"><!></pre> <h3>index-model.dsl</h3> <p>依序層級，每一層都可以渲染出一張圖</p> <p><code>Variable = softwareSystem "英文字名稱" =&gt; Variable = container "文字"  =&gt; Variable = component "文字"</code></p> <pre class="language-text"><!></pre> <h3>index-model.dsl</h3> <p>指定要渲染哪些 index-model.dsl 裡的 model，且需要降一階處理</p> <p><code>index-model.dsl 裡的 YourSystem = softwareSystem</code></p> <p><code>index-model.dsl 要改成 container YourSystem 來指定</code></p> <pre class="language-text"><!></pre>',1);function Ts(u){var o=Es(),p=t(b(o),12),k=n(p);a(k,()=>`<code class="language-yml">// docker<span class="token punctuation">-</span>compose.yml
...
component YourSystem.InitPage_1 &quot;InitData&quot; &#123;
    include *
&#125;</code>`),s(l),h(u,o)}const xs=Object.freeze(Object.defineProperty({__proto__:null,default:Ts,metadata:ln},Symbol.toStringTag,{value:"Module"})),un={title:"XLSL Excel",date:"2025-06-22",category:"software",subCategory:"開發筆記",tags:["XLSL","js","Excel"],slug:"xlsx_excel"},{title:up,date:kp,category:rp,subCategory:ip,tags:dp,slug:gp}=un;var As=w('<h6><a href="https://www.npmjs.com/package/xlsx/v/0.14.1?activeTab=readme" rel="nofollow">xlsx 0.14.1</a></h6> <hr/> <h3>Workbook & Worksheet</h3> <p>單個 Workbook 實例代表一份完整的xsml檔案，Worksheet 代表一頁 xsml的分頁，都可以產多個。</p> <pre class="language-js"><!></pre> <h3>Sheet Content</h3> <pre class="language-js"><!></pre> <h3>Merges</h3> <p>指定哪些儲存格要上下合併</p> <pre class="language-js"><!></pre> <h3>多列合併實作</h3> <ul><li>假設有一筆一對多的資料列</li> <li>分割/合併儲存格的方式在EXCEL上呈現</li></ul> <br/> <p>先處理資料結構</p> <pre class="language-js"><!></pre> <p>處理合併欄位</p> <pre class="language-js"><!></pre> <p>完整流程</p> <pre class="language-js"><!></pre>',1);function Os(u){var o=As(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token constant">XLSX</span> <span class="token keyword">from</span> <span class="token string">'xlsx'</span><span class="token punctuation">;</span>
...
builder<span class="token punctuation">.</span>Services<span class="token punctuation">.</span><span class="token function">AddTransient</span><span class="token punctuation">(</span><span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">IPipelineBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">,</span> <span class="token keyword">typeof</span><span class="token punctuation">(</span><span class="token type-expression class-name">ValidationBehavior<span class="token punctuation">&lt;</span><span class="token punctuation">,</span><span class="token punctuation">></span></span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(m);var f=t(m,8),S=n(f);a(S,()=>`<code class="language-csharp"><span class="token comment">// .csproj</span>
...
<span class="token operator">&lt;</span><span class="token class-name">PackageReference</span> Include<span class="token operator">=</span><span class="token string">"MassTransit.RabbitMQ"</span> Version<span class="token operator">=</span><span class="token string">"8.1.2"</span> <span class="token operator">/</span><span class="token operator">></span></code>`),s(f);var v=t(f,2),I=n(v);a(I,()=>`<code class="language-csharp"><span class="token comment">// Program.cs</span>
...
<span class="token punctuation">&#125;</span></code>`),s(A),h(u,o)}const Ms=Object.freeze(Object.defineProperty({__proto__:null,default:js,metadata:rn},Symbol.toStringTag,{value:"Module"})),dn={title:"Outbox Message",date:"2025-06-23",category:"software",subCategory:"Domain-Driven Design",tags:["DDD","backend","design"],slug:"ddd_outbox"},{title:Ip,date:Pp,category:Ep,subCategory:Tp,tags:xp,slug:Ap}=dn;var Us=w('<h6>拆分主副邏輯，同時保持資料同步性</h6> <hr/> <h2>SideEffect</h2> <p>若把 DDD 流程中的主副行為拆分：</p> <ul><li>創建員工帳戶的時候 <code>&lt;TABLE_Employee&gt;</code> 新增一筆資料</li> <li>幫對應到的 <code>&lt;TABLE_Department&gt;_Headcount</code> 總人數加一</li></ul> <br/> <p>若是以依照 MVC 架構會是</p> <pre class="language-csharp"><!></pre> <p>用 DDD 寫則變成是</p> <pre class="language-csharp"><!></pre> <p>假設創建員工帳號變為須更新 5-10 張表單,函式會越來越巨大、複雜且難以測試與維護。透過 DDD 的 Domain Event 拆解副作用邏輯可異步處理，減少主流程延遲。</p> <h2>ASIO 原子性（Atomicity of Side-Effect & IO）</h2> <p>剛剛提到的行為，主邏輯成功時無法保證所有副作用（如更新部門、發送通知等）都成功執行，這違反了分散系統中常見的 資料一致性與原子性要求。</p> <p>解決方法是設計一張資料庫新表<code>&lt;DB_Outbox_Message&gt;</code>，在一筆交易中提交主邏輯與事件，且把事件訊息<code>(Event、Payload、Time)</code>寫入這張表。這樣執行失敗也有紀錄可以查驗，也可設計失敗的 Retry 機制。</p> <br/> <p>主要實踐方法是用背景應用重複執行，訪問 DB_Outbox_Message 執行該事件</p> <pre class="language-csharp"><!></pre>',1);function Hs(u){var o=Us(),p=t(b(o),14),k=n(p);a(k,()=>`<code class="language-csharp">db_Employee<span class="token punctuation">.</span><span class="token function">Add</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(c),h(u,o)}const Bs=Object.freeze(Object.defineProperty({__proto__:null,default:Hs,metadata:dn},Symbol.toStringTag,{value:"Module"})),gn={title:"插入 3D 影像",date:"2025-08-13",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"css"},{title:Op,date:Np,category:Lp,subCategory:$p,tags:qp,slug:Fp}=gn;var Vs=w(`<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>匯入 .glb</h3> <p>透過用 three.js 匯入
Canvas ➜ WebGL ➜ Three.js ➜ GLB 模型 ➜ GPU 顯示</p> <pre class="language-js"><!></pre>`,1);function zs(u){var o=Vs(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-js">  <span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> <span class="token constant">THREE</span> <span class="token keyword">from</span> <span class="token string">'three'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">CardComponent</span> <span class="token punctuation">&#123;</span><span class="token punctuation">&#125;</span></code>`),s(m);var f=t(m,4),S=n(f);a(S,()=>`<code class="language-ts"><span class="token operator">&lt;</span>app<span class="token operator">-</span>card<span class="token operator">></span>
...
<span class="token operator">&lt;</span><span class="token operator">/</span>app<span class="token operator">-</span>card<span class="token operator">></span></code>`),s(f);var v=t(f,4),I=n(v);a(I,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(e);var c=t(e,6),d=n(c);a(d,()=>`<code class="language-js"><span class="token keyword">this</span><span class="token punctuation">.</span>api<span class="token punctuation">.</span>get<span class="token operator">&lt;</span>any<span class="token operator">></span><span class="token punctuation">(</span><span class="token string">'/api/users'</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code>`),s(c),h(u,o)}const Qs=Object.freeze(Object.defineProperty({__proto__:null,default:Ks,metadata:yn},Symbol.toStringTag,{value:"Module"})),fn={title:"Router",date:"2025-06-22",category:"software",subCategory:"Angular18",tags:["route","angular","api"],slug:"angular_router"},{title:Kp,date:Qp,category:Zp,subCategory:no,tags:so,slug:ao}=fn;var Zs=w('<h6>參考這個<a href="https://github.com/mbejda/AngularFire-Starter-Template" rel="nofollow">專案範本</a>、官方文件學習</h6> <hr/> <p>專案起始 index.html</p> <pre class="language-html"><!></pre> <p>元件去抓專案的根節點，render的內容用<code>&lt;router-outlet&gt;</code>佔位</p> <pre class="language-ts"><!></pre> <p>Route</p> <p>設定該路由(Path) <code>&lt;router-outlet&gt;</code>映射的元件</p> <pre class="language-ts"><!></pre> <p>且若添加 children 屬性擇該 映射的元件 裡面也可以再放一個佔位</p> <pre class="language-ts"><!></pre> <pre class="language-html"><!></pre> <h3>Route順序和路由守衛</h3> <p>Angular自帶跳轉和瀏覽權限設定，可自行放入<code>canActivate[]</code>裡面做邏輯判斷</p> <pre class="language-ts"><!></pre>',1);function na(u){var o=Zs(),p=t(b(o),6),k=n(p);a(k,()=>`<code class="language-html"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token name">doctype</span> <span class="token name">html</span><span class="token punctuation">></span></span>
...
<span class="token punctuation">/></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>custom-slider</span> <span class="token attr-name">[(defineValue)]</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>50<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span></code>`),s(m);var f=t(m,8),S=n(f);a(S,()=>`<code class="language-js">@<span class="token function">ViewChild</span><span class="token punctuation">(</span><span class="token string">'myDiv'</span><span class="token punctuation">)</span> divElement<span class="token operator">!</span><span class="token operator">:</span> ElementRef<span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(f);var v=t(f,2),I=n(v);a(I,()=>'<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">#myDiv</span><span class="token punctuation">></span></span>hello<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>'),s(v);var C=t(v,4),P=n(C);a(P,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component<span class="token punctuation">,</span> effect<span class="token punctuation">,</span> viewChild<span class="token punctuation">,</span> ElementRef <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">HeroComponent</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token function">add</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">this</span><span class="token punctuation">.</span>heroes <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span>heroService<span class="token punctuation">.</span><span class="token function">getHeroes</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(A);var L=t(A,4),Cn=n(L);a(Cn,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
firstName<span class="token punctuation">.</span><span class="token function">update</span><span class="token punctuation">(</span><span class="token parameter">name</span> <span class="token operator">=></span> name<span class="token punctuation">.</span><span class="token function">toUpperCase</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(L);var $=t(L,2),Sn=n($);a(Sn,()=>`<code class="language-ts"><span class="token keyword">const</span> firstName <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token string">'Morgan'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
firstName<span class="token punctuation">.</span><span class="token function">set</span><span class="token punctuation">(</span><span class="token string">'Jaime'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">firstNameCapitalized</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 'JAIME'（自動反應）</span></code>`),s($);var q=t($,4),Rn=n(q);a(Rn,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> Component<span class="token punctuation">,</span> signal<span class="token punctuation">,</span> computed <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),s(F);var j=t(F,4),In=n(j);a(In,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> signal<span class="token punctuation">,</span> effect<span class="token punctuation">,</span> untracked <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'@angular/core'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(j);var U=t(j,4),Pn=n(U);a(Pn,()=>`<code class="language-js"><span class="token keyword">const</span> a <span class="token operator">=</span> <span class="token function">signal</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(p),h(u,o)}const ca=Object.freeze(Object.defineProperty({__proto__:null,default:ea,metadata:hn},Symbol.toStringTag,{value:"Module"})),bn={title:"Design Token",date:"2025-08-18",category:"software",subCategory:"Frontend",tags:["css","fronted","web"],slug:"css"},{title:yo,date:fo,category:wo,subCategory:ho,tags:bo,slug:vo}=bn;var la=w('<h6><a href="https://designsystem.digital.gov/" rel="nofollow">U.S. Web Design System</a></h6> <hr/> <h3>Color System</h3> <p>Primary Colors</p> <pre class="language-json"><!></pre> <p>Status Colors</p> <pre class="language-json"><!></pre> <p>Neutral Colors</p> <pre class="language-json"><!></pre> <h3>Typography System</h3> <p>Font Family</p> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre> <pre class="language-json"><!></pre>',1);function ua(u){var o=la(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(i);var m=t(i,2),_=n(m);a(_,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(m);var f=t(m,2),S=n(f);a(S,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(f);var v=t(f,2),I=n(v);a(I,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),s(R);var D=t(R,2),x=n(D);a(x,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),s(D),h(u,o)}const ka=Object.freeze(Object.defineProperty({__proto__:null,default:ua,metadata:bn},Symbol.toStringTag,{value:"Module"})),vn={title:"Http Server",date:"2025-09-03",category:"software",subCategory:"Http",tags:["Http","tcp","backend"],slug:"http"},{title:_o,date:Co,category:So,subCategory:Ro,tags:Do,slug:Io}=vn;var ra=w('<h3>TCP 連線的運作機制</h3> <ol><li><p>伺服器主機主動開啟 Port <code>net.Listen("tcp", ":4000")</code></p></li> <li><p>同時 <code>conn, err := listener.Accept()</code> 等待連接</p></li> <li><p>客戶端發送請求 <code>server_ip:4000</code> OS 背後做 TCP 三次握手驗證</p></li> <li><p>資料會傳送到 <code>OS緩衝區</code>，程式則會定期去緩衝區讀取資料處理</p></li></ol> <h3>Server 的核心特性</h3> <ul><li>持續運行（Long-running Process）</li> <li>對外提供通訊介面</li></ul> <pre class="language-go"><!></pre> <p>HTTP 本身是個字串，會需要嚴格的解析流程，可以導入狀態機的概念去處理如:</p> <ul><li>解析請求行 → 提取方法、路徑、版本</li> <li>解析標頭   → 逐行讀取 key: value</li> <li>解析請求體 → 根據 Content-Length 讀取</li></ul> <pre class="language-go"><!></pre>',1);function ia(u){var o=ra(),p=t(b(o),8),k=n(p);a(k,()=>`<code class="language-go"><span class="token keyword">package</span> main
...
<span class="token punctuation">&#125;</span></code>`),s(e),h(u,o)}const da=Object.freeze(Object.defineProperty({__proto__:null,default:ia,metadata:vn},Symbol.toStringTag,{value:"Module"})),_n={title:"CSS Render 範本",date:"2025-06-22",category:null,subCategory:null,tags:["svelte","blog","markdown"],slug:"example"},{title:Po,date:Eo,category:To,subCategory:xo,tags:Ao,slug:Oo}=_n;var ga=w('<p>這是第一篇文章，用來展示部落格如何從 markdown 載入內容。</p> <hr/> <h1>這是 H1 標題</h1> <h2>這是 H2 標題</h2> <h3>這是 H3 標題</h3> <hr/> <p>段落文字：這是一段普通的段落內容，展示預設的段落文字樣式。</p> <p>強調文字：<strong>粗體</strong>、<em>斜體</em>、<del>刪除線</del>。</p> <hr/> <h3>清單測試</h3> <ul><li>無序清單項目 1</li> <li>無序清單項目 2 <ul><li>子項目 a</li> <li>子項目 b</li></ul></li></ul> <ol><li>有序清單項目 1</li> <li>有序清單項目 2 <ol><li>子項目 i</li> <li>子項目 ii</li></ol></li></ol> <hr/> <h3>程式碼區塊</h3> <h4>行內程式碼</h4> <p>例如你可以這樣寫：<code>console.log("Hello Svelte!")</code></p> <h4>區塊程式碼</h4> <pre class="language-js"><!></pre>',1);function ma(u){var o=ga(),p=t(b(o),34),k=n(p);a(k,()=>`<code class="language-js"><span class="token keyword">function</span> <span class="token function">greet</span><span class="token punctuation">(</span><span class="token parameter">name</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">return</span> <span class="token template-string"><span class="token template-punctuation string">&#96;</span><span class="token string">Hello, </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">$&#123;</span>name<span class="token interpolation-punctuation punctuation">&#125;</span></span><span class="token string">!</span><span class="token template-punctuation string">&#96;</span></span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`),s(p),h(u,o)}const ya=Object.freeze(Object.defineProperty({__proto__:null,default:ma,metadata:_n},Symbol.toStringTag,{value:"Module"})),M=[],W=Object.assign({"/src/content/Backend/FSM.md":Mn,"/src/content/Database/Paxon_1.md":Bn,"/src/content/Database/Paxon_2.md":Wn,"/src/content/Database/consistency_1.md":Xn,"/src/content/Database/consistency_2.md":Qn,"/src/content/Database/consistency_3.md":ss,"/src/content/Database/db_leetcode50.md":ps,"/src/content/Database/db_normalization.md":cs,"/src/content/Database/db_relational.md":ks,"/src/content/Database/db_sql.md":ds,"/src/content/Database/db_table_1.md":ys,"/src/content/Devlop-Note/cashflow.md":hs,"/src/content/Devlop-Note/jsPDF.md":_s,"/src/content/Devlop-Note/pdfMerge.md":Rs,"/src/content/Devlop-Note/sftp_ftps.md":Ps,"/src/content/Devlop-Note/structurizr.md":xs,"/src/content/Devlop-Note/xlsx_excel.md":Ns,"/src/content/Domain-Driven/DDD_layer.md":qs,"/src/content/Domain-Driven/DDD_mediator.md":Ms,"/src/content/Domain-Driven/DDD_outbox.md":Bs,"/src/content/Fronted/ThreeJS.md":Ws,"/src/content/Fronted/angular_basic.md":Xs,"/src/content/Fronted/angular_http.md":Qs,"/src/content/Fronted/angular_router.md":sa,"/src/content/Fronted/angular_value.md":pa,"/src/content/Fronted/css.md":ca,"/src/content/Fronted/design_token.md":ka,"/src/content/Http/http_01.md":da,"/src/content/empty.md":ya});for(const u in W){const o=W[u];M.push({category:o.metadata.category,subCategory:o.metadata.subCategory,title:o.metadata.title,slug:o.metadata.slug,date:o.metadata.date,tags:o.metadata.tags,excerpt:o.metadata.excerpt??"",component:o.default})}M.sort((u,o)=>o.date.localeCompare(u.date));const No=qn(M);export{Bn as A,Mn as B,No as C,ya as _,da as a,ka as b,ca as c,pa as d,sa as e,Qs as f,Xs as g,Ws as h,Bs as i,Ms as j,qs as k,Ns as l,xs as m,Ps as n,Rs as o,_s as p,hs as q,ys as r,ds as s,ks as t,cs as u,ps as v,ss as w,Qn as x,Xn as y,Wn as z};
