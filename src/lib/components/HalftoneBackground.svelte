<script lang="ts">
  ...
  function buildDots(w: number, h: number) {
    ...
    const foci = [
      { cx: w * 0.30, cy: h * 0.18, xs: w * 0.28, ys: h * 0.32, r: 64,  g: 117, b: 166 },
      { cx: w * 0.42, cy: h * 0.52, xs: w * 0.26, ys: h * 0.38, r: 45,  g: 88,  b: 135 },
      { cx: w * 0.22, cy: h * 0.82, xs: w * 0.24, ys: h * 0.28, r: 72,  g: 128, b: 172 },
    ];
